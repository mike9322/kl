...
/**
*  @file generated/gsiDeclQBuffer_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQBuffer_EventAdaptor
#define _HDR_gsiDeclQBuffer_EventAdaptor
...
public:
  QBuffer_EventAdaptor (QObject *host);
