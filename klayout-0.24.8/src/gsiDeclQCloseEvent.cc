...
#include "gsiDeclQCloseEvent_Enums.h"
#include <memory>
...
gsi::Class<QCloseEvent> decl_QCloseEvent (decl_QEvent, "QCloseEvent_Native",
  gsi::Methods(),
  "@hide\n@alias QCloseEvent");
}
...
static qt_gsi::GenericStaticMethod *_create_ctor_QCloseEvent_Adaptor_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QCloseEvent::QCloseEvent()\nThis method creates an object of class QCloseEvent.", &_init_ctor_QCloseEvent_Adaptor_0, &_call_ctor_QCloseEvent_Adaptor_0);
}

namespace gsi
{

extern gsi::Class<QCloseEvent> decl_QCloseEvent;

gsi::Class<QCloseEvent_Adaptor> decl_QCloseEvent_Adaptor (decl_QCloseEvent, "QCloseEvent",
  gsi::Methods(_create_ctor_QCloseEvent_Adaptor_0 ()),
