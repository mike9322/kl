...
#include "gsiDeclQStyleOptionTitleBar_Enums.h"
#include <memory>
...
static qt_gsi::GenericStaticMethod *_create_ctor_QStyleOptionTitleBar_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QStyleOptionTitleBar::QStyleOptionTitleBar()\nThis method creates an object of class QStyleOptionTitleBar.", &_init_ctor_QStyleOptionTitleBar_0, &_call_ctor_QStyleOptionTitleBar_0);
}
...
{
  const QStyleOptionTitleBar &arg1 = args.read<const QStyleOptionTitleBar & > ();
  ret.write<QStyleOptionTitleBar *> (new QStyleOptionTitleBar (arg1));
}

static qt_gsi::GenericStaticMethod *_create_ctor_QStyleOptionTitleBar_3347 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QStyleOptionTitleBar::QStyleOptionTitleBar(const QStyleOptionTitleBar &other)\nThis method creates an object of class QStyleOptionTitleBar.", &_init_ctor_QStyleOptionTitleBar_3347, &_call_ctor_QStyleOptionTitleBar_3347);
}
...
gsi::Class<QStyleOptionTitleBar> decl_QStyleOptionTitleBar (decl_QStyleOptionComplex, "QStyleOptionTitleBar",
  gsi::Methods(_create_ctor_QStyleOptionTitleBar_0 ()) +
  gsi::Methods(_create_ctor_QStyleOptionTitleBar_3347 ()),
