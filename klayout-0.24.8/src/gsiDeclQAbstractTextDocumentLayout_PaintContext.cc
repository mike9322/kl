...
#include "gsiDeclQAbstractTextDocumentLayout_PaintContext_Enums.h"
#include <memory>
...
static qt_gsi::GenericStaticMethod *_create_ctor_QAbstractTextDocumentLayout_PaintContext_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QAbstractTextDocumentLayout::PaintContext::PaintContext()\nThis method creates an object of class QAbstractTextDocumentLayout::PaintContext.", &_init_ctor_QAbstractTextDocumentLayout_PaintContext_0, &_call_ctor_QAbstractTextDocumentLayout_PaintContext_0);
}
...
gsi::Class<QAbstractTextDocumentLayout::PaintContext> decl_QAbstractTextDocumentLayout_PaintContext ("QAbstractTextDocumentLayout_PaintContext",
  gsi::Methods(_create_ctor_QAbstractTextDocumentLayout_PaintContext_0 ()),
