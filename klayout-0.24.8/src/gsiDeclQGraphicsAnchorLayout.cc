...
#include "gsiDeclQGraphicsAnchorLayout_Enums.h"
#include <memory>
...
static void _call_f_addAnchor_8538 (const qt_gsi::GenericMethod *decl, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  const qt_gsi::Converter<Qt::AnchorPoint>::target_type & arg2 = args.read<const qt_gsi::Converter<Qt::AnchorPoint>::target_type & > ();
  QGraphicsLayoutItem *arg3 = args.read<QGraphicsLayoutItem * > ();
  const qt_gsi::Converter<Qt::AnchorPoint>::target_type & arg4 = args.read<const qt_gsi::Converter<Qt::AnchorPoint>::target_type & > ();
...
static qt_gsi::GenericMethod *_create_f_addAnchor_8538 ()
{
  return new qt_gsi::GenericMethod ("addAnchor", "@brief Method QGraphicsAnchor *QGraphicsAnchorLayout::addAnchor(QGraphicsLayoutItem *firstItem, Qt::AnchorPoint firstEdge, QGraphicsLayoutItem *secondItem, Qt::AnchorPoint secondEdge)\n", false, &_init_f_addAnchor_8538, &_call_f_addAnchor_8538);
}
...
static void _init_f_addAnchors_7507 (qt_gsi::GenericMethod *decl)
{
  ...
  decl->add_arg<const qt_gsi::Converter<QFlags<Qt::Orientation> >::target_type & > (argspec_2);
...
static void _call_f_addAnchors_7507 (const qt_gsi::GenericMethod *decl, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  tl::Heap heap;
  const qt_gsi::Converter<QFlags<Qt::Orientation> >::target_type & arg3 = args ? args.read<const qt_gsi::Converter<QFlags<Qt::Orientation> >::target_type & > () : (const qt_gsi::Converter<QFlags<Qt::Orientation> >::target_type &)(qt_gsi::CppToQtReadAdaptor<QFlags<Qt::Orientation> >(heap, Qt::Horizontal | Qt::Vertical));
  ((QGraphicsAnchorLayout *)cls)->addAnchors (arg1, arg2, qt_gsi::QtToCppAdaptor<QFlags<Qt::Orientation> >(arg3).cref());
}

static qt_gsi::GenericMethod *_create_f_addAnchors_7507 ()
{
  return new qt_gsi::GenericMethod ("addAnchors", "@brief Method void QGraphicsAnchorLayout::addAnchors(QGraphicsLayoutItem *firstItem, QGraphicsLayoutItem *secondItem, QFlags<Qt::Orientation> orientations)\n", false, &_init_f_addAnchors_7507, &_call_f_addAnchors_7507);
}
...
{
  QGraphicsLayoutItem *arg1 = args.read<QGraphicsLayoutItem * > ();
  const qt_gsi::Converter<Qt::Corner>::target_type & arg2 = args.read<const qt_gsi::Converter<Qt::Corner>::target_type & > ();
  QGraphicsLayoutItem *arg3 = args.read<QGraphicsLayoutItem * > ();
  const qt_gsi::Converter<Qt::Corner>::target_type & arg4 = args.read<const qt_gsi::Converter<Qt::Corner>::target_type & > ();
...
static qt_gsi::GenericMethod *_create_f_addCornerAnchors_7522 ()
{
  return new qt_gsi::GenericMethod ("addCornerAnchors", "@brief Method void QGraphicsAnchorLayout::addCornerAnchors(QGraphicsLayoutItem *firstItem, Qt::Corner firstCorner, QGraphicsLayoutItem *secondItem, Qt::Corner secondCorner)\n", false, &_init_f_addCornerAnchors_7522, &_call_f_addCornerAnchors_7522);
}
...
static qt_gsi::GenericMethod *_create_f_anchor_8538 ()
{
  return new qt_gsi::GenericMethod ("anchor", "@brief Method QGraphicsAnchor *QGraphicsAnchorLayout::anchor(QGraphicsLayoutItem *firstItem, Qt::AnchorPoint firstEdge, QGraphicsLayoutItem *secondItem, Qt::AnchorPoint secondEdge)\n", false, &_init_f_anchor_8538, &_call_f_anchor_8538);
}
...
{
  return new qt_gsi::GenericMethod (":horizontalSpacing", "@brief Method double QGraphicsAnchorLayout::horizontalSpacing()\n", true, &_init_f_horizontalSpacing_c0, &_call_f_horizontalSpacing_c0);
}
...
{
  return new qt_gsi::GenericMethod ("itemAt", "@brief Method QGraphicsLayoutItem *QGraphicsAnchorLayout::itemAt(int index)\nThis is a reimplementation of QGraphicsLayout::itemAt", true, &_init_f_itemAt_c767, &_call_f_itemAt_c767);
}
...
{
  return new qt_gsi::GenericMethod ("setGeometry|geometry=", "@brief Method void QGraphicsAnchorLayout::setGeometry(const QRectF &rect)\nThis is a reimplementation of QGraphicsLayoutItem::setGeometry", false, &_init_f_setGeometry_1862, &_call_f_setGeometry_1862);
}
...
{
  return new qt_gsi::GenericMethod ("setHorizontalSpacing|horizontalSpacing=", "@brief Method void QGraphicsAnchorLayout::setHorizontalSpacing(double spacing)\n", false, &_init_f_setHorizontalSpacing_1071, &_call_f_setHorizontalSpacing_1071);
}
...
{
  return new qt_gsi::GenericMethod ("setSpacing", "@brief Method void QGraphicsAnchorLayout::setSpacing(double spacing)\n", false, &_init_f_setSpacing_1071, &_call_f_setSpacing_1071);
}
...
{
  return new qt_gsi::GenericMethod ("setVerticalSpacing|verticalSpacing=", "@brief Method void QGraphicsAnchorLayout::setVerticalSpacing(double spacing)\n", false, &_init_f_setVerticalSpacing_1071, &_call_f_setVerticalSpacing_1071);
}
...
{
  return new qt_gsi::GenericMethod (":verticalSpacing", "@brief Method double QGraphicsAnchorLayout::verticalSpacing()\n", true, &_init_f_verticalSpacing_c0, &_call_f_verticalSpacing_c0);
}
...
gsi::Class<QGraphicsAnchorLayout> decl_QGraphicsAnchorLayout (decl_QGraphicsLayout, "QGraphicsAnchorLayout_Native",
  gsi::Methods(_create_f_addAnchor_8538 ()) +
  gsi::Methods(_create_f_addAnchors_7507 ()) +
  gsi::Methods(_create_f_addCornerAnchors_7522 ()) +
  gsi::Methods(_create_f_anchor_8538 ()) +
...
public:
  ...
  //  void QGraphicsAnchorLayout::addChildLayoutItem(QGraphicsLayoutItem *layoutItem)
  ...
  //  void QGraphicsAnchorLayout::setOwnedByLayout(bool ownedByLayout)
...
static qt_gsi::GenericStaticMethod *_create_ctor_QGraphicsAnchorLayout_Adaptor_2557 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QGraphicsAnchorLayout::QGraphicsAnchorLayout(QGraphicsLayoutItem *parent)\nThis method creates an object of class QGraphicsAnchorLayout.", &_init_ctor_QGraphicsAnchorLayout_Adaptor_2557, &_call_ctor_QGraphicsAnchorLayout_Adaptor_2557);
}
...
extern gsi::Class<QGraphicsAnchorLayout> decl_QGraphicsAnchorLayout;

gsi::Class<QGraphicsAnchorLayout_Adaptor> decl_QGraphicsAnchorLayout_Adaptor (decl_QGraphicsAnchorLayout, "QGraphicsAnchorLayout",
  ...
  gsi::Methods(_create_ctor_QGraphicsAnchorLayout_Adaptor_2557 ()),
