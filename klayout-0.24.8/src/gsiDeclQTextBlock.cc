...
#include "gsiDeclQTextBlock_Enums.h"
#include <memory>
...
static qt_gsi::GenericStaticMethod *_create_ctor_QTextBlock_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QTextBlock::QTextBlock()\nThis method creates an object of class QTextBlock.", &_init_ctor_QTextBlock_0, &_call_ctor_QTextBlock_0);
}
...
static qt_gsi::GenericStaticMethod *_create_ctor_QTextBlock_2306 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QTextBlock::QTextBlock(const QTextBlock &o)\nThis method creates an object of class QTextBlock.", &_init_ctor_QTextBlock_2306, &_call_ctor_QTextBlock_2306);
}
...
{
  return new qt_gsi::GenericMethod ("begin", "@brief Method QTextBlock::iterator QTextBlock::begin()\n", true, &_init_f_begin_c0, &_call_f_begin_c0);
}
...
{
  return new qt_gsi::GenericMethod ("blockFormat", "@brief Method QTextBlockFormat QTextBlock::blockFormat()\n", true, &_init_f_blockFormat_c0, &_call_f_blockFormat_c0);
}
...
static qt_gsi::GenericMethod *_create_f_blockFormatIndex_c0 ()
{
  return new qt_gsi::GenericMethod ("blockFormatIndex", "@brief Method int QTextBlock::blockFormatIndex()\n", true, &_init_f_blockFormatIndex_c0, &_call_f_blockFormatIndex_c0);
}
...
{
  return new qt_gsi::GenericMethod ("blockNumber", "@brief Method int QTextBlock::blockNumber()\n", true, &_init_f_blockNumber_c0, &_call_f_blockNumber_c0);
}
...
{
  return new qt_gsi::GenericMethod ("charFormat", "@brief Method QTextCharFormat QTextBlock::charFormat()\n", true, &_init_f_charFormat_c0, &_call_f_charFormat_c0);
}
...
{
  return new qt_gsi::GenericMethod ("charFormatIndex", "@brief Method int QTextBlock::charFormatIndex()\n", true, &_init_f_charFormatIndex_c0, &_call_f_charFormatIndex_c0);
}
...
{
  return new qt_gsi::GenericMethod ("clearLayout", "@brief Method void QTextBlock::clearLayout()\n", false, &_init_f_clearLayout_0, &_call_f_clearLayout_0);
}
...
{
  return new qt_gsi::GenericMethod ("contains", "@brief Method bool QTextBlock::contains(int position)\n", true, &_init_f_contains_c767, &_call_f_contains_c767);
}
...
{
  return new qt_gsi::GenericMethod ("document", "@brief Method const QTextDocument *QTextBlock::document()\n", true, &_init_f_document_c0, &_call_f_document_c0);
}
...
{
  return new qt_gsi::GenericMethod ("end", "@brief Method QTextBlock::iterator QTextBlock::end()\n", true, &_init_f_end_c0, &_call_f_end_c0);
}
...
static qt_gsi::GenericMethod *_create_f_firstLineNumber_c0 ()
{
  return new qt_gsi::GenericMethod ("firstLineNumber", "@brief Method int QTextBlock::firstLineNumber()\n", true, &_init_f_firstLineNumber_c0, &_call_f_firstLineNumber_c0);
}
...
static qt_gsi::GenericMethod *_create_f_fragmentIndex_c0 ()
{
  return new qt_gsi::GenericMethod ("fragmentIndex", "@brief Method int QTextBlock::fragmentIndex()\n", true, &_init_f_fragmentIndex_c0, &_call_f_fragmentIndex_c0);
}
...
{
  return new qt_gsi::GenericMethod ("isValid?", "@brief Method bool QTextBlock::isValid()\n", true, &_init_f_isValid_c0, &_call_f_isValid_c0);
}
...
{
  return new qt_gsi::GenericMethod ("isVisible?|:visible", "@brief Method bool QTextBlock::isVisible()\n", true, &_init_f_isVisible_c0, &_call_f_isVisible_c0);
}
...
{
  return new qt_gsi::GenericMethod ("layout", "@brief Method QTextLayout *QTextBlock::layout()\n", true, &_init_f_layout_c0, &_call_f_layout_c0);
}
...
{
  return new qt_gsi::GenericMethod ("length", "@brief Method int QTextBlock::length()\n", true, &_init_f_length_c0, &_call_f_length_c0);
}
...
{
  return new qt_gsi::GenericMethod (":lineCount", "@brief Method int QTextBlock::lineCount()\n", true, &_init_f_lineCount_c0, &_call_f_lineCount_c0);
}
...
static qt_gsi::GenericMethod *_create_f_next_c0 ()
{
  return new qt_gsi::GenericMethod ("next", "@brief Method QTextBlock QTextBlock::next()\n", true, &_init_f_next_c0, &_call_f_next_c0);
}
...
static qt_gsi::GenericMethod *_create_f_operator_excl__eq__c2306 ()
{
  return new qt_gsi::GenericMethod ("!=", "@brief Method bool QTextBlock::operator!=(const QTextBlock &o)\n", true, &_init_f_operator_excl__eq__c2306, &_call_f_operator_excl__eq__c2306);
}
...
static qt_gsi::GenericMethod *_create_f_operator_lt__c2306 ()
{
...
static qt_gsi::GenericMethod *_create_f_operator_eq__2306 ()
{
  return new qt_gsi::GenericMethod ("assign", "@brief Method QTextBlock &QTextBlock::operator=(const QTextBlock &o)\n", false, &_init_f_operator_eq__2306, &_call_f_operator_eq__2306);
}
...
static qt_gsi::GenericMethod *_create_f_operator_eq__eq__c2306 ()
{
...
{
  return new qt_gsi::GenericMethod ("position", "@brief Method int QTextBlock::position()\n", true, &_init_f_position_c0, &_call_f_position_c0);
}
...
static qt_gsi::GenericMethod *_create_f_previous_c0 ()
{
  return new qt_gsi::GenericMethod ("previous", "@brief Method QTextBlock QTextBlock::previous()\n", true, &_init_f_previous_c0, &_call_f_previous_c0);
}
...
{
  return new qt_gsi::GenericMethod (":revision", "@brief Method int QTextBlock::revision()\n", true, &_init_f_revision_c0, &_call_f_revision_c0);
}
...
static qt_gsi::GenericMethod *_create_f_setLineCount_767 ()
{
  return new qt_gsi::GenericMethod ("setLineCount|lineCount=", "@brief Method void QTextBlock::setLineCount(int count)\n", false, &_init_f_setLineCount_767, &_call_f_setLineCount_767);
}
...
static qt_gsi::GenericMethod *_create_f_setRevision_767 ()
{
  return new qt_gsi::GenericMethod ("setRevision|revision=", "@brief Method void QTextBlock::setRevision(int rev)\n", false, &_init_f_setRevision_767, &_call_f_setRevision_767);
}
...
{
  QTextBlockUserData *arg1 = args.read<QTextBlockUserData * > ();
  ((QTextBlock *)cls)->setUserData (arg1);
}

static qt_gsi::GenericMethod *_create_f_setUserData_2408 ()
{
  return new qt_gsi::GenericMethod ("setUserData|userData=", "@brief Method void QTextBlock::setUserData(QTextBlockUserData *data)\n", false, &_init_f_setUserData_2408, &_call_f_setUserData_2408);
}
...
static qt_gsi::GenericMethod *_create_f_setUserState_767 ()
{
  return new qt_gsi::GenericMethod ("setUserState|userState=", "@brief Method void QTextBlock::setUserState(int state)\n", false, &_init_f_setUserState_767, &_call_f_setUserState_767);
}
...
{
  return new qt_gsi::GenericMethod ("setVisible|visible=", "@brief Method void QTextBlock::setVisible(bool visible)\n", false, &_init_f_setVisible_864, &_call_f_setVisible_864);
}
...
{
  return new qt_gsi::GenericMethod ("text", "@brief Method QString QTextBlock::text()\n", true, &_init_f_text_c0, &_call_f_text_c0);
}
...
{
  return new qt_gsi::GenericMethod ("textList", "@brief Method QTextList *QTextBlock::textList()\n", true, &_init_f_textList_c0, &_call_f_textList_c0);
}
...
static qt_gsi::GenericMethod *_create_f_userData_c0 ()
{
  return new qt_gsi::GenericMethod (":userData", "@brief Method QTextBlockUserData *QTextBlock::userData()\n", true, &_init_f_userData_c0, &_call_f_userData_c0);
}
...
static qt_gsi::GenericMethod *_create_f_userState_c0 ()
{
  return new qt_gsi::GenericMethod (":userState", "@brief Method int QTextBlock::userState()\n", true, &_init_f_userState_c0, &_call_f_userState_c0);
}


namespace gsi
{
gsi::Class<QTextBlock> decl_QTextBlock ("QTextBlock",
  gsi::Methods(_create_ctor_QTextBlock_0 ()) +
  gsi::Methods(_create_ctor_QTextBlock_2306 ()) +
  gsi::Methods(_create_f_begin_c0 ()) +
  gsi::Methods(_create_f_blockFormat_c0 ()) +
  gsi::Methods(_create_f_blockFormatIndex_c0 ()) +
  ...
  gsi::Methods(_create_f_firstLineNumber_c0 ()) +
  gsi::Methods(_create_f_fragmentIndex_c0 ()) +
  ...
  gsi::Methods(_create_f_next_c0 ()) +
  gsi::Methods(_create_f_operator_excl__eq__c2306 ()) +
  gsi::Methods(_create_f_operator_lt__c2306 ()) +
  gsi::Methods(_create_f_operator_eq__2306 ()) +
  gsi::Methods(_create_f_operator_eq__eq__c2306 ()) +
  gsi::Methods(_create_f_position_c0 ()) +
  gsi::Methods(_create_f_previous_c0 ()) +
  gsi::Methods(_create_f_revision_c0 ()) +
  gsi::Methods(_create_f_setLineCount_767 ()) +
  gsi::Methods(_create_f_setRevision_767 ()) +
  gsi::Methods(_create_f_setUserData_2408 ()) +
  gsi::Methods(_create_f_setUserState_767 ()) +
  gsi::Methods(_create_f_setVisible_864 ()) +
  gsi::Methods(_create_f_text_c0 ()) +
  gsi::Methods(_create_f_textList_c0 ()) +
  gsi::Methods(_create_f_userData_c0 ()) +
  gsi::Methods(_create_f_userState_c0 ()),
