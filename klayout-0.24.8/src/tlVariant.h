...
protected:
  static const tl::VariantUserClassBase *instance (const std::type_info &type, bool reference, bool is_const);
  static void register_instance (const tl::VariantUserClassBase *inst, const std::type_info &type, bool reference, bool is_const);
  static void unregister_instance (const tl::VariantUserClassBase *inst, const std::type_info &type, bool reference, bool is_const);
};
...
public:
  ...
  static const tl::VariantUserClassBase *instance (bool reference, bool is_const)
  {
    return VariantUserClassBase::instance (typeid (T), reference, is_const);
  }
...
protected:
  void register_instance (const tl::VariantUserClassBase *inst, bool reference, bool is_const)
  {
    VariantUserClassBase::register_instance (inst, typeid (T), reference, is_const);
  }

  void unregister_instance (const tl::VariantUserClassBase *inst, bool reference, bool is_const)
  {
    VariantUserClassBase::unregister_instance (inst, typeid (T), reference, is_const);
  }
};
...
public:
  ...
  {
    const tl::VariantUserClassBase *c = tl::VariantUserClass<T>::instance (false, false);
    tl_assert (c != 0);
  ...
  {
    const tl::VariantUserClassBase *c = gsi::cls_decl<T> ()->var_cls (true, false);
    tl_assert (c != 0);
    return tl::Variant (0, (void *) t, c);
  }
  ...
  {
    const tl::VariantUserClassBase *c = gsi::cls_decl<T> ()->var_cls (true, true);
    tl_assert (c != 0);
    return tl::Variant (0, (void *) t, c);
  }
  ...
  {
    const tl::VariantUserClassBase *c = gsi::cls_decl<T> ()->var_cls (false, false);
    tl_assert (c != 0);
    return tl::Variant (0, (void *) t, c);
  }
  ...
  {
    const tl::VariantUserClassBase *c = gsi::cls_decl <T> ()->var_cls (false, is_const);
    tl_assert (c != 0);
    return tl::Variant (0, (void *) new T(t), c);
  }
  ...
  T &to_user ()
  {
    ...
    tl_assert (tcls != 0);
    T *t = tcls->get (m_var.mp_user.object);
    tl_assert (t);
    return *t;
  }
  ...
  const T &to_user () const
  {
    ...
    const VariantUserClass<T> *tcls = dynamic_cast<const VariantUserClass<T> *> (m_var.mp_user.cls);
    tl_assert (tcls != 0);
    const T *t = tcls->get (m_var.mp_user.object);
    tl_assert (t);
    return *t;
  }
