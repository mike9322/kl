...
#include "gsiDeclQShowEvent_Enums.h"
#include <memory>
...
gsi::Class<QShowEvent> decl_QShowEvent (decl_QEvent, "QShowEvent_Native",
  gsi::Methods(),
  "@hide\n@alias QShowEvent");
}
...
static qt_gsi::GenericStaticMethod *_create_ctor_QShowEvent_Adaptor_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QShowEvent::QShowEvent()\nThis method creates an object of class QShowEvent.", &_init_ctor_QShowEvent_Adaptor_0, &_call_ctor_QShowEvent_Adaptor_0);
}

namespace gsi
{

extern gsi::Class<QShowEvent> decl_QShowEvent;

gsi::Class<QShowEvent_Adaptor> decl_QShowEvent_Adaptor (decl_QShowEvent, "QShowEvent",
  gsi::Methods(_create_ctor_QShowEvent_Adaptor_0 ()),
