...
CellSelectionForm::CellSelectionForm (QWidget *parent, lay::LayoutView *view, const char *name, bool simple_mode, Qt::WFlags fl)
  : QDialog (parent, fl), Ui::CellSelectionForm (),
    mp_view (view),
    m_current_cv (-1),
...
SimpleCellSelectionForm::SimpleCellSelectionForm (QWidget *parent, db::Layout *layout, const char *name, Qt::WFlags fl)
  : QDialog (parent, fl), Ui::SimpleCellSelectionForm (),
    mp_layout (layout),
    m_name_cb_enabled (true),
    m_cells_cb_enabled (true),
    m_children_cb_enabled (true),
...
LibraryCellSelectionForm::LibraryCellSelectionForm (QWidget *parent, db::Layout *layout, const char *name, bool all_cells, Qt::WFlags fl)
  : QDialog (parent, fl), Ui::LibraryCellSelectionForm (),
...
LibraryCellSelectionForm::LibraryCellSelectionForm (QWidget *parent, const char *name, bool all_cells, Qt::WFlags fl)
  : QDialog (parent, fl), Ui::LibraryCellSelectionForm (),
