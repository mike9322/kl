...
/**
*  @file gsiDeclQMdiArea_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQMdiArea_Enums
#define _HDR_gsiDeclQMdiArea_Enums
...
//  Wrapper class for QFlags<enum QMdiArea::AreaOption>
class QMdiArea_AreaOption_Enums : public QFlags<enum QMdiArea::AreaOption> {
public:
  QMdiArea_AreaOption_Enums () : m_flags () { }
  QMdiArea_AreaOption_Enums (enum QMdiArea::AreaOption v) : m_flags (v) { }
  QMdiArea_AreaOption_Enums (const QFlags<enum QMdiArea::AreaOption> &v) : m_flags (v) { }
  QFlags<enum QMdiArea::AreaOption> flags () const { return m_flags; }
private:
  QFlags<QMdiArea::AreaOption> m_flags;
};

//  Wrapper class for enum QMdiArea::AreaOption
class QMdiArea_AreaOption_Enum : public QMdiArea_AreaOption_Enums {
public:
  QMdiArea_AreaOption_Enum () { }
  QMdiArea_AreaOption_Enum (enum QMdiArea::AreaOption v) : QMdiArea_AreaOption_Enums (v) { }
  enum QMdiArea::AreaOption value () const { return (enum QMdiArea::AreaOption) flags ().operator int (); }
};

//  Converter for QFlags<enum QMdiArea::AreaOption>
template <>
struct Converter<QFlags<enum QMdiArea::AreaOption> >
{
public:
  typedef QFlags<enum QMdiArea::AreaOption> source_type;
  typedef QMdiArea_AreaOption_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QMdiArea::AreaOption
template <>
struct Converter<enum QMdiArea::AreaOption>
{
public:
  typedef enum QMdiArea::AreaOption source_type;
  typedef QMdiArea_AreaOption_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Wrapper class for QFlags<enum QMdiArea::ViewMode>
class QMdiArea_ViewMode_Enums : public QFlags<enum QMdiArea::ViewMode> {
public:
  QMdiArea_ViewMode_Enums () : m_flags () { }
  QMdiArea_ViewMode_Enums (enum QMdiArea::ViewMode v) : m_flags (v) { }
  QMdiArea_ViewMode_Enums (const QFlags<enum QMdiArea::ViewMode> &v) : m_flags (v) { }
  QFlags<enum QMdiArea::ViewMode> flags () const { return m_flags; }
private:
  QFlags<QMdiArea::ViewMode> m_flags;
};

//  Wrapper class for enum QMdiArea::ViewMode
class QMdiArea_ViewMode_Enum : public QMdiArea_ViewMode_Enums {
public:
  QMdiArea_ViewMode_Enum () { }
  QMdiArea_ViewMode_Enum (enum QMdiArea::ViewMode v) : QMdiArea_ViewMode_Enums (v) { }
  enum QMdiArea::ViewMode value () const { return (enum QMdiArea::ViewMode) flags ().operator int (); }
};

//  Converter for QFlags<enum QMdiArea::ViewMode>
template <>
struct Converter<QFlags<enum QMdiArea::ViewMode> >
{
public:
  typedef QFlags<enum QMdiArea::ViewMode> source_type;
  typedef QMdiArea_ViewMode_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QMdiArea::ViewMode
template <>
struct Converter<enum QMdiArea::ViewMode>
{
public:
  typedef enum QMdiArea::ViewMode source_type;
  typedef QMdiArea_ViewMode_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Wrapper class for QFlags<enum QMdiArea::WindowOrder>
class QMdiArea_WindowOrder_Enums : public QFlags<enum QMdiArea::WindowOrder> {
public:
  QMdiArea_WindowOrder_Enums () : m_flags () { }
  QMdiArea_WindowOrder_Enums (enum QMdiArea::WindowOrder v) : m_flags (v) { }
  QMdiArea_WindowOrder_Enums (const QFlags<enum QMdiArea::WindowOrder> &v) : m_flags (v) { }
  QFlags<enum QMdiArea::WindowOrder> flags () const { return m_flags; }
private:
  QFlags<QMdiArea::WindowOrder> m_flags;
};

//  Wrapper class for enum QMdiArea::WindowOrder
class QMdiArea_WindowOrder_Enum : public QMdiArea_WindowOrder_Enums {
public:
  QMdiArea_WindowOrder_Enum () { }
  QMdiArea_WindowOrder_Enum (enum QMdiArea::WindowOrder v) : QMdiArea_WindowOrder_Enums (v) { }
  enum QMdiArea::WindowOrder value () const { return (enum QMdiArea::WindowOrder) flags ().operator int (); }
};

//  Converter for QFlags<enum QMdiArea::WindowOrder>
template <>
struct Converter<QFlags<enum QMdiArea::WindowOrder> >
{
public:
  typedef QFlags<enum QMdiArea::WindowOrder> source_type;
  typedef QMdiArea_WindowOrder_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QMdiArea::WindowOrder
template <>
struct Converter<enum QMdiArea::WindowOrder>
{
public:
  typedef enum QMdiArea::WindowOrder source_type;
  typedef QMdiArea_WindowOrder_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};
...
//  Wrapper class for QFlags<enum QTabWidget::TabPosition>
class QTabWidget_TabPosition_Enums : public QFlags<enum QTabWidget::TabPosition> {
public:
  QTabWidget_TabPosition_Enums () : m_flags () { }
  QTabWidget_TabPosition_Enums (enum QTabWidget::TabPosition v) : m_flags (v) { }
  QTabWidget_TabPosition_Enums (const QFlags<enum QTabWidget::TabPosition> &v) : m_flags (v) { }
  QFlags<enum QTabWidget::TabPosition> flags () const { return m_flags; }
private:
  QFlags<QTabWidget::TabPosition> m_flags;
};

//  Wrapper class for enum QTabWidget::TabPosition
class QTabWidget_TabPosition_Enum : public QTabWidget_TabPosition_Enums {
public:
  QTabWidget_TabPosition_Enum () { }
  QTabWidget_TabPosition_Enum (enum QTabWidget::TabPosition v) : QTabWidget_TabPosition_Enums (v) { }
  enum QTabWidget::TabPosition value () const { return (enum QTabWidget::TabPosition) flags ().operator int (); }
};

//  Converter for QFlags<enum QTabWidget::TabPosition>
template <>
struct Converter<QFlags<enum QTabWidget::TabPosition> >
{
public:
  typedef QFlags<enum QTabWidget::TabPosition> source_type;
  typedef QTabWidget_TabPosition_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QTabWidget::TabPosition
template <>
struct Converter<enum QTabWidget::TabPosition>
{
public:
  typedef enum QTabWidget::TabPosition source_type;
  typedef QTabWidget_TabPosition_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Wrapper class for QFlags<enum QTabWidget::TabShape>
class QTabWidget_TabShape_Enums : public QFlags<enum QTabWidget::TabShape> {
public:
  QTabWidget_TabShape_Enums () : m_flags () { }
  QTabWidget_TabShape_Enums (enum QTabWidget::TabShape v) : m_flags (v) { }
  QTabWidget_TabShape_Enums (const QFlags<enum QTabWidget::TabShape> &v) : m_flags (v) { }
  QFlags<enum QTabWidget::TabShape> flags () const { return m_flags; }
private:
  QFlags<QTabWidget::TabShape> m_flags;
};

//  Wrapper class for enum QTabWidget::TabShape
class QTabWidget_TabShape_Enum : public QTabWidget_TabShape_Enums {
public:
  QTabWidget_TabShape_Enum () { }
  QTabWidget_TabShape_Enum (enum QTabWidget::TabShape v) : QTabWidget_TabShape_Enums (v) { }
  enum QTabWidget::TabShape value () const { return (enum QTabWidget::TabShape) flags ().operator int (); }
};

//  Converter for QFlags<enum QTabWidget::TabShape>
template <>
struct Converter<QFlags<enum QTabWidget::TabShape> >
{
public:
  typedef QFlags<enum QTabWidget::TabShape> source_type;
  typedef QTabWidget_TabShape_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QTabWidget::TabShape
template <>
struct Converter<enum QTabWidget::TabShape>
{
public:
  typedef enum QTabWidget::TabShape source_type;
  typedef QTabWidget_TabShape_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};
