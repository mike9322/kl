...
/**
*  @file generated/gsiDeclQTextEdit_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQTextEdit_EventAdaptor
#define _HDR_gsiDeclQTextEdit_EventAdaptor
...
public:
  QTextEdit_EventAdaptor (QObject *host);
