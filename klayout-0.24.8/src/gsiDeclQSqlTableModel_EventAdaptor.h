...
/**
*  @file generated/gsiDeclQSqlTableModel_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQSqlTableModel_EventAdaptor
#define _HDR_gsiDeclQSqlTableModel_EventAdaptor
...
public:
  QSqlTableModel_EventAdaptor (QObject *host);
