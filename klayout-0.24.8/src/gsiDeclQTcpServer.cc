...
#include "gsiDeclQTcpServer_EventAdaptor.h"
#include "gsiDeclQTcpServer_Enums.h"
#include <memory>
...
{
  return new qt_gsi::GenericMethod ("close", "@brief Method void QTcpServer::close()\n", false, &_init_f_close_0, &_call_f_close_0);
}
...
{
  return new qt_gsi::GenericMethod ("errorString", "@brief Method QString QTcpServer::errorString()\n", true, &_init_f_errorString_c0, &_call_f_errorString_c0);
}
...
{
  return new qt_gsi::GenericMethod ("hasPendingConnections", "@brief Method bool QTcpServer::hasPendingConnections()\n", true, &_init_f_hasPendingConnections_c0, &_call_f_hasPendingConnections_c0);
}
...
{
  return new qt_gsi::GenericMethod ("isListening?", "@brief Method bool QTcpServer::isListening()\n", true, &_init_f_isListening_c0, &_call_f_isListening_c0);
}
...
{
  const QHostAddress &arg1 = args ? args.read<const QHostAddress & > () : (const QHostAddress &)(QHostAddress::Any);
  quint16 arg2 = args ? args.read<quint16 > () : (quint16)(0);
  ret.write<bool > ((bool)((QTcpServer *)cls)->listen (arg1, arg2));
}

static qt_gsi::GenericMethod *_create_f_listen_3510 ()
{
  return new qt_gsi::GenericMethod ("listen", "@brief Method bool QTcpServer::listen(const QHostAddress &address, quint16 port)\n", false, &_init_f_listen_3510, &_call_f_listen_3510);
}
...
{
  return new qt_gsi::GenericMethod (":maxPendingConnections", "@brief Method int QTcpServer::maxPendingConnections()\n", true, &_init_f_maxPendingConnections_c0, &_call_f_maxPendingConnections_c0);
}
...
{
  return new qt_gsi::GenericMethod ("nextPendingConnection", "@brief Method QTcpSocket *QTcpServer::nextPendingConnection()\n", false, &_init_f_nextPendingConnection_0, &_call_f_nextPendingConnection_0);
}
...
{
  return new qt_gsi::GenericMethod (":proxy", "@brief Method QNetworkProxy QTcpServer::proxy()\n", true, &_init_f_proxy_c0, &_call_f_proxy_c0);
}
...
static qt_gsi::GenericMethod *_create_f_serverAddress_c0 ()
{
  return new qt_gsi::GenericMethod ("serverAddress", "@brief Method QHostAddress QTcpServer::serverAddress()\n", true, &_init_f_serverAddress_c0, &_call_f_serverAddress_c0);
}
...
{
  return new qt_gsi::GenericMethod ("serverError", "@brief Method QAbstractSocket::SocketError QTcpServer::serverError()\n", true, &_init_f_serverError_c0, &_call_f_serverError_c0);
}
...
static qt_gsi::GenericMethod *_create_f_serverPort_c0 ()
{
  return new qt_gsi::GenericMethod ("serverPort", "@brief Method quint16 QTcpServer::serverPort()\n", true, &_init_f_serverPort_c0, &_call_f_serverPort_c0);
}
...
{
  return new qt_gsi::GenericMethod ("setMaxPendingConnections|maxPendingConnections=", "@brief Method void QTcpServer::setMaxPendingConnections(int numConnections)\n", false, &_init_f_setMaxPendingConnections_767, &_call_f_setMaxPendingConnections_767);
}
...
{
  return new qt_gsi::GenericMethod ("setProxy|proxy=", "@brief Method void QTcpServer::setProxy(const QNetworkProxy &networkProxy)\n", false, &_init_f_setProxy_2686, &_call_f_setProxy_2686);
}
...
static qt_gsi::GenericMethod *_create_f_setSocketDescriptor_767 ()
{
  return new qt_gsi::GenericMethod ("setSocketDescriptor", "@brief Method bool QTcpServer::setSocketDescriptor(int socketDescriptor)\n", false, &_init_f_setSocketDescriptor_767, &_call_f_setSocketDescriptor_767);
}
...
{
  return new qt_gsi::GenericMethod ("socketDescriptor", "@brief Method int QTcpServer::socketDescriptor()\n", true, &_init_f_socketDescriptor_c0, &_call_f_socketDescriptor_c0);
}
...
{
  return new qt_gsi::GenericMethod ("waitForNewConnection", "@brief Method bool QTcpServer::waitForNewConnection(int msec, bool *timedOut)\n", false, &_init_f_waitForNewConnection_1709, &_call_f_waitForNewConnection_1709);
}
...
{
  return new qt_gsi::GenericStaticMethod ("tr", "@brief Static method QString QTcpServer::tr(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_tr_3354, &_call_f_tr_3354);
}
...
{
  return new qt_gsi::GenericStaticMethod ("tr", "@brief Static method QString QTcpServer::tr(const char *s, const char *c, int n)\nThis method is static and can be called without an instance.", &_init_f_tr_4013, &_call_f_tr_4013);
}
...
{
  return new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QTcpServer::trUtf8(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_3354, &_call_f_trUtf8_3354);
}
...
{
  return new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QTcpServer::trUtf8(const char *s, const char *c, int n)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_4013, &_call_f_trUtf8_4013);
}

static qt_gsi::QObjectConnector<QTcpServer, QTcpServer_EventAdaptor> ea_QTcpServer;

namespace gsi
{
extern gsi::Class<QObject> decl_QObject;

gsi::Class<QTcpServer> decl_QTcpServer (ea_QTcpServer, decl_QObject, "QTcpServer_Native",
  ...
  gsi::Methods(_create_f_listen_3510 ()) +
  ...
  gsi::Methods(_create_f_serverAddress_c0 ()) +
  gsi::Methods(_create_f_serverError_c0 ()) +
  gsi::Methods(_create_f_serverPort_c0 ()) +
  gsi::Methods(_create_f_setMaxPendingConnections_767 ()) +
  gsi::Methods(_create_f_setProxy_2686 ()) +
  gsi::Methods(_create_f_setSocketDescriptor_767 ()) +
  gsi::Methods(_create_f_socketDescriptor_c0 ()) +
  gsi::Methods(_create_f_waitForNewConnection_1709 ()) +
  qt_gsi::qt_signal<QTcpServer, QTcpServer_EventAdaptor, QObject *> ("destroyed", &QTcpServer_EventAdaptor::destroyed_e_1302, gsi::arg("arg1"), "@brief Signal declaration for QTcpServer::destroyed(QObject *)\nYou can bind a procedure to this signal.") +
  qt_gsi::qt_signal<QTcpServer, QTcpServer_EventAdaptor> ("newConnection", &QTcpServer_EventAdaptor::newConnection_e_0, "@brief Signal declaration for QTcpServer::newConnection()\nYou can bind a procedure to this signal.") +
...
static qt_gsi::GenericStaticMethod *_create_ctor_QTcpServer_Adaptor_1302 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QTcpServer::QTcpServer(QObject *parent)\nThis method creates an object of class QTcpServer.", &_init_ctor_QTcpServer_Adaptor_1302, &_call_ctor_QTcpServer_Adaptor_1302);
}
...
{
  return new qt_gsi::GenericMethod("*receivers", "@brief Method int QTcpServer::receivers(const char *signal)\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_receivers_c1731, &_call_fp_receivers_c1731);
}
...
{
  return new qt_gsi::GenericMethod("*sender", "@brief Method QObject *QTcpServer::sender()\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_sender_c0, &_call_fp_sender_c0);
}
...
{
  return new qt_gsi::GenericMethod ("event", "@brief Virtual method bool QTcpServer::event(QEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_event_1217_0, &_call_cbs_event_1217_0, &_set_callback_cbs_event_1217_0);
}
...
{
  return new qt_gsi::GenericMethod ("eventFilter", "@brief Virtual method bool QTcpServer::eventFilter(QObject *, QEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_eventFilter_2411_0, &_call_cbs_eventFilter_2411_0, &_set_callback_cbs_eventFilter_2411_0);
}
...
{
  return new qt_gsi::GenericMethod ("*childEvent", "@brief Virtual method void QTcpServer::childEvent(QChildEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_childEvent_1701_0, &_call_cbs_childEvent_1701_0, &_set_callback_cbs_childEvent_1701_0);
}
...
{
  return new qt_gsi::GenericMethod ("*customEvent", "@brief Virtual method void QTcpServer::customEvent(QEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_customEvent_1217_0, &_call_cbs_customEvent_1217_0, &_set_callback_cbs_customEvent_1217_0);
}
...
{
  return new qt_gsi::GenericMethod ("*disconnectNotify", "@brief Virtual method void QTcpServer::disconnectNotify(const char *signal)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_disconnectNotify_1731_0, &_call_cbs_disconnectNotify_1731_0, &_set_callback_cbs_disconnectNotify_1731_0);
}
...
static qt_gsi::GenericMethod *_create_cbs_incomingConnection_767_0 ()
{
  return new qt_gsi::GenericMethod ("*incomingConnection", "@hide", false, &_init_cbs_incomingConnection_767_0, &_call_cbs_incomingConnection_767_0);
}

static qt_gsi::GenericMethod *_create_callback_cbs_incomingConnection_767_0 ()
{
  return new qt_gsi::GenericMethod ("*incomingConnection", "@brief Virtual method void QTcpServer::incomingConnection(int handle)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_incomingConnection_767_0, &_call_cbs_incomingConnection_767_0, &_set_callback_cbs_incomingConnection_767_0);
}
...
{
  return new qt_gsi::GenericMethod ("*timerEvent", "@brief Virtual method void QTcpServer::timerEvent(QTimerEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_timerEvent_1730_0, &_call_cbs_timerEvent_1730_0, &_set_callback_cbs_timerEvent_1730_0);
}
...
extern gsi::Class<QTcpServer> decl_QTcpServer;

gsi::Class<QTcpServer_Adaptor> decl_QTcpServer_Adaptor (decl_QTcpServer, "QTcpServer",
  ...
  gsi::Methods(_create_cbs_incomingConnection_767_0 ()) +
  gsi::Methods(_create_callback_cbs_incomingConnection_767_0 ()) +
  gsi::Methods(_create_cbs_timerEvent_1730_0 ()) +
  gsi::Methods(_create_callback_cbs_timerEvent_1730_0 ()) +
  gsi::Methods(_create_ctor_QTcpServer_Adaptor_1302 ()),
