 ...
 */
class KLAYOUT_DLL LEFDEFReaderException
...
extern const std::string lef_def_technology_component_name;
 ...
 */
class KLAYOUT_DLL LEFDEFTechnologyComponent
  : public lay::TechnologyComponent
{
public:
  LEFDEFTechnologyComponent ();
  LEFDEFTechnologyComponent (const LEFDEFTechnologyComponent &d);
 ...
 */
class KLAYOUT_DLL LEFDEFLayerDelegate
{
public:
  /**
   *  @brief Constructor
   */
  LEFDEFLayerDelegate (const LEFDEFTechnologyComponent *tc);
   ...
   */
  const LEFDEFTechnologyComponent *tech_comp () const
  {
    return mp_tech_comp;
  }
...
private:
  ...
  const LEFDEFTechnologyComponent *mp_tech_comp;
};

/**
 *  @brief The LEF importer object
 */
class KLAYOUT_DLL LEFDEFImporter
{
public:
  /**
   ...
   */
  void read (tl::InputStream &stream, db::Layout &layout, LEFDEFLayerDelegate &layer_delegate, const std::string &fn);
...
protected:
  void create_generated_via (std::vector<db::Polygon> &bottom,
                             ...
                             const db::Point &cutsize, 
                             const db::Point &cutspacing,
                             const db::Point &be, const db::Point &te,
                             const db::Point &bo, const db::Point &to,
                             const db::Point &o,
