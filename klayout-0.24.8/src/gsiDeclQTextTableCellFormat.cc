...
#include "gsiDeclQTextTableCellFormat_Enums.h"
#include <memory>
...
static qt_gsi::GenericStaticMethod *_create_ctor_QTextTableCellFormat_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QTextTableCellFormat::QTextTableCellFormat()\nThis method creates an object of class QTextTableCellFormat.", &_init_ctor_QTextTableCellFormat_0, &_call_ctor_QTextTableCellFormat_0);
}
...
static qt_gsi::GenericMethod *_create_f_bottomPadding_c0 ()
{
  return new qt_gsi::GenericMethod (":bottomPadding", "@brief Method double QTextTableCellFormat::bottomPadding()\n", true, &_init_f_bottomPadding_c0, &_call_f_bottomPadding_c0);
}
...
{
  return new qt_gsi::GenericMethod ("isValid?", "@brief Method bool QTextTableCellFormat::isValid()\n", true, &_init_f_isValid_c0, &_call_f_isValid_c0);
}
...
static qt_gsi::GenericMethod *_create_f_leftPadding_c0 ()
{
  return new qt_gsi::GenericMethod (":leftPadding", "@brief Method double QTextTableCellFormat::leftPadding()\n", true, &_init_f_leftPadding_c0, &_call_f_leftPadding_c0);
}
...
static qt_gsi::GenericMethod *_create_f_rightPadding_c0 ()
{
  return new qt_gsi::GenericMethod (":rightPadding", "@brief Method double QTextTableCellFormat::rightPadding()\n", true, &_init_f_rightPadding_c0, &_call_f_rightPadding_c0);
}
...
static qt_gsi::GenericMethod *_create_f_setBottomPadding_1071 ()
{
  return new qt_gsi::GenericMethod ("setBottomPadding|bottomPadding=", "@brief Method void QTextTableCellFormat::setBottomPadding(double padding)\n", false, &_init_f_setBottomPadding_1071, &_call_f_setBottomPadding_1071);
}
...
static qt_gsi::GenericMethod *_create_f_setLeftPadding_1071 ()
{
  return new qt_gsi::GenericMethod ("setLeftPadding|leftPadding=", "@brief Method void QTextTableCellFormat::setLeftPadding(double padding)\n", false, &_init_f_setLeftPadding_1071, &_call_f_setLeftPadding_1071);
}
...
{
  return new qt_gsi::GenericMethod ("setPadding", "@brief Method void QTextTableCellFormat::setPadding(double padding)\n", false, &_init_f_setPadding_1071, &_call_f_setPadding_1071);
}
...
static qt_gsi::GenericMethod *_create_f_setRightPadding_1071 ()
{
  return new qt_gsi::GenericMethod ("setRightPadding|rightPadding=", "@brief Method void QTextTableCellFormat::setRightPadding(double padding)\n", false, &_init_f_setRightPadding_1071, &_call_f_setRightPadding_1071);
}
...
static qt_gsi::GenericMethod *_create_f_setTopPadding_1071 ()
{
  return new qt_gsi::GenericMethod ("setTopPadding|topPadding=", "@brief Method void QTextTableCellFormat::setTopPadding(double padding)\n", false, &_init_f_setTopPadding_1071, &_call_f_setTopPadding_1071);
}
...
static qt_gsi::GenericMethod *_create_f_topPadding_c0 ()
{
  return new qt_gsi::GenericMethod (":topPadding", "@brief Method double QTextTableCellFormat::topPadding()\n", true, &_init_f_topPadding_c0, &_call_f_topPadding_c0);
}
...
gsi::Class<QTextTableCellFormat> decl_QTextTableCellFormat (decl_QTextCharFormat, "QTextTableCellFormat",
  gsi::Methods(_create_ctor_QTextTableCellFormat_0 ()) +
  gsi::Methods(_create_f_bottomPadding_c0 ()) +
  gsi::Methods(_create_f_isValid_c0 ()) +
  gsi::Methods(_create_f_leftPadding_c0 ()) +
  gsi::Methods(_create_f_rightPadding_c0 ()) +
  gsi::Methods(_create_f_setBottomPadding_1071 ()) +
  gsi::Methods(_create_f_setLeftPadding_1071 ()) +
  gsi::Methods(_create_f_setPadding_1071 ()) +
  gsi::Methods(_create_f_setRightPadding_1071 ()) +
  gsi::Methods(_create_f_setTopPadding_1071 ()) +
  gsi::Methods(_create_f_topPadding_c0 ()),
