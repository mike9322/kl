...
#include "gsiDeclQStyleOptionFocusRect_Enums.h"
#include <memory>
...
static qt_gsi::GenericStaticMethod *_create_ctor_QStyleOptionFocusRect_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QStyleOptionFocusRect::QStyleOptionFocusRect()\nThis method creates an object of class QStyleOptionFocusRect.", &_init_ctor_QStyleOptionFocusRect_0, &_call_ctor_QStyleOptionFocusRect_0);
}
...
{
  const QStyleOptionFocusRect &arg1 = args.read<const QStyleOptionFocusRect & > ();
  ret.write<QStyleOptionFocusRect *> (new QStyleOptionFocusRect (arg1));
}

static qt_gsi::GenericStaticMethod *_create_ctor_QStyleOptionFocusRect_3466 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QStyleOptionFocusRect::QStyleOptionFocusRect(const QStyleOptionFocusRect &other)\nThis method creates an object of class QStyleOptionFocusRect.", &_init_ctor_QStyleOptionFocusRect_3466, &_call_ctor_QStyleOptionFocusRect_3466);
}
...
gsi::Class<QStyleOptionFocusRect> decl_QStyleOptionFocusRect (decl_QStyleOption, "QStyleOptionFocusRect",
  gsi::Methods(_create_ctor_QStyleOptionFocusRect_0 ()) +
  gsi::Methods(_create_ctor_QStyleOptionFocusRect_3466 ()),
