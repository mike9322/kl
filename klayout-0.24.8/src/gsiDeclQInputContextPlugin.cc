...
#include "gsiDeclQInputContextPlugin_Enums.h"
#include <memory>
...
{
  return new qt_gsi::GenericMethod ("qt_create", "@brief Method QInputContext *QInputContextPlugin::create(const QString &key)\n", false, &_init_f_create_2025, &_call_f_create_2025);
}
...
static qt_gsi::GenericMethod *_create_f_description_2025 ()
{
  return new qt_gsi::GenericMethod ("description", "@brief Method QString QInputContextPlugin::description(const QString &key)\n", false, &_init_f_description_2025, &_call_f_description_2025);
}
...
static qt_gsi::GenericMethod *_create_f_displayName_2025 ()
{
  return new qt_gsi::GenericMethod ("displayName", "@brief Method QString QInputContextPlugin::displayName(const QString &key)\n", false, &_init_f_displayName_2025, &_call_f_displayName_2025);
}
...
{
  ret.write<qt_gsi::Converter<QStringList>::target_type > ((qt_gsi::Converter<QStringList>::target_type)qt_gsi::CppToQtAdaptor<QStringList>(((QInputContextPlugin *)cls)->keys ()));
}

static qt_gsi::GenericMethod *_create_f_keys_c0 ()
{
  return new qt_gsi::GenericMethod ("keys", "@brief Method QStringList QInputContextPlugin::keys()\n", true, &_init_f_keys_c0, &_call_f_keys_c0);
}
...
{
  const QString &arg1 = args.read<const QString & > ();
  ret.write<qt_gsi::Converter<QStringList>::target_type > ((qt_gsi::Converter<QStringList>::target_type)qt_gsi::CppToQtAdaptor<QStringList>(((QInputContextPlugin *)cls)->languages (arg1)));
}

static qt_gsi::GenericMethod *_create_f_languages_2025 ()
{
  return new qt_gsi::GenericMethod ("languages", "@brief Method QStringList QInputContextPlugin::languages(const QString &key)\n", false, &_init_f_languages_2025, &_call_f_languages_2025);
}
...
{
  return new qt_gsi::GenericStaticMethod ("tr", "@brief Static method QString QInputContextPlugin::tr(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_tr_3354, &_call_f_tr_3354);
}
...
{
  return new qt_gsi::GenericStaticMethod ("tr", "@brief Static method QString QInputContextPlugin::tr(const char *s, const char *c, int n)\nThis method is static and can be called without an instance.", &_init_f_tr_4013, &_call_f_tr_4013);
}
...
{
  return new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QInputContextPlugin::trUtf8(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_3354, &_call_f_trUtf8_3354);
}
...
{
  return new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QInputContextPlugin::trUtf8(const char *s, const char *c, int n)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_4013, &_call_f_trUtf8_4013);
}

static qt_gsi::QObjectConnector<QInputContextPlugin, QInputContextPlugin_EventAdaptor> ea_QInputContextPlugin;

namespace gsi
{
extern gsi::Class<QObject> decl_QObject;

gsi::Class<QInputContextPlugin> decl_QInputContextPlugin (ea_QInputContextPlugin, decl_QObject, "QInputContextPlugin_Native",
  ...
  qt_gsi::qt_signal<QInputContextPlugin, QInputContextPlugin_EventAdaptor, QObject *> ("destroyed", &QInputContextPlugin_EventAdaptor::destroyed_e_1302, gsi::arg("arg1"), "@brief Signal declaration for QInputContextPlugin::destroyed(QObject *)\nYou can bind a procedure to this signal.") +
...
public:
  ...
  virtual QStringList keys() const
  {
    if (cb_keys_c0_0.can_issue()) {
      return qt_gsi::QtToCppAdaptor<QStringList>(cb_keys_c0_0.issue<QInputContextPlugin_Adaptor, qt_gsi::Converter<QStringList>::target_type>(&QInputContextPlugin_Adaptor::cbs_keys_c0_0)).cref();
    } else {
      throw qt_gsi::AbstractMethodCalledException("keys");
    }
  }
  ...
  qt_gsi::Converter<QStringList>::target_type cbs_languages_2025_0(const QString &key)
  {
  ...
  virtual QStringList languages(const QString &key)
  {
    if (cb_languages_2025_0.can_issue()) {
      return qt_gsi::QtToCppAdaptor<QStringList>(cb_languages_2025_0.issue<QInputContextPlugin_Adaptor, qt_gsi::Converter<QStringList>::target_type, const QString &>(&QInputContextPlugin_Adaptor::cbs_languages_2025_0, key)).cref();
    } else {
      throw qt_gsi::AbstractMethodCalledException("languages");
    }
  }
...
static qt_gsi::GenericStaticMethod *_create_ctor_QInputContextPlugin_Adaptor_1302 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QInputContextPlugin::QInputContextPlugin(QObject *parent)\nThis method creates an object of class QInputContextPlugin.", &_init_ctor_QInputContextPlugin_Adaptor_1302, &_call_ctor_QInputContextPlugin_Adaptor_1302);
}
...
{
  return new qt_gsi::GenericMethod("*receivers", "@brief Method int QInputContextPlugin::receivers(const char *signal)\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_receivers_c1731, &_call_fp_receivers_c1731);
}
...
{
  return new qt_gsi::GenericMethod("*sender", "@brief Method QObject *QInputContextPlugin::sender()\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_sender_c0, &_call_fp_sender_c0);
}
...
static qt_gsi::GenericMethod *_create_cbs_description_2025_0 ()
{
  return new qt_gsi::GenericMethod ("description", "@hide", false, &_init_cbs_description_2025_0, &_call_cbs_description_2025_0);
}

static qt_gsi::GenericMethod *_create_callback_cbs_description_2025_0 ()
{
  return new qt_gsi::GenericMethod ("description", "@brief Virtual method QString QInputContextPlugin::description(const QString &key)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_description_2025_0, &_call_cbs_description_2025_0, &_set_callback_cbs_description_2025_0);
}
...
static qt_gsi::GenericMethod *_create_cbs_displayName_2025_0 ()
{
  return new qt_gsi::GenericMethod ("displayName", "@hide", false, &_init_cbs_displayName_2025_0, &_call_cbs_displayName_2025_0);
}

static qt_gsi::GenericMethod *_create_callback_cbs_displayName_2025_0 ()
{
  return new qt_gsi::GenericMethod ("displayName", "@brief Virtual method QString QInputContextPlugin::displayName(const QString &key)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_displayName_2025_0, &_call_cbs_displayName_2025_0, &_set_callback_cbs_displayName_2025_0);
}
...
{
  return new qt_gsi::GenericMethod ("event", "@brief Virtual method bool QInputContextPlugin::event(QEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_event_1217_0, &_call_cbs_event_1217_0, &_set_callback_cbs_event_1217_0);
}
...
{
  return new qt_gsi::GenericMethod ("eventFilter", "@brief Virtual method bool QInputContextPlugin::eventFilter(QObject *, QEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_eventFilter_2411_0, &_call_cbs_eventFilter_2411_0, &_set_callback_cbs_eventFilter_2411_0);
}
...
{
  ret.write<qt_gsi::Converter<QStringList>::target_type > ((qt_gsi::Converter<QStringList>::target_type)((QInputContextPlugin_Adaptor *)cls)->cbs_keys_c0_0 ());
}
...
{
  const QString &arg1 = args.read<const QString & > ();
  ret.write<qt_gsi::Converter<QStringList>::target_type > ((qt_gsi::Converter<QStringList>::target_type)((QInputContextPlugin_Adaptor *)cls)->cbs_languages_2025_0 (arg1));
}
...
static qt_gsi::GenericMethod *_create_cbs_languages_2025_0 ()
{
  return new qt_gsi::GenericMethod ("languages", "@hide", false, &_init_cbs_languages_2025_0, &_call_cbs_languages_2025_0);
}

static qt_gsi::GenericMethod *_create_callback_cbs_languages_2025_0 ()
{
  return new qt_gsi::GenericMethod ("languages", "@brief Virtual method QStringList QInputContextPlugin::languages(const QString &key)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_languages_2025_0, &_call_cbs_languages_2025_0, &_set_callback_cbs_languages_2025_0);
}
...
{
  return new qt_gsi::GenericMethod ("*childEvent", "@brief Virtual method void QInputContextPlugin::childEvent(QChildEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_childEvent_1701_0, &_call_cbs_childEvent_1701_0, &_set_callback_cbs_childEvent_1701_0);
}
...
{
  return new qt_gsi::GenericMethod ("*customEvent", "@brief Virtual method void QInputContextPlugin::customEvent(QEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_customEvent_1217_0, &_call_cbs_customEvent_1217_0, &_set_callback_cbs_customEvent_1217_0);
}
...
{
  return new qt_gsi::GenericMethod ("*disconnectNotify", "@brief Virtual method void QInputContextPlugin::disconnectNotify(const char *signal)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_disconnectNotify_1731_0, &_call_cbs_disconnectNotify_1731_0, &_set_callback_cbs_disconnectNotify_1731_0);
}
...
{
  return new qt_gsi::GenericMethod ("*timerEvent", "@brief Virtual method void QInputContextPlugin::timerEvent(QTimerEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_timerEvent_1730_0, &_call_cbs_timerEvent_1730_0, &_set_callback_cbs_timerEvent_1730_0);
}
...
extern gsi::Class<QInputContextPlugin> decl_QInputContextPlugin;

gsi::Class<QInputContextPlugin_Adaptor> decl_QInputContextPlugin_Adaptor (decl_QInputContextPlugin, "QInputContextPlugin",
  gsi::Methods(_create_fp_receivers_c1731 ()) +
  gsi::Methods(_create_fp_sender_c0 ()) +
  gsi::Methods(_create_cbs_create_2025_0 ()) +
  gsi::Methods(_create_callback_cbs_create_2025_0 ()) +
  gsi::Methods(_create_cbs_description_2025_0 ()) +
  gsi::Methods(_create_callback_cbs_description_2025_0 ()) +
  gsi::Methods(_create_cbs_displayName_2025_0 ()) +
  gsi::Methods(_create_callback_cbs_displayName_2025_0 ()) +
  ...
  gsi::Methods(_create_cbs_languages_2025_0 ()) +
  gsi::Methods(_create_callback_cbs_languages_2025_0 ()) +
  ...
  gsi::Methods(_create_ctor_QInputContextPlugin_Adaptor_1302 ()),
