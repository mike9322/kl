...
/**
*  @file generated/gsiDeclQAbstractListModel_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQAbstractListModel_EventAdaptor
#define _HDR_gsiDeclQAbstractListModel_EventAdaptor
...
public:
  QAbstractListModel_EventAdaptor (QObject *host);
