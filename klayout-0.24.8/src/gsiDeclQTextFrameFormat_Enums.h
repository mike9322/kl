...
/**
*  @file gsiDeclQTextFrameFormat_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQTextFrameFormat_Enums
#define _HDR_gsiDeclQTextFrameFormat_Enums
...
//  Wrapper class for QFlags<enum QTextFrameFormat::BorderStyle>
class QTextFrameFormat_BorderStyle_Enums : public QFlags<enum QTextFrameFormat::BorderStyle> {
public:
  QTextFrameFormat_BorderStyle_Enums () : m_flags () { }
  QTextFrameFormat_BorderStyle_Enums (enum QTextFrameFormat::BorderStyle v) : m_flags (v) { }
  QTextFrameFormat_BorderStyle_Enums (const QFlags<enum QTextFrameFormat::BorderStyle> &v) : m_flags (v) { }
  QFlags<enum QTextFrameFormat::BorderStyle> flags () const { return m_flags; }
private:
  QFlags<QTextFrameFormat::BorderStyle> m_flags;
};

//  Wrapper class for enum QTextFrameFormat::BorderStyle
class QTextFrameFormat_BorderStyle_Enum : public QTextFrameFormat_BorderStyle_Enums {
public:
  QTextFrameFormat_BorderStyle_Enum () { }
  QTextFrameFormat_BorderStyle_Enum (enum QTextFrameFormat::BorderStyle v) : QTextFrameFormat_BorderStyle_Enums (v) { }
  enum QTextFrameFormat::BorderStyle value () const { return (enum QTextFrameFormat::BorderStyle) flags ().operator int (); }
};

//  Converter for QFlags<enum QTextFrameFormat::BorderStyle>
template <>
struct Converter<QFlags<enum QTextFrameFormat::BorderStyle> >
{
public:
  typedef QFlags<enum QTextFrameFormat::BorderStyle> source_type;
  typedef QTextFrameFormat_BorderStyle_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QTextFrameFormat::BorderStyle
template <>
struct Converter<enum QTextFrameFormat::BorderStyle>
{
public:
  typedef enum QTextFrameFormat::BorderStyle source_type;
  typedef QTextFrameFormat_BorderStyle_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};
