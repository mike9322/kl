...
/**
*  @file generated/gsiDeclQErrorMessage_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQErrorMessage_EventAdaptor
#define _HDR_gsiDeclQErrorMessage_EventAdaptor
...
public:
  QErrorMessage_EventAdaptor (QObject *host);
