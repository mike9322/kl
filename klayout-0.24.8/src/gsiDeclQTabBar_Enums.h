...
/**
*  @file gsiDeclQTabBar_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQTabBar_Enums
#define _HDR_gsiDeclQTabBar_Enums
...
//  Wrapper class for QFlags<enum QTabBar::ButtonPosition>
class QTabBar_ButtonPosition_Enums : public QFlags<enum QTabBar::ButtonPosition> {
public:
  QTabBar_ButtonPosition_Enums () : m_flags () { }
  QTabBar_ButtonPosition_Enums (enum QTabBar::ButtonPosition v) : m_flags (v) { }
  QTabBar_ButtonPosition_Enums (const QFlags<enum QTabBar::ButtonPosition> &v) : m_flags (v) { }
  QFlags<enum QTabBar::ButtonPosition> flags () const { return m_flags; }
private:
  QFlags<QTabBar::ButtonPosition> m_flags;
};

//  Wrapper class for enum QTabBar::ButtonPosition
class QTabBar_ButtonPosition_Enum : public QTabBar_ButtonPosition_Enums {
public:
  QTabBar_ButtonPosition_Enum () { }
  QTabBar_ButtonPosition_Enum (enum QTabBar::ButtonPosition v) : QTabBar_ButtonPosition_Enums (v) { }
  enum QTabBar::ButtonPosition value () const { return (enum QTabBar::ButtonPosition) flags ().operator int (); }
};

//  Converter for QFlags<enum QTabBar::ButtonPosition>
template <>
struct Converter<QFlags<enum QTabBar::ButtonPosition> >
{
public:
  typedef QFlags<enum QTabBar::ButtonPosition> source_type;
  typedef QTabBar_ButtonPosition_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QTabBar::ButtonPosition
template <>
struct Converter<enum QTabBar::ButtonPosition>
{
public:
  typedef enum QTabBar::ButtonPosition source_type;
  typedef QTabBar_ButtonPosition_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Wrapper class for QFlags<enum QTabBar::SelectionBehavior>
class QTabBar_SelectionBehavior_Enums : public QFlags<enum QTabBar::SelectionBehavior> {
public:
  QTabBar_SelectionBehavior_Enums () : m_flags () { }
  QTabBar_SelectionBehavior_Enums (enum QTabBar::SelectionBehavior v) : m_flags (v) { }
  QTabBar_SelectionBehavior_Enums (const QFlags<enum QTabBar::SelectionBehavior> &v) : m_flags (v) { }
  QFlags<enum QTabBar::SelectionBehavior> flags () const { return m_flags; }
private:
  QFlags<QTabBar::SelectionBehavior> m_flags;
};

//  Wrapper class for enum QTabBar::SelectionBehavior
class QTabBar_SelectionBehavior_Enum : public QTabBar_SelectionBehavior_Enums {
public:
  QTabBar_SelectionBehavior_Enum () { }
  QTabBar_SelectionBehavior_Enum (enum QTabBar::SelectionBehavior v) : QTabBar_SelectionBehavior_Enums (v) { }
  enum QTabBar::SelectionBehavior value () const { return (enum QTabBar::SelectionBehavior) flags ().operator int (); }
};

//  Converter for QFlags<enum QTabBar::SelectionBehavior>
template <>
struct Converter<QFlags<enum QTabBar::SelectionBehavior> >
{
public:
  typedef QFlags<enum QTabBar::SelectionBehavior> source_type;
  typedef QTabBar_SelectionBehavior_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QTabBar::SelectionBehavior
template <>
struct Converter<enum QTabBar::SelectionBehavior>
{
public:
  typedef enum QTabBar::SelectionBehavior source_type;
  typedef QTabBar_SelectionBehavior_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Wrapper class for QFlags<enum QTabBar::Shape>
class QTabBar_Shape_Enums : public QFlags<enum QTabBar::Shape> {
public:
  QTabBar_Shape_Enums () : m_flags () { }
  QTabBar_Shape_Enums (enum QTabBar::Shape v) : m_flags (v) { }
  QTabBar_Shape_Enums (const QFlags<enum QTabBar::Shape> &v) : m_flags (v) { }
  QFlags<enum QTabBar::Shape> flags () const { return m_flags; }
private:
  QFlags<QTabBar::Shape> m_flags;
};

//  Wrapper class for enum QTabBar::Shape
class QTabBar_Shape_Enum : public QTabBar_Shape_Enums {
public:
  QTabBar_Shape_Enum () { }
  QTabBar_Shape_Enum (enum QTabBar::Shape v) : QTabBar_Shape_Enums (v) { }
  enum QTabBar::Shape value () const { return (enum QTabBar::Shape) flags ().operator int (); }
};

//  Converter for QFlags<enum QTabBar::Shape>
template <>
struct Converter<QFlags<enum QTabBar::Shape> >
{
public:
  typedef QFlags<enum QTabBar::Shape> source_type;
  typedef QTabBar_Shape_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QTabBar::Shape
template <>
struct Converter<enum QTabBar::Shape>
{
public:
  typedef enum QTabBar::Shape source_type;
  typedef QTabBar_Shape_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};
