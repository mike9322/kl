...
/**
*  @file gsiDeclQImage_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQImage_Enums
#define _HDR_gsiDeclQImage_Enums
...
//  Wrapper class for QFlags<enum QImage::InvertMode>
class QImage_InvertMode_Enums : public QFlags<enum QImage::InvertMode> {
public:
  QImage_InvertMode_Enums () : m_flags () { }
  QImage_InvertMode_Enums (enum QImage::InvertMode v) : m_flags (v) { }
  QImage_InvertMode_Enums (const QFlags<enum QImage::InvertMode> &v) : m_flags (v) { }
  QFlags<enum QImage::InvertMode> flags () const { return m_flags; }
private:
  QFlags<QImage::InvertMode> m_flags;
};

//  Wrapper class for enum QImage::InvertMode
class QImage_InvertMode_Enum : public QImage_InvertMode_Enums {
public:
  QImage_InvertMode_Enum () { }
  QImage_InvertMode_Enum (enum QImage::InvertMode v) : QImage_InvertMode_Enums (v) { }
  enum QImage::InvertMode value () const { return (enum QImage::InvertMode) flags ().operator int (); }
};

//  Converter for QFlags<enum QImage::InvertMode>
template <>
struct Converter<QFlags<enum QImage::InvertMode> >
{
public:
  typedef QFlags<enum QImage::InvertMode> source_type;
  typedef QImage_InvertMode_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QImage::InvertMode
template <>
struct Converter<enum QImage::InvertMode>
{
public:
  typedef enum QImage::InvertMode source_type;
  typedef QImage_InvertMode_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};
