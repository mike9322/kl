...
/**
*  @file generated/gsiDeclQAbstractPrintDialog_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQAbstractPrintDialog_EventAdaptor
#define _HDR_gsiDeclQAbstractPrintDialog_EventAdaptor
...
public:
  QAbstractPrintDialog_EventAdaptor (QObject *host);
