...
/**
*  @file gsiDeclQFontDialog_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQFontDialog_Enums
#define _HDR_gsiDeclQFontDialog_Enums
...
//  Wrapper class for QFlags<enum QFontDialog::FontDialogOption>
class QFontDialog_FontDialogOption_Enums : public QFlags<enum QFontDialog::FontDialogOption> {
public:
  QFontDialog_FontDialogOption_Enums () : m_flags () { }
  QFontDialog_FontDialogOption_Enums (enum QFontDialog::FontDialogOption v) : m_flags (v) { }
  QFontDialog_FontDialogOption_Enums (const QFlags<enum QFontDialog::FontDialogOption> &v) : m_flags (v) { }
  QFlags<enum QFontDialog::FontDialogOption> flags () const { return m_flags; }
private:
  QFlags<QFontDialog::FontDialogOption> m_flags;
};

//  Wrapper class for enum QFontDialog::FontDialogOption
class QFontDialog_FontDialogOption_Enum : public QFontDialog_FontDialogOption_Enums {
public:
  QFontDialog_FontDialogOption_Enum () { }
  QFontDialog_FontDialogOption_Enum (enum QFontDialog::FontDialogOption v) : QFontDialog_FontDialogOption_Enums (v) { }
  enum QFontDialog::FontDialogOption value () const { return (enum QFontDialog::FontDialogOption) flags ().operator int (); }
};

//  Converter for QFlags<enum QFontDialog::FontDialogOption>
template <>
struct Converter<QFlags<enum QFontDialog::FontDialogOption> >
{
public:
  typedef QFlags<enum QFontDialog::FontDialogOption> source_type;
  typedef QFontDialog_FontDialogOption_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QFontDialog::FontDialogOption
template <>
struct Converter<enum QFontDialog::FontDialogOption>
{
public:
  typedef enum QFontDialog::FontDialogOption source_type;
  typedef QFontDialog_FontDialogOption_Enum target_type;
