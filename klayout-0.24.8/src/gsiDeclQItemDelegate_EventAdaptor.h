...
/**
*  @file generated/gsiDeclQItemDelegate_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQItemDelegate_EventAdaptor
#define _HDR_gsiDeclQItemDelegate_EventAdaptor
...
public:
  QItemDelegate_EventAdaptor (QObject *host);
