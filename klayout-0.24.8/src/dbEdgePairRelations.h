 ...
 */
struct KLAYOUT_DLL EdgeRelationFilter
{
...
KLAYOUT_DLL bool projected_near_part_of_edge (bool include_zero, db::Coord d, const db::Edge &e, const db::Edge &g, db::Edge *output);
KLAYOUT_DLL bool square_near_part_of_edge (bool include_zero, db::Coord d, const db::Edge &e, const db::Edge &g, db::Edge *output);
KLAYOUT_DLL bool euclidian_near_part_of_edge (bool include_zero, db::Coord d, const db::Edge &e, const db::Edge &g, db::Edge *output);
KLAYOUT_DLL db::Edge::distance_type edge_projection (const db::Edge &a, const db::Edge &b);
