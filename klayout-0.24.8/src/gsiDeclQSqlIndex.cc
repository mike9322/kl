...
#include "gsiDeclQSqlIndex_Enums.h"
#include <memory>
...
static qt_gsi::GenericStaticMethod *_create_ctor_QSqlIndex_3942 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QSqlIndex::QSqlIndex(const QString &cursorName, const QString &name)\nThis method creates an object of class QSqlIndex.", &_init_ctor_QSqlIndex_3942, &_call_ctor_QSqlIndex_3942);
}
...
{
  const QSqlIndex &arg1 = args.read<const QSqlIndex & > ();
  ret.write<QSqlIndex *> (new QSqlIndex (arg1));
}

static qt_gsi::GenericStaticMethod *_create_ctor_QSqlIndex_2202 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QSqlIndex::QSqlIndex(const QSqlIndex &other)\nThis method creates an object of class QSqlIndex.", &_init_ctor_QSqlIndex_2202, &_call_ctor_QSqlIndex_2202);
}
...
{
  return new qt_gsi::GenericMethod ("append", "@brief Method void QSqlIndex::append(const QSqlField &field)\n", false, &_init_f_append_2182, &_call_f_append_2182);
}
...
static qt_gsi::GenericMethod *_create_f_append_2938 ()
{
  return new qt_gsi::GenericMethod ("append", "@brief Method void QSqlIndex::append(const QSqlField &field, bool desc)\n", false, &_init_f_append_2938, &_call_f_append_2938);
}
...
static qt_gsi::GenericMethod *_create_f_cursorName_c0 ()
{
  return new qt_gsi::GenericMethod (":cursorName", "@brief Method QString QSqlIndex::cursorName()\n", true, &_init_f_cursorName_c0, &_call_f_cursorName_c0);
}
...
static qt_gsi::GenericMethod *_create_f_isDescending_c767 ()
{
  return new qt_gsi::GenericMethod ("isDescending?", "@brief Method bool QSqlIndex::isDescending(int i)\n", true, &_init_f_isDescending_c767, &_call_f_isDescending_c767);
}
...
{
  return new qt_gsi::GenericMethod (":name", "@brief Method QString QSqlIndex::name()\n", true, &_init_f_name_c0, &_call_f_name_c0);
}
...
static qt_gsi::GenericMethod *_create_f_operator_eq__2202 ()
{
  return new qt_gsi::GenericMethod ("assign", "@brief Method QSqlIndex &QSqlIndex::operator=(const QSqlIndex &other)\n", false, &_init_f_operator_eq__2202, &_call_f_operator_eq__2202);
}
...
static qt_gsi::GenericMethod *_create_f_setCursorName_2025 ()
{
  return new qt_gsi::GenericMethod ("setCursorName|cursorName=", "@brief Method void QSqlIndex::setCursorName(const QString &cursorName)\n", false, &_init_f_setCursorName_2025, &_call_f_setCursorName_2025);
}
...
static qt_gsi::GenericMethod *_create_f_setDescending_1523 ()
{
  return new qt_gsi::GenericMethod ("setDescending", "@brief Method void QSqlIndex::setDescending(int i, bool desc)\n", false, &_init_f_setDescending_1523, &_call_f_setDescending_1523);
}
...
{
  return new qt_gsi::GenericMethod ("setName|name=", "@brief Method void QSqlIndex::setName(const QString &name)\n", false, &_init_f_setName_2025, &_call_f_setName_2025);
}


namespace gsi
{
extern gsi::Class<QSqlRecord> decl_QSqlRecord;

gsi::Class<QSqlIndex> decl_QSqlIndex (decl_QSqlRecord, "QSqlIndex",
  gsi::Methods(_create_ctor_QSqlIndex_3942 ()) +
  gsi::Methods(_create_ctor_QSqlIndex_2202 ()) +
  gsi::Methods(_create_f_append_2182 ()) +
  gsi::Methods(_create_f_append_2938 ()) +
  gsi::Methods(_create_f_cursorName_c0 ()) +
  gsi::Methods(_create_f_isDescending_c767 ()) +
  gsi::Methods(_create_f_name_c0 ()) +
  gsi::Methods(_create_f_operator_eq__2202 ()) +
  gsi::Methods(_create_f_setCursorName_2025 ()) +
  gsi::Methods(_create_f_setDescending_1523 ()) +
