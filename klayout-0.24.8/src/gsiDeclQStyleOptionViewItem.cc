...
#include "gsiDeclQStyleOptionViewItem_Enums.h"
#include <memory>
...
static qt_gsi::GenericStaticMethod *_create_ctor_QStyleOptionViewItem_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QStyleOptionViewItem::QStyleOptionViewItem()\nThis method creates an object of class QStyleOptionViewItem.", &_init_ctor_QStyleOptionViewItem_0, &_call_ctor_QStyleOptionViewItem_0);
}
...
static qt_gsi::GenericStaticMethod *_create_ctor_QStyleOptionViewItem_3366 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QStyleOptionViewItem::QStyleOptionViewItem(const QStyleOptionViewItem &other)\nThis method creates an object of class QStyleOptionViewItem.", &_init_ctor_QStyleOptionViewItem_3366, &_call_ctor_QStyleOptionViewItem_3366);
}
...
gsi::Class<QStyleOptionViewItem> decl_QStyleOptionViewItem (decl_QStyleOption, "QStyleOptionViewItem",
  gsi::Methods(_create_ctor_QStyleOptionViewItem_0 ()) +
  gsi::Methods(_create_ctor_QStyleOptionViewItem_3366 ()),
