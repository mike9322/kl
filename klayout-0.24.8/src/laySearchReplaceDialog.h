...
public:
  ...
  {
    QueryShapeResult (const db::Shape &s, unsigned int l, const db::CplxTrans &t, db::cell_index_type ci, db::cell_index_type ici)
  ...
  {
    QueryInstResult (const db::Instance &i, const db::CplxTrans &t, db::cell_index_type ci, db::cell_index_type ici)
...
public:
  ...
  SearchReplaceDialog (lay::MainWindow *main, lay::LayoutView *view);
  ~SearchReplaceDialog ();
