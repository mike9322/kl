...
/**
*  @file generated/gsiDeclQDockWidget_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQDockWidget_EventAdaptor
#define _HDR_gsiDeclQDockWidget_EventAdaptor
...
public:
  QDockWidget_EventAdaptor (QObject *host);
...
public:
  gsi::event<const qt_gsi::Converter<QFlags<Qt::DockWidgetArea> >::target_type &> allowedAreasChanged_e_2819;
  gsi::event<const QPoint &> customContextMenuRequested_e_1916;
  gsi::event<QObject *> destroyed_e_1302;
  gsi::event<const qt_gsi::Converter<Qt::DockWidgetArea>::target_type &> dockLocationChanged_e_2123;
  gsi::event<const qt_gsi::Converter<QFlags<QDockWidget::DockWidgetFeature> >::target_type &> featuresChanged_e_4039;
  gsi::event<bool> topLevelChanged_e_864;
  gsi::event<bool> visibilityChanged_e_864;
};
