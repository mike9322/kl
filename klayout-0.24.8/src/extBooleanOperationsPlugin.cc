...
public:
  ...
  void boolean ()
  {
    ...
    if (dialog.exec (mp_view, m_boolean_cva, m_boolean_layera, m_boolean_cvb, m_boolean_layerb, m_boolean_cvr, m_boolean_layerr, m_boolean_mode, m_boolean_hier_mode, m_boolean_mincoh)) {
  ...
  void merge ()
  {
    ...
    if (dialog.exec (mp_view, m_boolean_cva, m_boolean_layera, m_boolean_cvr, m_boolean_layerr, m_boolean_minwc, m_boolean_hier_mode, m_boolean_mincoh)) {
  ...
  void size ()
  {
    ...
    if (dialog.exec (mp_view, m_boolean_cva, m_boolean_layera, m_boolean_cvr, m_boolean_layerr, m_boolean_sizex, m_boolean_sizey, m_boolean_size_mode, m_boolean_hier_mode, m_boolean_mincoh)) {
...
public:
  ...
  {
    return new BooleanOperationsPlugin (main_window, view);
  }
};
