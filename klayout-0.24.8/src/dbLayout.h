 ...
 */
template <class C>
class KLAYOUT_DLL cell_list_iterator
{
public:
  typedef C cell_type;
 ...
 */
class KLAYOUT_DLL LayerIterator
{
public:
  /**
   *  @brief Constructor
...
public:
   ...
   */
  void flatten (const db::Cell &source_cell, db::Cell &target_cell, const db::CplxTrans &t, int levels);
