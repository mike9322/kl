...
#include "gsiDeclQResource_Enums.h"
#include <memory>
...
static void _call_ctor_QResource_3903 (const qt_gsi::GenericStaticMethod *decl, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  const QLocale &arg2 = args ? args.read<const QLocale & > () : (const QLocale &)(QLocale());
  ret.write<QResource *> (new QResource (arg1, arg2));
}

static qt_gsi::GenericStaticMethod *_create_ctor_QResource_3903 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QResource::QResource(const QString &file, const QLocale &locale)\nThis method creates an object of class QResource.", &_init_ctor_QResource_3903, &_call_ctor_QResource_3903);
}
...
{
  return new qt_gsi::GenericMethod ("absoluteFilePath", "@brief Method QString QResource::absoluteFilePath()\n", true, &_init_f_absoluteFilePath_c0, &_call_f_absoluteFilePath_c0);
}
...
{
  return new qt_gsi::GenericMethod ("data", "@brief Method const unsigned char *QResource::data()\n", true, &_init_f_data_c0, &_call_f_data_c0);
}
...
{
  return new qt_gsi::GenericMethod (":fileName", "@brief Method QString QResource::fileName()\n", true, &_init_f_fileName_c0, &_call_f_fileName_c0);
}
...
static qt_gsi::GenericMethod *_create_f_isCompressed_c0 ()
{
  return new qt_gsi::GenericMethod ("isCompressed?", "@brief Method bool QResource::isCompressed()\n", true, &_init_f_isCompressed_c0, &_call_f_isCompressed_c0);
}
...
{
  return new qt_gsi::GenericMethod ("isValid?", "@brief Method bool QResource::isValid()\n", true, &_init_f_isValid_c0, &_call_f_isValid_c0);
}
...
{
  return new qt_gsi::GenericMethod (":locale", "@brief Method QLocale QResource::locale()\n", true, &_init_f_locale_c0, &_call_f_locale_c0);
}
...
{
  return new qt_gsi::GenericMethod ("setFileName|fileName=", "@brief Method void QResource::setFileName(const QString &file)\n", false, &_init_f_setFileName_2025, &_call_f_setFileName_2025);
}
...
{
  return new qt_gsi::GenericMethod ("setLocale|locale=", "@brief Method void QResource::setLocale(const QLocale &locale)\n", false, &_init_f_setLocale_1986, &_call_f_setLocale_1986);
}
...
{
  return new qt_gsi::GenericMethod ("size", "@brief Method qint64 QResource::size()\n", true, &_init_f_size_c0, &_call_f_size_c0);
}
...
static qt_gsi::GenericStaticMethod *_create_f_addSearchPath_2025 ()
{
  return new qt_gsi::GenericStaticMethod ("addSearchPath", "@brief Static method void QResource::addSearchPath(const QString &path)\nThis method is static and can be called without an instance.", &_init_f_addSearchPath_2025, &_call_f_addSearchPath_2025);
}
...
static qt_gsi::GenericStaticMethod *_create_f_registerResource_3942 ()
{
  return new qt_gsi::GenericStaticMethod ("registerResource_file", "@brief Static method bool QResource::registerResource(const QString &rccFilename, const QString &resourceRoot)\nThis method is static and can be called without an instance.", &_init_f_registerResource_3942, &_call_f_registerResource_3942);
}
...
static qt_gsi::GenericStaticMethod *_create_f_registerResource_4653 ()
{
  return new qt_gsi::GenericStaticMethod ("registerResource_data", "@brief Static method bool QResource::registerResource(const unsigned char *rccData, const QString &resourceRoot)\nThis method is static and can be called without an instance.", &_init_f_registerResource_4653, &_call_f_registerResource_4653);
}
...
{
  ret.write<qt_gsi::Converter<QStringList>::target_type > ((qt_gsi::Converter<QStringList>::target_type)qt_gsi::CppToQtAdaptor<QStringList>(QResource::searchPaths ()));
}

static qt_gsi::GenericStaticMethod *_create_f_searchPaths_0 ()
{
  return new qt_gsi::GenericStaticMethod ("searchPaths", "@brief Static method QStringList QResource::searchPaths()\nThis method is static and can be called without an instance.", &_init_f_searchPaths_0, &_call_f_searchPaths_0);
}
...
static qt_gsi::GenericStaticMethod *_create_f_unregisterResource_3942 ()
{
  return new qt_gsi::GenericStaticMethod ("unregisterResource_file", "@brief Static method bool QResource::unregisterResource(const QString &rccFilename, const QString &resourceRoot)\nThis method is static and can be called without an instance.", &_init_f_unregisterResource_3942, &_call_f_unregisterResource_3942);
}
...
static qt_gsi::GenericStaticMethod *_create_f_unregisterResource_4653 ()
{
  return new qt_gsi::GenericStaticMethod ("unregisterResource_data", "@brief Static method bool QResource::unregisterResource(const unsigned char *rccData, const QString &resourceRoot)\nThis method is static and can be called without an instance.", &_init_f_unregisterResource_4653, &_call_f_unregisterResource_4653);
}
...
gsi::Class<QResource> decl_QResource ("QResource",
  ...
  gsi::Methods(_create_f_addSearchPath_2025 ()) +
  gsi::Methods(_create_f_registerResource_3942 ()) +
  gsi::Methods(_create_f_registerResource_4653 ()) +
  gsi::Methods(_create_f_searchPaths_0 ()) +
  gsi::Methods(_create_f_unregisterResource_3942 ()) +
  gsi::Methods(_create_f_unregisterResource_4653 ()),
