...
#include "gsiDeclQMimeSource_Enums.h"
#include <memory>
...
{
  return new qt_gsi::GenericMethod ("encodedData", "@brief Method QByteArray QMimeSource::encodedData(const char *)\n", true, &_init_f_encodedData_c1731, &_call_f_encodedData_c1731);
}
...
{
  return new qt_gsi::GenericMethod ("format", "@brief Method const char *QMimeSource::format(int n)\n", true, &_init_f_format_c767, &_call_f_format_c767);
}
...
{
  return new qt_gsi::GenericMethod ("provides", "@brief Method bool QMimeSource::provides(const char *)\n", true, &_init_f_provides_c1731, &_call_f_provides_c1731);
}
...
static qt_gsi::GenericStaticMethod *_create_ctor_QMimeSource_Adaptor_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QMimeSource::QMimeSource()\nThis method creates an object of class QMimeSource.", &_init_ctor_QMimeSource_Adaptor_0, &_call_ctor_QMimeSource_Adaptor_0);
}
...
extern gsi::Class<QMimeSource> decl_QMimeSource;

gsi::Class<QMimeSource_Adaptor> decl_QMimeSource_Adaptor (decl_QMimeSource, "QMimeSource",
  ...
  gsi::Methods(_create_ctor_QMimeSource_Adaptor_0 ()),
