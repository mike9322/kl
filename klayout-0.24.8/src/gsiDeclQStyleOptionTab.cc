...
#include "gsiDeclQStyleOptionTab_Enums.h"
#include <memory>
...
static qt_gsi::GenericStaticMethod *_create_ctor_QStyleOptionTab_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QStyleOptionTab::QStyleOptionTab()\nThis method creates an object of class QStyleOptionTab.", &_init_ctor_QStyleOptionTab_0, &_call_ctor_QStyleOptionTab_0);
}
...
static qt_gsi::GenericStaticMethod *_create_ctor_QStyleOptionTab_2835 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QStyleOptionTab::QStyleOptionTab(const QStyleOptionTab &other)\nThis method creates an object of class QStyleOptionTab.", &_init_ctor_QStyleOptionTab_2835, &_call_ctor_QStyleOptionTab_2835);
}
...
gsi::Class<QStyleOptionTab> decl_QStyleOptionTab (decl_QStyleOption, "QStyleOptionTab",
  gsi::Methods(_create_ctor_QStyleOptionTab_0 ()) +
  gsi::Methods(_create_ctor_QStyleOptionTab_2835 ()),
