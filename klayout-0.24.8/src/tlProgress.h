...
class KLAYOUT_DLL ProgressAdaptor
{
public:  
  ProgressAdaptor ();
...
class KLAYOUT_DLL BreakException
  : public tl::Exception
{
public:
 ...
 */
class KLAYOUT_DLL RelativeProgress
  : public Progress
{
public:
  /**
 ...
 */
class KLAYOUT_DLL AbsoluteProgress
  : public Progress
{
public:
  /**
  ...
  /**
   *  @brief Set the resolution for the output (granularity)
   *
