...
static qt_gsi::GenericMethod *_create_f_appendHtml_2025 ()
{
  return new qt_gsi::GenericMethod ("appendHtml", "@brief Method void QPlainTextEdit::appendHtml(const QString &html)\n", false, &_init_f_appendHtml_2025, &_call_f_appendHtml_2025);
}
...
static qt_gsi::GenericMethod *_create_f_appendPlainText_2025 ()
{
  return new qt_gsi::GenericMethod ("appendPlainText", "@brief Method void QPlainTextEdit::appendPlainText(const QString &text)\n", false, &_init_f_appendPlainText_2025, &_call_f_appendPlainText_2025);
}
...
static qt_gsi::GenericMethod *_create_f_backgroundVisible_c0 ()
{
  return new qt_gsi::GenericMethod (":backgroundVisible", "@brief Method bool QPlainTextEdit::backgroundVisible()\n", true, &_init_f_backgroundVisible_c0, &_call_f_backgroundVisible_c0);
}
...
{
  return new qt_gsi::GenericMethod (":blockCount", "@brief Method int QPlainTextEdit::blockCount()\n", true, &_init_f_blockCount_c0, &_call_f_blockCount_c0);
}
...
{
  return new qt_gsi::GenericMethod ("canPaste", "@brief Method bool QPlainTextEdit::canPaste()\n", true, &_init_f_canPaste_c0, &_call_f_canPaste_c0);
}
...
static qt_gsi::GenericMethod *_create_f_centerCursor_0 ()
{
  return new qt_gsi::GenericMethod ("centerCursor", "@brief Method void QPlainTextEdit::centerCursor()\n", false, &_init_f_centerCursor_0, &_call_f_centerCursor_0);
}
...
static qt_gsi::GenericMethod *_create_f_centerOnScroll_c0 ()
{
  return new qt_gsi::GenericMethod (":centerOnScroll", "@brief Method bool QPlainTextEdit::centerOnScroll()\n", true, &_init_f_centerOnScroll_c0, &_call_f_centerOnScroll_c0);
}
...
{
  return new qt_gsi::GenericMethod ("clear", "@brief Method void QPlainTextEdit::clear()\n", false, &_init_f_clear_0, &_call_f_clear_0);
}
...
{
  return new qt_gsi::GenericMethod ("copy", "@brief Method void QPlainTextEdit::copy()\n", false, &_init_f_copy_0, &_call_f_copy_0);
}
...
{
  return new qt_gsi::GenericMethod ("createStandardContextMenu", "@brief Method QMenu *QPlainTextEdit::createStandardContextMenu()\n", false, &_init_f_createStandardContextMenu_0, &_call_f_createStandardContextMenu_0);
}
...
{
  return new qt_gsi::GenericMethod (":currentCharFormat", "@brief Method QTextCharFormat QPlainTextEdit::currentCharFormat()\n", true, &_init_f_currentCharFormat_c0, &_call_f_currentCharFormat_c0);
}
...
{
  return new qt_gsi::GenericMethod ("cursorForPosition", "@brief Method QTextCursor QPlainTextEdit::cursorForPosition(const QPoint &pos)\n", true, &_init_f_cursorForPosition_c1916, &_call_f_cursorForPosition_c1916);
}
...
{
  return new qt_gsi::GenericMethod ("cursorRect", "@brief Method QRect QPlainTextEdit::cursorRect(const QTextCursor &cursor)\n", true, &_init_f_cursorRect_c2453, &_call_f_cursorRect_c2453);
}
...
{
  return new qt_gsi::GenericMethod ("cursorRect", "@brief Method QRect QPlainTextEdit::cursorRect()\n", true, &_init_f_cursorRect_c0, &_call_f_cursorRect_c0);
}
...
{
  return new qt_gsi::GenericMethod (":cursorWidth", "@brief Method int QPlainTextEdit::cursorWidth()\n", true, &_init_f_cursorWidth_c0, &_call_f_cursorWidth_c0);
}
...
{
  return new qt_gsi::GenericMethod ("cut", "@brief Method void QPlainTextEdit::cut()\n", false, &_init_f_cut_0, &_call_f_cut_0);
}
...
{
  return new qt_gsi::GenericMethod (":document", "@brief Method QTextDocument *QPlainTextEdit::document()\n", true, &_init_f_document_c0, &_call_f_document_c0);
}
...
{
  return new qt_gsi::GenericMethod (":documentTitle", "@brief Method QString QPlainTextEdit::documentTitle()\n", true, &_init_f_documentTitle_c0, &_call_f_documentTitle_c0);
}
...
{
  return new qt_gsi::GenericMethod ("ensureCursorVisible", "@brief Method void QPlainTextEdit::ensureCursorVisible()\n", false, &_init_f_ensureCursorVisible_0, &_call_f_ensureCursorVisible_0);
}
...
{
  ret.write<qt_gsi::Converter<QList<QTextEdit::ExtraSelection> >::target_type > ((qt_gsi::Converter<QList<QTextEdit::ExtraSelection> >::target_type)qt_gsi::CppToQtAdaptor<QList<QTextEdit::ExtraSelection> >(((QPlainTextEdit *)cls)->extraSelections ()));
}

static qt_gsi::GenericMethod *_create_f_extraSelections_c0 ()
{
  return new qt_gsi::GenericMethod (":extraSelections", "@brief Method QList<QTextEdit::ExtraSelection> QPlainTextEdit::extraSelections()\n", true, &_init_f_extraSelections_c0, &_call_f_extraSelections_c0);
}
...
static void _call_f_find_5261 (const qt_gsi::GenericMethod *decl, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ret.write<bool > ((bool)((QPlainTextEdit *)cls)->find (arg1, qt_gsi::QtToCppAdaptor<QFlags<QTextDocument::FindFlag> >(arg2).cref()));
}

static qt_gsi::GenericMethod *_create_f_find_5261 ()
{
  return new qt_gsi::GenericMethod ("find", "@brief Method bool QPlainTextEdit::find(const QString &exp, QFlags<QTextDocument::FindFlag> options)\n", false, &_init_f_find_5261, &_call_f_find_5261);
}
...
{
  return new qt_gsi::GenericMethod ("insertPlainText", "@brief Method void QPlainTextEdit::insertPlainText(const QString &text)\n", false, &_init_f_insertPlainText_2025, &_call_f_insertPlainText_2025);
}
...
{
  return new qt_gsi::GenericMethod ("isReadOnly?|:readOnly", "@brief Method bool QPlainTextEdit::isReadOnly()\n", true, &_init_f_isReadOnly_c0, &_call_f_isReadOnly_c0);
}
...
{
  return new qt_gsi::GenericMethod ("isUndoRedoEnabled?|:undoRedoEnabled", "@brief Method bool QPlainTextEdit::isUndoRedoEnabled()\n", true, &_init_f_isUndoRedoEnabled_c0, &_call_f_isUndoRedoEnabled_c0);
}
...
{
  return new qt_gsi::GenericMethod (":lineWrapMode", "@brief Method QPlainTextEdit::LineWrapMode QPlainTextEdit::lineWrapMode()\n", true, &_init_f_lineWrapMode_c0, &_call_f_lineWrapMode_c0);
}
...
{
  return new qt_gsi::GenericMethod ("loadResource", "@brief Method QVariant QPlainTextEdit::loadResource(int type, const QUrl &name)\n", false, &_init_f_loadResource_2360, &_call_f_loadResource_2360);
}
...
{
  return new qt_gsi::GenericMethod (":maximumBlockCount", "@brief Method int QPlainTextEdit::maximumBlockCount()\n", true, &_init_f_maximumBlockCount_c0, &_call_f_maximumBlockCount_c0);
}
...
{
  return new qt_gsi::GenericMethod ("mergeCurrentCharFormat", "@brief Method void QPlainTextEdit::mergeCurrentCharFormat(const QTextCharFormat &modifier)\n", false, &_init_f_mergeCurrentCharFormat_2814, &_call_f_mergeCurrentCharFormat_2814);
}
...
{
  return new qt_gsi::GenericMethod ("moveCursor", "@brief Method void QPlainTextEdit::moveCursor(QTextCursor::MoveOperation operation, QTextCursor::MoveMode mode)\n", false, &_init_f_moveCursor_5424, &_call_f_moveCursor_5424);
}
...
{
  return new qt_gsi::GenericMethod (":overwriteMode", "@brief Method bool QPlainTextEdit::overwriteMode()\n", true, &_init_f_overwriteMode_c0, &_call_f_overwriteMode_c0);
}
...
{
  return new qt_gsi::GenericMethod ("paste", "@brief Method void QPlainTextEdit::paste()\n", false, &_init_f_paste_0, &_call_f_paste_0);
}
...
{
  return new qt_gsi::GenericMethod ("print", "@brief Method void QPlainTextEdit::print(QPrinter *printer)\n", true, &_init_f_print_c1443, &_call_f_print_c1443);
}
...
{
  return new qt_gsi::GenericMethod ("redo", "@brief Method void QPlainTextEdit::redo()\n", false, &_init_f_redo_0, &_call_f_redo_0);
}
...
{
  return new qt_gsi::GenericMethod ("selectAll", "@brief Method void QPlainTextEdit::selectAll()\n", false, &_init_f_selectAll_0, &_call_f_selectAll_0);
}
...
static qt_gsi::GenericMethod *_create_f_setBackgroundVisible_864 ()
{
  return new qt_gsi::GenericMethod ("setBackgroundVisible|backgroundVisible=", "@brief Method void QPlainTextEdit::setBackgroundVisible(bool visible)\n", false, &_init_f_setBackgroundVisible_864, &_call_f_setBackgroundVisible_864);
}
...
static qt_gsi::GenericMethod *_create_f_setCenterOnScroll_864 ()
{
  return new qt_gsi::GenericMethod ("setCenterOnScroll|centerOnScroll=", "@brief Method void QPlainTextEdit::setCenterOnScroll(bool enabled)\n", false, &_init_f_setCenterOnScroll_864, &_call_f_setCenterOnScroll_864);
}
...
{
  return new qt_gsi::GenericMethod ("setCurrentCharFormat|currentCharFormat=", "@brief Method void QPlainTextEdit::setCurrentCharFormat(const QTextCharFormat &format)\n", false, &_init_f_setCurrentCharFormat_2814, &_call_f_setCurrentCharFormat_2814);
}
...
{
  return new qt_gsi::GenericMethod ("setCursorWidth|cursorWidth=", "@brief Method void QPlainTextEdit::setCursorWidth(int width)\n", false, &_init_f_setCursorWidth_767, &_call_f_setCursorWidth_767);
}
...
{
  return new qt_gsi::GenericMethod ("setDocument|document=", "@brief Method void QPlainTextEdit::setDocument(QTextDocument *document)\n", false, &_init_f_setDocument_1955, &_call_f_setDocument_1955);
}
...
{
  return new qt_gsi::GenericMethod ("setDocumentTitle|documentTitle=", "@brief Method void QPlainTextEdit::setDocumentTitle(const QString &title)\n", false, &_init_f_setDocumentTitle_2025, &_call_f_setDocumentTitle_2025);
}
...
static void _call_f_setExtraSelections_4386 (const qt_gsi::GenericMethod *decl, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ((QPlainTextEdit *)cls)->setExtraSelections (qt_gsi::QtToCppAdaptor<QList<QTextEdit::ExtraSelection> >(arg1).cref());
}

static qt_gsi::GenericMethod *_create_f_setExtraSelections_4386 ()
{
  return new qt_gsi::GenericMethod ("setExtraSelections|extraSelections=", "@brief Method void QPlainTextEdit::setExtraSelections(const QList<QTextEdit::ExtraSelection> &selections)\n", false, &_init_f_setExtraSelections_4386, &_call_f_setExtraSelections_4386);
}
...
{
  const qt_gsi::Converter<QPlainTextEdit::LineWrapMode>::target_type & arg1 = args.read<const qt_gsi::Converter<QPlainTextEdit::LineWrapMode>::target_type & > ();
  ((QPlainTextEdit *)cls)->setLineWrapMode (qt_gsi::QtToCppAdaptor<QPlainTextEdit::LineWrapMode>(arg1).cref());
}

static qt_gsi::GenericMethod *_create_f_setLineWrapMode_3135 ()
{
  return new qt_gsi::GenericMethod ("setLineWrapMode|lineWrapMode=", "@brief Method void QPlainTextEdit::setLineWrapMode(QPlainTextEdit::LineWrapMode mode)\n", false, &_init_f_setLineWrapMode_3135, &_call_f_setLineWrapMode_3135);
}
...
{
  return new qt_gsi::GenericMethod ("setMaximumBlockCount|maximumBlockCount=", "@brief Method void QPlainTextEdit::setMaximumBlockCount(int maximum)\n", false, &_init_f_setMaximumBlockCount_767, &_call_f_setMaximumBlockCount_767);
}
...
{
  return new qt_gsi::GenericMethod ("setOverwriteMode|overwriteMode=", "@brief Method void QPlainTextEdit::setOverwriteMode(bool overwrite)\n", false, &_init_f_setOverwriteMode_864, &_call_f_setOverwriteMode_864);
}
...
{
  return new qt_gsi::GenericMethod ("setPlainText|plainText=", "@brief Method void QPlainTextEdit::setPlainText(const QString &text)\n", false, &_init_f_setPlainText_2025, &_call_f_setPlainText_2025);
}
...
{
  return new qt_gsi::GenericMethod ("setReadOnly|readOnly=", "@brief Method void QPlainTextEdit::setReadOnly(bool ro)\n", false, &_init_f_setReadOnly_864, &_call_f_setReadOnly_864);
}
...
{
  return new qt_gsi::GenericMethod ("setTabChangesFocus|tabChangesFocus=", "@brief Method void QPlainTextEdit::setTabChangesFocus(bool b)\n", false, &_init_f_setTabChangesFocus_864, &_call_f_setTabChangesFocus_864);
}
...
{
  return new qt_gsi::GenericMethod ("setTabStopWidth|tabStopWidth=", "@brief Method void QPlainTextEdit::setTabStopWidth(int width)\n", false, &_init_f_setTabStopWidth_767, &_call_f_setTabStopWidth_767);
}
...
{
  return new qt_gsi::GenericMethod ("setTextCursor|textCursor=", "@brief Method void QPlainTextEdit::setTextCursor(const QTextCursor &cursor)\n", false, &_init_f_setTextCursor_2453, &_call_f_setTextCursor_2453);
}
...
static void _call_f_setTextInteractionFlags_3396 (const qt_gsi::GenericMethod *decl, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ((QPlainTextEdit *)cls)->setTextInteractionFlags (qt_gsi::QtToCppAdaptor<QFlags<Qt::TextInteractionFlag> >(arg1).cref());
}

static qt_gsi::GenericMethod *_create_f_setTextInteractionFlags_3396 ()
{
  return new qt_gsi::GenericMethod ("setTextInteractionFlags|textInteractionFlags=", "@brief Method void QPlainTextEdit::setTextInteractionFlags(QFlags<Qt::TextInteractionFlag> flags)\n", false, &_init_f_setTextInteractionFlags_3396, &_call_f_setTextInteractionFlags_3396);
}
...
{
  return new qt_gsi::GenericMethod ("setUndoRedoEnabled|undoRedoEnabled=", "@brief Method void QPlainTextEdit::setUndoRedoEnabled(bool enable)\n", false, &_init_f_setUndoRedoEnabled_864, &_call_f_setUndoRedoEnabled_864);
}
...
{
  return new qt_gsi::GenericMethod ("setWordWrapMode|wordWrapMode=", "@brief Method void QPlainTextEdit::setWordWrapMode(QTextOption::WrapMode policy)\n", false, &_init_f_setWordWrapMode_2486, &_call_f_setWordWrapMode_2486);
}
...
{
  return new qt_gsi::GenericMethod (":tabChangesFocus", "@brief Method bool QPlainTextEdit::tabChangesFocus()\n", true, &_init_f_tabChangesFocus_c0, &_call_f_tabChangesFocus_c0);
}
...
{
  return new qt_gsi::GenericMethod (":tabStopWidth", "@brief Method int QPlainTextEdit::tabStopWidth()\n", true, &_init_f_tabStopWidth_c0, &_call_f_tabStopWidth_c0);
}
...
{
  return new qt_gsi::GenericMethod (":textCursor", "@brief Method QTextCursor QPlainTextEdit::textCursor()\n", true, &_init_f_textCursor_c0, &_call_f_textCursor_c0);
}
...
{
  ret.write<qt_gsi::Converter<QFlags<Qt::TextInteractionFlag> >::target_type > ((qt_gsi::Converter<QFlags<Qt::TextInteractionFlag> >::target_type)qt_gsi::CppToQtAdaptor<QFlags<Qt::TextInteractionFlag> >(((QPlainTextEdit *)cls)->textInteractionFlags ()));
}

static qt_gsi::GenericMethod *_create_f_textInteractionFlags_c0 ()
{
  return new qt_gsi::GenericMethod (":textInteractionFlags", "@brief Method QFlags<Qt::TextInteractionFlag> QPlainTextEdit::textInteractionFlags()\n", true, &_init_f_textInteractionFlags_c0, &_call_f_textInteractionFlags_c0);
}
...
{
  return new qt_gsi::GenericMethod ("toPlainText", "@brief Method QString QPlainTextEdit::toPlainText()\n", true, &_init_f_toPlainText_c0, &_call_f_toPlainText_c0);
}
...
{
  return new qt_gsi::GenericMethod ("undo", "@brief Method void QPlainTextEdit::undo()\n", false, &_init_f_undo_0, &_call_f_undo_0);
}
...
{
  return new qt_gsi::GenericMethod (":wordWrapMode", "@brief Method QTextOption::WrapMode QPlainTextEdit::wordWrapMode()\n", true, &_init_f_wordWrapMode_c0, &_call_f_wordWrapMode_c0);
}
...
{
  return new qt_gsi::GenericStaticMethod ("tr", "@brief Static method QString QPlainTextEdit::tr(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_tr_3354, &_call_f_tr_3354);
}
...
{
  return new qt_gsi::GenericStaticMethod ("tr", "@brief Static method QString QPlainTextEdit::tr(const char *s, const char *c, int n)\nThis method is static and can be called without an instance.", &_init_f_tr_4013, &_call_f_tr_4013);
}
...
{
  return new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QPlainTextEdit::trUtf8(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_3354, &_call_f_trUtf8_3354);
}
...
{
  return new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QPlainTextEdit::trUtf8(const char *s, const char *c, int n)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_4013, &_call_f_trUtf8_4013);
}

static qt_gsi::QObjectConnector<QPlainTextEdit, QPlainTextEdit_EventAdaptor> ea_QPlainTextEdit;

namespace gsi
{
extern gsi::Class<QAbstractScrollArea> decl_QAbstractScrollArea;

gsi::Class<QPlainTextEdit> decl_QPlainTextEdit (ea_QPlainTextEdit, decl_QAbstractScrollArea, "QPlainTextEdit_Native",
  gsi::Methods(_create_smo ()) +
  gsi::Methods(_create_f_appendHtml_2025 ()) +
  gsi::Methods(_create_f_appendPlainText_2025 ()) +
  gsi::Methods(_create_f_backgroundVisible_c0 ()) +
  gsi::Methods(_create_f_blockCount_c0 ()) +
  gsi::Methods(_create_f_canPaste_c0 ()) +
  gsi::Methods(_create_f_centerCursor_0 ()) +
  gsi::Methods(_create_f_centerOnScroll_c0 ()) +
  ...
  gsi::Methods(_create_f_setBackgroundVisible_864 ()) +
  gsi::Methods(_create_f_setCenterOnScroll_864 ()) +
  ...
  gsi::Methods(_create_f_setLineWrapMode_3135 ()) +
  ...
  qt_gsi::qt_signal<QPlainTextEdit, QPlainTextEdit_EventAdaptor, int> ("blockCountChanged", &QPlainTextEdit_EventAdaptor::blockCountChanged_e_767, gsi::arg("newBlockCount"), "@brief Signal declaration for QPlainTextEdit::blockCountChanged(int newBlockCount)\nYou can bind a procedure to this signal.") +
  qt_gsi::qt_signal<QPlainTextEdit, QPlainTextEdit_EventAdaptor, bool> ("copyAvailable", &QPlainTextEdit_EventAdaptor::copyAvailable_e_864, gsi::arg("b"), "@brief Signal declaration for QPlainTextEdit::copyAvailable(bool b)\nYou can bind a procedure to this signal.") +
  qt_gsi::qt_signal<QPlainTextEdit, QPlainTextEdit_EventAdaptor> ("cursorPositionChanged", &QPlainTextEdit_EventAdaptor::cursorPositionChanged_e_0, "@brief Signal declaration for QPlainTextEdit::cursorPositionChanged()\nYou can bind a procedure to this signal.") +
  qt_gsi::qt_signal<QPlainTextEdit, QPlainTextEdit_EventAdaptor, const QPoint &> ("customContextMenuRequested", &QPlainTextEdit_EventAdaptor::customContextMenuRequested_e_1916, gsi::arg("pos"), "@brief Signal declaration for QPlainTextEdit::customContextMenuRequested(const QPoint &pos)\nYou can bind a procedure to this signal.") +
  qt_gsi::qt_signal<QPlainTextEdit, QPlainTextEdit_EventAdaptor, QObject *> ("destroyed", &QPlainTextEdit_EventAdaptor::destroyed_e_1302, gsi::arg("arg1"), "@brief Signal declaration for QPlainTextEdit::destroyed(QObject *)\nYou can bind a procedure to this signal.") +
  qt_gsi::qt_signal<QPlainTextEdit, QPlainTextEdit_EventAdaptor, bool> ("modificationChanged", &QPlainTextEdit_EventAdaptor::modificationChanged_e_864, gsi::arg("arg1"), "@brief Signal declaration for QPlainTextEdit::modificationChanged(bool)\nYou can bind a procedure to this signal.") +
  qt_gsi::qt_signal<QPlainTextEdit, QPlainTextEdit_EventAdaptor, bool> ("redoAvailable", &QPlainTextEdit_EventAdaptor::redoAvailable_e_864, gsi::arg("b"), "@brief Signal declaration for QPlainTextEdit::redoAvailable(bool b)\nYou can bind a procedure to this signal.") +
  qt_gsi::qt_signal<QPlainTextEdit, QPlainTextEdit_EventAdaptor> ("selectionChanged", &QPlainTextEdit_EventAdaptor::selectionChanged_e_0, "@brief Signal declaration for QPlainTextEdit::selectionChanged()\nYou can bind a procedure to this signal.") +
  qt_gsi::qt_signal<QPlainTextEdit, QPlainTextEdit_EventAdaptor> ("textChanged", &QPlainTextEdit_EventAdaptor::textChanged_e_0, "@brief Signal declaration for QPlainTextEdit::textChanged()\nYou can bind a procedure to this signal.") +
  qt_gsi::qt_signal<QPlainTextEdit, QPlainTextEdit_EventAdaptor, bool> ("undoAvailable", &QPlainTextEdit_EventAdaptor::undoAvailable_e_864, gsi::arg("b"), "@brief Signal declaration for QPlainTextEdit::undoAvailable(bool b)\nYou can bind a procedure to this signal.") +
  qt_gsi::qt_signal<QPlainTextEdit, QPlainTextEdit_EventAdaptor, const QRect &, int> ("updateRequest", &QPlainTextEdit_EventAdaptor::updateRequest_e_2451, gsi::arg("rect"), gsi::arg("dy"), "@brief Signal declaration for QPlainTextEdit::updateRequest(const QRect &rect, int dy)\nYou can bind a procedure to this signal.") +
...
public:
  ...
  //  QRectF QPlainTextEdit::blockBoundingRect(const QTextBlock &block)
  ...
  //  void QPlainTextEdit::create(WId, bool initializeWindow, bool destroyOldWindow)
  ...
  //  void QPlainTextEdit::setViewportMargins(const QMargins &margins)
  ...
  //  void QPlainTextEdit::updateMicroFocus()
...
static qt_gsi::GenericStaticMethod *_create_ctor_QPlainTextEdit_Adaptor_1315 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QPlainTextEdit::QPlainTextEdit(QWidget *parent)\nThis method creates an object of class QPlainTextEdit.", &_init_ctor_QPlainTextEdit_Adaptor_1315, &_call_ctor_QPlainTextEdit_Adaptor_1315);
}
...
static qt_gsi::GenericStaticMethod *_create_ctor_QPlainTextEdit_Adaptor_3232 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QPlainTextEdit::QPlainTextEdit(const QString &text, QWidget *parent)\nThis method creates an object of class QPlainTextEdit.", &_init_ctor_QPlainTextEdit_Adaptor_3232, &_call_ctor_QPlainTextEdit_Adaptor_3232);
}
...
static qt_gsi::GenericMethod*_create_fp_blockBoundingGeometry_c2306 ()
{
  return new qt_gsi::GenericMethod("*blockBoundingGeometry", "@brief Method QRectF QPlainTextEdit::blockBoundingGeometry(const QTextBlock &block)\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_blockBoundingGeometry_c2306, &_call_fp_blockBoundingGeometry_c2306);
}
...
static qt_gsi::GenericMethod*_create_fp_blockBoundingRect_c2306 ()
{
  return new qt_gsi::GenericMethod("*blockBoundingRect", "@brief Method QRectF QPlainTextEdit::blockBoundingRect(const QTextBlock &block)\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_blockBoundingRect_c2306, &_call_fp_blockBoundingRect_c2306);
}
...
static qt_gsi::GenericMethod*_create_fp_contentOffset_c0 ()
{
  return new qt_gsi::GenericMethod("*contentOffset", "@brief Method QPointF QPlainTextEdit::contentOffset()\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_contentOffset_c0, &_call_fp_contentOffset_c0);
}
...
{
  return new qt_gsi::GenericMethod("*qt_create", "@brief Method void QPlainTextEdit::create(WId, bool initializeWindow, bool destroyOldWindow)\nThis method is protected and can only be called from inside a derived class.", false, &_init_fp_create_2208, &_call_fp_create_2208);
}
...
{
  return new qt_gsi::GenericMethod("*qt_destroy", "@brief Method void QPlainTextEdit::destroy(bool destroyWindow, bool destroySubWindows)\nThis method is protected and can only be called from inside a derived class.", false, &_init_fp_destroy_1620, &_call_fp_destroy_1620);
}
...
static qt_gsi::GenericMethod*_create_fp_firstVisibleBlock_c0 ()
{
  return new qt_gsi::GenericMethod("*firstVisibleBlock", "@brief Method QTextBlock QPlainTextEdit::firstVisibleBlock()\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_firstVisibleBlock_c0, &_call_fp_firstVisibleBlock_c0);
}
...
{
  return new qt_gsi::GenericMethod("*focusNextChild", "@brief Method bool QPlainTextEdit::focusNextChild()\nThis method is protected and can only be called from inside a derived class.", false, &_init_fp_focusNextChild_0, &_call_fp_focusNextChild_0);
}
...
{
  return new qt_gsi::GenericMethod("*focusPreviousChild", "@brief Method bool QPlainTextEdit::focusPreviousChild()\nThis method is protected and can only be called from inside a derived class.", false, &_init_fp_focusPreviousChild_0, &_call_fp_focusPreviousChild_0);
}
...
static qt_gsi::GenericMethod*_create_fp_getPaintContext_c0 ()
{
  return new qt_gsi::GenericMethod("*getPaintContext", "@brief Method QAbstractTextDocumentLayout::PaintContext QPlainTextEdit::getPaintContext()\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_getPaintContext_c0, &_call_fp_getPaintContext_c0);
}
...
{
  return new qt_gsi::GenericMethod("*receivers", "@brief Method int QPlainTextEdit::receivers(const char *signal)\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_receivers_c1731, &_call_fp_receivers_c1731);
}
...
{
  return new qt_gsi::GenericMethod("*sender", "@brief Method QObject *QPlainTextEdit::sender()\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_sender_c0, &_call_fp_sender_c0);
}
...
{
  return new qt_gsi::GenericMethod("*updateMicroFocus", "@brief Method void QPlainTextEdit::updateMicroFocus()\nThis method is protected and can only be called from inside a derived class.", false, &_init_fp_updateMicroFocus_0, &_call_fp_updateMicroFocus_0);
}
...
{
  return new qt_gsi::GenericMethod ("eventFilter", "@brief Virtual method bool QPlainTextEdit::eventFilter(QObject *, QEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_eventFilter_2411_0, &_call_cbs_eventFilter_2411_0, &_set_callback_cbs_eventFilter_2411_0);
}
...
{
  return new qt_gsi::GenericMethod ("heightForWidth", "@brief Virtual method int QPlainTextEdit::heightForWidth(int)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_heightForWidth_c767_0, &_call_cbs_heightForWidth_c767_0, &_set_callback_cbs_heightForWidth_c767_0);
}
...
{
  return new qt_gsi::GenericMethod ("paintEngine", "@brief Virtual method QPaintEngine *QPlainTextEdit::paintEngine()\nThis method can be reimplemented in a derived class.", true, &_init_cbs_paintEngine_c0_0, &_call_cbs_paintEngine_c0_0, &_set_callback_cbs_paintEngine_c0_0);
}
...
{
  return new qt_gsi::GenericMethod ("sizeHint", "@brief Virtual method QSize QPlainTextEdit::sizeHint()\nThis method can be reimplemented in a derived class.", true, &_init_cbs_sizeHint_c0_0, &_call_cbs_sizeHint_c0_0, &_set_callback_cbs_sizeHint_c0_0);
}
...
{
  return new qt_gsi::GenericMethod ("*changeEvent", "@brief Virtual method void QPlainTextEdit::changeEvent(QEvent *e)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_changeEvent_1217_0, &_call_cbs_changeEvent_1217_0, &_set_callback_cbs_changeEvent_1217_0);
}
...
{
  return new qt_gsi::GenericMethod ("*childEvent", "@brief Virtual method void QPlainTextEdit::childEvent(QChildEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_childEvent_1701_0, &_call_cbs_childEvent_1701_0, &_set_callback_cbs_childEvent_1701_0);
}
...
{
  return new qt_gsi::GenericMethod ("*closeEvent", "@brief Virtual method void QPlainTextEdit::closeEvent(QCloseEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_closeEvent_1719_0, &_call_cbs_closeEvent_1719_0, &_set_callback_cbs_closeEvent_1719_0);
}
...
{
  return new qt_gsi::GenericMethod ("*customEvent", "@brief Virtual method void QPlainTextEdit::customEvent(QEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_customEvent_1217_0, &_call_cbs_customEvent_1217_0, &_set_callback_cbs_customEvent_1217_0);
}
...
{
  return new qt_gsi::GenericMethod ("*disconnectNotify", "@brief Virtual method void QPlainTextEdit::disconnectNotify(const char *signal)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_disconnectNotify_1731_0, &_call_cbs_disconnectNotify_1731_0, &_set_callback_cbs_disconnectNotify_1731_0);
}
...
{
  return new qt_gsi::GenericMethod ("*event", "@brief Virtual method bool QPlainTextEdit::event(QEvent *e)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_event_1217_0, &_call_cbs_event_1217_0, &_set_callback_cbs_event_1217_0);
}
...
{
  return new qt_gsi::GenericMethod ("*focusInEvent", "@brief Virtual method void QPlainTextEdit::focusInEvent(QFocusEvent *e)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_focusInEvent_1729_0, &_call_cbs_focusInEvent_1729_0, &_set_callback_cbs_focusInEvent_1729_0);
}
...
{
  return new qt_gsi::GenericMethod ("*focusNextPrevChild", "@brief Virtual method bool QPlainTextEdit::focusNextPrevChild(bool next)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_focusNextPrevChild_864_0, &_call_cbs_focusNextPrevChild_864_0, &_set_callback_cbs_focusNextPrevChild_864_0);
}
...
{
  return new qt_gsi::GenericMethod ("*focusOutEvent", "@brief Virtual method void QPlainTextEdit::focusOutEvent(QFocusEvent *e)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_focusOutEvent_1729_0, &_call_cbs_focusOutEvent_1729_0, &_set_callback_cbs_focusOutEvent_1729_0);
}
...
{
  return new qt_gsi::GenericMethod ("*hideEvent", "@brief Virtual method void QPlainTextEdit::hideEvent(QHideEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_hideEvent_1595_0, &_call_cbs_hideEvent_1595_0, &_set_callback_cbs_hideEvent_1595_0);
}
...
{
  return new qt_gsi::GenericMethod ("*inputMethodEvent", "@brief Virtual method void QPlainTextEdit::inputMethodEvent(QInputMethodEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_inputMethodEvent_2354_0, &_call_cbs_inputMethodEvent_2354_0, &_set_callback_cbs_inputMethodEvent_2354_0);
}
...
{
  return new qt_gsi::GenericMethod ("*inputMethodQuery", "@brief Virtual method QVariant QPlainTextEdit::inputMethodQuery(Qt::InputMethodQuery property)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_inputMethodQuery_c2420_0, &_call_cbs_inputMethodQuery_c2420_0, &_set_callback_cbs_inputMethodQuery_c2420_0);
}
...
{
  return new qt_gsi::GenericMethod ("*keyPressEvent", "@brief Virtual method void QPlainTextEdit::keyPressEvent(QKeyEvent *e)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_keyPressEvent_1514_0, &_call_cbs_keyPressEvent_1514_0, &_set_callback_cbs_keyPressEvent_1514_0);
}
...
{
  return new qt_gsi::GenericMethod ("*keyReleaseEvent", "@brief Virtual method void QPlainTextEdit::keyReleaseEvent(QKeyEvent *e)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_keyReleaseEvent_1514_0, &_call_cbs_keyReleaseEvent_1514_0, &_set_callback_cbs_keyReleaseEvent_1514_0);
}
...
{
  return new qt_gsi::GenericMethod ("*metric", "@brief Virtual method int QPlainTextEdit::metric(QPaintDevice::PaintDeviceMetric)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_metric_c3445_0, &_call_cbs_metric_c3445_0, &_set_callback_cbs_metric_c3445_0);
}
...
{
  return new qt_gsi::GenericMethod ("*mouseDoubleClickEvent", "@brief Virtual method void QPlainTextEdit::mouseDoubleClickEvent(QMouseEvent *e)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_mouseDoubleClickEvent_1738_0, &_call_cbs_mouseDoubleClickEvent_1738_0, &_set_callback_cbs_mouseDoubleClickEvent_1738_0);
}
...
{
  return new qt_gsi::GenericMethod ("*mouseMoveEvent", "@brief Virtual method void QPlainTextEdit::mouseMoveEvent(QMouseEvent *e)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_mouseMoveEvent_1738_0, &_call_cbs_mouseMoveEvent_1738_0, &_set_callback_cbs_mouseMoveEvent_1738_0);
}
...
{
  return new qt_gsi::GenericMethod ("*mousePressEvent", "@brief Virtual method void QPlainTextEdit::mousePressEvent(QMouseEvent *e)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_mousePressEvent_1738_0, &_call_cbs_mousePressEvent_1738_0, &_set_callback_cbs_mousePressEvent_1738_0);
}
...
{
  return new qt_gsi::GenericMethod ("*mouseReleaseEvent", "@brief Virtual method void QPlainTextEdit::mouseReleaseEvent(QMouseEvent *e)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_mouseReleaseEvent_1738_0, &_call_cbs_mouseReleaseEvent_1738_0, &_set_callback_cbs_mouseReleaseEvent_1738_0);
}
...
{
  return new qt_gsi::GenericMethod ("*moveEvent", "@brief Virtual method void QPlainTextEdit::moveEvent(QMoveEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_moveEvent_1624_0, &_call_cbs_moveEvent_1624_0, &_set_callback_cbs_moveEvent_1624_0);
}
...
{
  return new qt_gsi::GenericMethod ("*paintEvent", "@brief Virtual method void QPlainTextEdit::paintEvent(QPaintEvent *e)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_paintEvent_1725_0, &_call_cbs_paintEvent_1725_0, &_set_callback_cbs_paintEvent_1725_0);
}
...
{
  return new qt_gsi::GenericMethod ("*resizeEvent", "@brief Virtual method void QPlainTextEdit::resizeEvent(QResizeEvent *e)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_resizeEvent_1843_0, &_call_cbs_resizeEvent_1843_0, &_set_callback_cbs_resizeEvent_1843_0);
}
...
{
  return new qt_gsi::GenericMethod ("*showEvent", "@brief Virtual method void QPlainTextEdit::showEvent(QShowEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_showEvent_1634_0, &_call_cbs_showEvent_1634_0, &_set_callback_cbs_showEvent_1634_0);
}
...
{
  return new qt_gsi::GenericMethod ("*tabletEvent", "@brief Virtual method void QPlainTextEdit::tabletEvent(QTabletEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_tabletEvent_1821_0, &_call_cbs_tabletEvent_1821_0, &_set_callback_cbs_tabletEvent_1821_0);
}
...
{
  return new qt_gsi::GenericMethod ("*timerEvent", "@brief Virtual method void QPlainTextEdit::timerEvent(QTimerEvent *e)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_timerEvent_1730_0, &_call_cbs_timerEvent_1730_0, &_set_callback_cbs_timerEvent_1730_0);
}
...
{
  return new qt_gsi::GenericMethod ("*wheelEvent", "@brief Virtual method void QPlainTextEdit::wheelEvent(QWheelEvent *e)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_wheelEvent_1718_0, &_call_cbs_wheelEvent_1718_0, &_set_callback_cbs_wheelEvent_1718_0);
}
...
extern gsi::Class<QPlainTextEdit> decl_QPlainTextEdit;

gsi::Class<QPlainTextEdit_Adaptor> decl_QPlainTextEdit_Adaptor (decl_QPlainTextEdit, "QPlainTextEdit",
  gsi::Methods(_create_fp_blockBoundingGeometry_c2306 ()) +
  gsi::Methods(_create_fp_blockBoundingRect_c2306 ()) +
  gsi::Methods(_create_fp_contentOffset_c0 ()) +
  gsi::Methods(_create_fp_create_2208 ()) +
  gsi::Methods(_create_fp_destroy_1620 ()) +
  gsi::Methods(_create_fp_drawFrame_1426 ()) +
  gsi::Methods(_create_fp_firstVisibleBlock_c0 ()) +
  gsi::Methods(_create_fp_focusNextChild_0 ()) +
  gsi::Methods(_create_fp_focusPreviousChild_0 ()) +
  gsi::Methods(_create_fp_getPaintContext_c0 ()) +
  ...
  gsi::Methods(_create_ctor_QPlainTextEdit_Adaptor_1315 ()) +
  gsi::Methods(_create_ctor_QPlainTextEdit_Adaptor_3232 ()),
...
static QPlainTextEdit_LineWrapMode_Enum *c_1_QPlainTextEdit_LineWrapMode_Enum () { return new QPlainTextEdit_LineWrapMode_Enum (QPlainTextEdit::NoWrap); }
static QPlainTextEdit_LineWrapMode_Enum *c_2_QPlainTextEdit_LineWrapMode_Enum () { return new QPlainTextEdit_LineWrapMode_Enum (QPlainTextEdit::WidgetWidth); }

static gsi::Methods mkdefs_QPlainTextEdit_LineWrapMode () {
  return
    gsi::constant ("NoWrap", &qt_gsi::c_1_QPlainTextEdit_LineWrapMode_Enum, "@brief Enum constant QPlainTextEdit::NoWrap") +
    gsi::constant ("WidgetWidth", &qt_gsi::c_2_QPlainTextEdit_LineWrapMode_Enum, "@brief Enum constant QPlainTextEdit::WidgetWidth");
}

static std::string to_s_QPlainTextEdit_LineWrapMode_Enum (const QPlainTextEdit_LineWrapMode_Enum *e)
{
  if (e->value () == QPlainTextEdit::NoWrap) { return tl::sprintf ("NoWrap (%u)", (unsigned int) e->value ()); }
  if (e->value () == QPlainTextEdit::WidgetWidth) { return tl::sprintf ("WidgetWidth (%u)", (unsigned int) e->value ()); }
  return std::string ("(not a valid enum evalue)");
}

static unsigned int to_i_QPlainTextEdit_LineWrapMode_Enum (const QPlainTextEdit_LineWrapMode_Enum *e)
{
  return (unsigned int) e->value ();
}

static QPlainTextEdit_LineWrapMode_Enum *from_i_QPlainTextEdit_LineWrapMode_Enum (unsigned int i)
{
  return new QPlainTextEdit_LineWrapMode_Enum ((QPlainTextEdit::LineWrapMode) i);
}

static bool equalQPlainTextEdit_LineWrapMode_Enum (const QPlainTextEdit_LineWrapMode_Enum *e, QPlainTextEdit_LineWrapMode_Enum d)
{
  return e->value () == d.value ();
}

static bool equal2QPlainTextEdit_LineWrapMode_Enum (const QPlainTextEdit_LineWrapMode_Enum *e, unsigned int i)
{
  return (unsigned int) e->value () == i;
}

static QPlainTextEdit_LineWrapMode_Enums oropQPlainTextEdit_LineWrapMode_Enums (const QPlainTextEdit_LineWrapMode_Enums *e, const QPlainTextEdit_LineWrapMode_Enums &d)
{
  return e->flags () | d.flags ();
}

static QPlainTextEdit_LineWrapMode_Enums andopQPlainTextEdit_LineWrapMode_Enums (const QPlainTextEdit_LineWrapMode_Enums *e, const QPlainTextEdit_LineWrapMode_Enums &d)
{
  return e->flags () & d.flags ();
}

static QPlainTextEdit_LineWrapMode_Enums xoropQPlainTextEdit_LineWrapMode_Enums (const QPlainTextEdit_LineWrapMode_Enums *e, const QPlainTextEdit_LineWrapMode_Enums &d)
{
  return e->flags () ^ d.flags ();
}

static std::string to_s_QPlainTextEdit_LineWrapMode_Enums (const QPlainTextEdit_LineWrapMode_Enums *e)
{
  std::string l;
  if (e->testFlag (QPlainTextEdit::NoWrap)) { if (!l.empty ()) l += "|"; l += "NoWrap"; }
  if (e->testFlag (QPlainTextEdit::WidgetWidth)) { if (!l.empty ()) l += "|"; l += "WidgetWidth"; }
  return tl::sprintf ("%u (%s)", (unsigned int) (e->flags ()), l);
}

static int to_i_QPlainTextEdit_LineWrapMode_Enums (const QPlainTextEdit_LineWrapMode_Enums *e)
{
  return int (e->flags ());
}

static bool testFlag_QPlainTextEdit_LineWrapMode_Enums (const QPlainTextEdit_LineWrapMode_Enums *e, const QPlainTextEdit_LineWrapMode_Enum &d)
{
...
gsi::Class<qt_gsi::QPlainTextEdit_LineWrapMode_Enums> decl_QPlainTextEdit_LineWrapMode_Enums ("QPlainTextEdit_QFlags_LineWrapMode",
  gsi::method_ext ("|", &qt_gsi::oropQPlainTextEdit_LineWrapMode_Enums, gsi::arg ("other"), "@brief 'or' operator between two flag sets") +
  gsi::method_ext ("&", &qt_gsi::andopQPlainTextEdit_LineWrapMode_Enums, gsi::arg ("other"), "@brief 'and' operator between two flag sets") +
  gsi::method_ext ("^", &qt_gsi::xoropQPlainTextEdit_LineWrapMode_Enums, gsi::arg ("other"), "@brief 'xor' operator between two flag sets") +
  gsi::method_ext ("to_s|inspect", &qt_gsi::to_s_QPlainTextEdit_LineWrapMode_Enums, "@brief Converts the flag set to a string") +
  gsi::method_ext ("to_i", &qt_gsi::to_i_QPlainTextEdit_LineWrapMode_Enums, "@brief Returns the integer value encoding the flag set") +
  gsi::method_ext ("testFlag", &qt_gsi::testFlag_QPlainTextEdit_LineWrapMode_Enums, gsi::arg ("flag"), "@brief Tests whether the flag is contained in the flag set"),
  "@qt\n@brief This class represents the QFlags<QPlainTextEdit::LineWrapMode> flag set");

//  Declarations for enum wrapper class
gsi::Class<qt_gsi::QPlainTextEdit_LineWrapMode_Enum> decl_QPlainTextEdit_LineWrapMode_Enum (decl_QPlainTextEdit_LineWrapMode_Enums, "QPlainTextEdit_LineWrapMode",
  qt_gsi::mkdefs_QPlainTextEdit_LineWrapMode () +
  gsi::method_ext ("to_s|inspect", &qt_gsi::to_s_QPlainTextEdit_LineWrapMode_Enum, "@brief Converts the enum class to a string") +
  gsi::method_ext ("to_i", &qt_gsi::to_i_QPlainTextEdit_LineWrapMode_Enum, "@brief Converts the enum class to an integer") +
  gsi::method_ext ("==", &qt_gsi::equalQPlainTextEdit_LineWrapMode_Enum, gsi::arg ("other"), "@brief Compares the enum class against an enum of it's own type") +
  gsi::method_ext ("==", &qt_gsi::equal2QPlainTextEdit_LineWrapMode_Enum, gsi::arg ("other"), "@brief Compares the enum class against an integer") +
  gsi::constructor ("new", &qt_gsi::from_i_QPlainTextEdit_LineWrapMode_Enum, gsi::arg ("value"), "@brief Creates the enum object from an integer"),
  "@qt\n@brief This class represents the QPlainTextEdit::LineWrapMode enum");

//  Inject the declarations into the parent
static gsi::ClassExt<QPlainTextEdit> inject_QPlainTextEdit_LineWrapMode_Enum_in_parent (qt_gsi::mkdefs_QPlainTextEdit_LineWrapMode ());
