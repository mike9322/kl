...
#include "gsiDeclQDragLeaveEvent_Enums.h"
#include <memory>
...
gsi::Class<QDragLeaveEvent> decl_QDragLeaveEvent (decl_QEvent, "QDragLeaveEvent_Native",
  gsi::Methods(),
...
static qt_gsi::GenericStaticMethod *_create_ctor_QDragLeaveEvent_Adaptor_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QDragLeaveEvent::QDragLeaveEvent()\nThis method creates an object of class QDragLeaveEvent.", &_init_ctor_QDragLeaveEvent_Adaptor_0, &_call_ctor_QDragLeaveEvent_Adaptor_0);
}

namespace gsi
{

extern gsi::Class<QDragLeaveEvent> decl_QDragLeaveEvent;

gsi::Class<QDragLeaveEvent_Adaptor> decl_QDragLeaveEvent_Adaptor (decl_QDragLeaveEvent, "QDragLeaveEvent",
  gsi::Methods(_create_ctor_QDragLeaveEvent_Adaptor_0 ()),
