...
/**
*  @file generated/gsiDeclQSqlRelationalTableModel_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQSqlRelationalTableModel_EventAdaptor
#define _HDR_gsiDeclQSqlRelationalTableModel_EventAdaptor
...
public:
  QSqlRelationalTableModel_EventAdaptor (QObject *host);
...
public:
  gsi::event<int> beforeDelete_e_767;
  gsi::event<QSqlRecord &> beforeInsert_e_1610;
  gsi::event<int, QSqlRecord &> beforeUpdate_e_2269;
  ...
  gsi::event<int, QSqlRecord &> primeInsert_e_2269;
};
