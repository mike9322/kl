...
#include "gsiDeclQXmlLexicalHandler_Enums.h"
#include <memory>
...
{
  return new qt_gsi::GenericMethod ("comment", "@brief Method bool QXmlLexicalHandler::comment(const QString &ch)\n", false, &_init_f_comment_2025, &_call_f_comment_2025);
}
...
{
  return new qt_gsi::GenericMethod ("endCDATA", "@brief Method bool QXmlLexicalHandler::endCDATA()\n", false, &_init_f_endCDATA_0, &_call_f_endCDATA_0);
}
...
{
  return new qt_gsi::GenericMethod ("endDTD", "@brief Method bool QXmlLexicalHandler::endDTD()\n", false, &_init_f_endDTD_0, &_call_f_endDTD_0);
}
...
{
  return new qt_gsi::GenericMethod ("endEntity", "@brief Method bool QXmlLexicalHandler::endEntity(const QString &name)\n", false, &_init_f_endEntity_2025, &_call_f_endEntity_2025);
}
...
{
  return new qt_gsi::GenericMethod ("errorString", "@brief Method QString QXmlLexicalHandler::errorString()\n", true, &_init_f_errorString_c0, &_call_f_errorString_c0);
}
...
{
  return new qt_gsi::GenericMethod ("startCDATA", "@brief Method bool QXmlLexicalHandler::startCDATA()\n", false, &_init_f_startCDATA_0, &_call_f_startCDATA_0);
}
...
{
  return new qt_gsi::GenericMethod ("startDTD", "@brief Method bool QXmlLexicalHandler::startDTD(const QString &name, const QString &publicId, const QString &systemId)\n", false, &_init_f_startDTD_5859, &_call_f_startDTD_5859);
}
...
{
  return new qt_gsi::GenericMethod ("startEntity", "@brief Method bool QXmlLexicalHandler::startEntity(const QString &name)\n", false, &_init_f_startEntity_2025, &_call_f_startEntity_2025);
}

namespace gsi
{
gsi::Class<QXmlLexicalHandler> decl_QXmlLexicalHandler ("QXmlLexicalHandler_Native",
...
static qt_gsi::GenericStaticMethod *_create_ctor_QXmlLexicalHandler_Adaptor_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QXmlLexicalHandler::QXmlLexicalHandler()\nThis method creates an object of class QXmlLexicalHandler.", &_init_ctor_QXmlLexicalHandler_Adaptor_0, &_call_ctor_QXmlLexicalHandler_Adaptor_0);
}
...
{
  return new qt_gsi::GenericMethod ("startDTD", "@brief Virtual method bool QXmlLexicalHandler::startDTD(const QString &name, const QString &publicId, const QString &systemId)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_startDTD_5859_0, &_call_cbs_startDTD_5859_0, &_set_callback_cbs_startDTD_5859_0);
}
...
extern gsi::Class<QXmlLexicalHandler> decl_QXmlLexicalHandler;

gsi::Class<QXmlLexicalHandler_Adaptor> decl_QXmlLexicalHandler_Adaptor (decl_QXmlLexicalHandler, "QXmlLexicalHandler",
  ...
  gsi::Methods(_create_ctor_QXmlLexicalHandler_Adaptor_0 ()),
