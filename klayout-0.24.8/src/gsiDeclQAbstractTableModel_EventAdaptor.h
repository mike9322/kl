...
/**
*  @file generated/gsiDeclQAbstractTableModel_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQAbstractTableModel_EventAdaptor
#define _HDR_gsiDeclQAbstractTableModel_EventAdaptor
...
public:
  QAbstractTableModel_EventAdaptor (QObject *host);
