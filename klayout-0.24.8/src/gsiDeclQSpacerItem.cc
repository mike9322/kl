...
#include "gsiDeclQSpacerItem_Enums.h"
#include <memory>
...
static void _call_f_changeSize_5794 (const qt_gsi::GenericMethod *decl, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  tl::Heap heap;
  const qt_gsi::Converter<QSizePolicy::Policy>::target_type & arg3 = args ? args.read<const qt_gsi::Converter<QSizePolicy::Policy>::target_type & > () : (const qt_gsi::Converter<QSizePolicy::Policy>::target_type &)(qt_gsi::CppToQtReadAdaptor<QSizePolicy::Policy>(heap, QSizePolicy::Minimum));
  const qt_gsi::Converter<QSizePolicy::Policy>::target_type & arg4 = args ? args.read<const qt_gsi::Converter<QSizePolicy::Policy>::target_type & > () : (const qt_gsi::Converter<QSizePolicy::Policy>::target_type &)(qt_gsi::CppToQtReadAdaptor<QSizePolicy::Policy>(heap, QSizePolicy::Minimum));
...
static qt_gsi::GenericMethod *_create_f_changeSize_5794 ()
{
  return new qt_gsi::GenericMethod ("changeSize", "@brief Method void QSpacerItem::changeSize(int w, int h, QSizePolicy::Policy hData, QSizePolicy::Policy vData)\n", false, &_init_f_changeSize_5794, &_call_f_changeSize_5794);
}
...
{
  ret.write<qt_gsi::Converter<QFlags<Qt::Orientation> >::target_type > ((qt_gsi::Converter<QFlags<Qt::Orientation> >::target_type)qt_gsi::CppToQtAdaptor<QFlags<Qt::Orientation> >(((QSpacerItem *)cls)->expandingDirections ()));
}

static qt_gsi::GenericMethod *_create_f_expandingDirections_c0 ()
{
  return new qt_gsi::GenericMethod ("expandingDirections", "@brief Method QFlags<Qt::Orientation> QSpacerItem::expandingDirections()\nThis is a reimplementation of QLayoutItem::expandingDirections", true, &_init_f_expandingDirections_c0, &_call_f_expandingDirections_c0);
}
...
gsi::Class<QSpacerItem> decl_QSpacerItem (decl_QLayoutItem, "QSpacerItem_Native",
  gsi::Methods(_create_f_changeSize_5794 ()) +
...
public:
  ...
  {
    return qt_gsi::CppToQtAdaptor<QFlags<Qt::Orientation> >(QSpacerItem::expandingDirections());
  }

  virtual QFlags<Qt::Orientation> expandingDirections() const
  {
    if (cb_expandingDirections_c0_0.can_issue()) {
      return qt_gsi::QtToCppAdaptor<QFlags<Qt::Orientation> >(cb_expandingDirections_c0_0.issue<QSpacerItem_Adaptor, qt_gsi::Converter<QFlags<Qt::Orientation> >::target_type>(&QSpacerItem_Adaptor::cbs_expandingDirections_c0_0)).cref();
    } else {
...
static qt_gsi::GenericStaticMethod *_create_ctor_QSpacerItem_Adaptor_5794 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QSpacerItem::QSpacerItem(int w, int h, QSizePolicy::Policy hData, QSizePolicy::Policy vData)\nThis method creates an object of class QSpacerItem.", &_init_ctor_QSpacerItem_Adaptor_5794, &_call_ctor_QSpacerItem_Adaptor_5794);
}
...
{
  ret.write<qt_gsi::Converter<QFlags<Qt::Orientation> >::target_type > ((qt_gsi::Converter<QFlags<Qt::Orientation> >::target_type)((QSpacerItem_Adaptor *)cls)->cbs_expandingDirections_c0_0 ());
}
...
{
  return new qt_gsi::GenericMethod ("heightForWidth", "@brief Virtual method int QSpacerItem::heightForWidth(int)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_heightForWidth_c767_0, &_call_cbs_heightForWidth_c767_0, &_set_callback_cbs_heightForWidth_c767_0);
}
...
{
  return new qt_gsi::GenericMethod ("sizeHint", "@brief Virtual method QSize QSpacerItem::sizeHint()\nThis method can be reimplemented in a derived class.", true, &_init_cbs_sizeHint_c0_0, &_call_cbs_sizeHint_c0_0, &_set_callback_cbs_sizeHint_c0_0);
}
...
extern gsi::Class<QSpacerItem> decl_QSpacerItem;

gsi::Class<QSpacerItem_Adaptor> decl_QSpacerItem_Adaptor (decl_QSpacerItem, "QSpacerItem",
  ...
  gsi::Methods(_create_ctor_QSpacerItem_Adaptor_5794 ()),
