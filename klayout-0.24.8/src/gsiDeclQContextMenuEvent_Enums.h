...
/**
*  @file gsiDeclQContextMenuEvent_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQContextMenuEvent_Enums
#define _HDR_gsiDeclQContextMenuEvent_Enums
...
//  Wrapper class for QFlags<enum QContextMenuEvent::Reason>
class QContextMenuEvent_Reason_Enums : public QFlags<enum QContextMenuEvent::Reason> {
public:
  QContextMenuEvent_Reason_Enums () : m_flags () { }
  QContextMenuEvent_Reason_Enums (enum QContextMenuEvent::Reason v) : m_flags (v) { }
  QContextMenuEvent_Reason_Enums (const QFlags<enum QContextMenuEvent::Reason> &v) : m_flags (v) { }
  QFlags<enum QContextMenuEvent::Reason> flags () const { return m_flags; }
private:
  QFlags<QContextMenuEvent::Reason> m_flags;
};

//  Wrapper class for enum QContextMenuEvent::Reason
class QContextMenuEvent_Reason_Enum : public QContextMenuEvent_Reason_Enums {
public:
  QContextMenuEvent_Reason_Enum () { }
  QContextMenuEvent_Reason_Enum (enum QContextMenuEvent::Reason v) : QContextMenuEvent_Reason_Enums (v) { }
  enum QContextMenuEvent::Reason value () const { return (enum QContextMenuEvent::Reason) flags ().operator int (); }
};

//  Converter for QFlags<enum QContextMenuEvent::Reason>
template <>
struct Converter<QFlags<enum QContextMenuEvent::Reason> >
{
public:
  typedef QFlags<enum QContextMenuEvent::Reason> source_type;
  typedef QContextMenuEvent_Reason_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QContextMenuEvent::Reason
template <>
struct Converter<enum QContextMenuEvent::Reason>
{
public:
  typedef enum QContextMenuEvent::Reason source_type;
  typedef QContextMenuEvent_Reason_Enum target_type;
