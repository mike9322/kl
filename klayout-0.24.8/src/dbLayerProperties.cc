...
template<> KLAYOUT_DLL void extractor_impl (tl::Extractor &ex, db::LayerProperties &e)
{
...
template<> KLAYOUT_DLL void extractor_impl (tl::Extractor &ex, db::LayerOffset &e)
{
  if (! test_extractor_impl (ex, e)) {
