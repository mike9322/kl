...
/**
*  @file generated/gsiDeclQInputDialog_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQInputDialog_EventAdaptor
#define _HDR_gsiDeclQInputDialog_EventAdaptor
...
public:
  QInputDialog_EventAdaptor (QObject *host);
...
public:
  ...
  gsi::event<double> doubleValueChanged_e_1071;
  gsi::event<double> doubleValueSelected_e_1071;
  gsi::event<int> finished_e_767;
  gsi::event<int> intValueChanged_e_767;
  gsi::event<int> intValueSelected_e_767;
  gsi::event<> rejected_e_0;
  gsi::event<const QString &> textValueChanged_e_2025;
  gsi::event<const QString &> textValueSelected_e_2025;
};
