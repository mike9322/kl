...
static db::Matrix3d *new_matrix3d_dsmrm (const db::DPoint &d, double shear, double mx, double my, double rot, bool m)
{
...
static db::Matrix3d *new_matrix3d_pdsmrm (double tx, double ty, double z, const db::DPoint &d, double shear, double mx, double my, double rot, bool m)
{
...
gsi::Class<db::Matrix3d> decl_Matrix3d ("Matrix3d", 
  ...
  gsi::method ("disp", (db::DPoint (db::Matrix3d::*) () const) &db::Matrix3d::disp,
