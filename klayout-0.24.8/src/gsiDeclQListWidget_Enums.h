...
/**
*  @file gsiDeclQListWidget_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQListWidget_Enums
#define _HDR_gsiDeclQListWidget_Enums
...
//  Wrapper class for QFlags<enum QListView::Flow>
class QListView_Flow_Enums : public QFlags<enum QListView::Flow> {
public:
  QListView_Flow_Enums () : m_flags () { }
  QListView_Flow_Enums (enum QListView::Flow v) : m_flags (v) { }
  QListView_Flow_Enums (const QFlags<enum QListView::Flow> &v) : m_flags (v) { }
  QFlags<enum QListView::Flow> flags () const { return m_flags; }
private:
  QFlags<QListView::Flow> m_flags;
};

//  Wrapper class for enum QListView::Flow
class QListView_Flow_Enum : public QListView_Flow_Enums {
public:
  QListView_Flow_Enum () { }
  QListView_Flow_Enum (enum QListView::Flow v) : QListView_Flow_Enums (v) { }
  enum QListView::Flow value () const { return (enum QListView::Flow) flags ().operator int (); }
};

//  Converter for QFlags<enum QListView::Flow>
template <>
struct Converter<QFlags<enum QListView::Flow> >
{
public:
  typedef QFlags<enum QListView::Flow> source_type;
  typedef QListView_Flow_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QListView::Flow
template <>
struct Converter<enum QListView::Flow>
{
public:
  typedef enum QListView::Flow source_type;
  typedef QListView_Flow_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Wrapper class for QFlags<enum QListView::LayoutMode>
class QListView_LayoutMode_Enums : public QFlags<enum QListView::LayoutMode> {
public:
  QListView_LayoutMode_Enums () : m_flags () { }
  QListView_LayoutMode_Enums (enum QListView::LayoutMode v) : m_flags (v) { }
  QListView_LayoutMode_Enums (const QFlags<enum QListView::LayoutMode> &v) : m_flags (v) { }
  QFlags<enum QListView::LayoutMode> flags () const { return m_flags; }
private:
  QFlags<QListView::LayoutMode> m_flags;
};

//  Wrapper class for enum QListView::LayoutMode
class QListView_LayoutMode_Enum : public QListView_LayoutMode_Enums {
public:
  QListView_LayoutMode_Enum () { }
  QListView_LayoutMode_Enum (enum QListView::LayoutMode v) : QListView_LayoutMode_Enums (v) { }
  enum QListView::LayoutMode value () const { return (enum QListView::LayoutMode) flags ().operator int (); }
};

//  Converter for QFlags<enum QListView::LayoutMode>
template <>
struct Converter<QFlags<enum QListView::LayoutMode> >
{
public:
  typedef QFlags<enum QListView::LayoutMode> source_type;
  typedef QListView_LayoutMode_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QListView::LayoutMode
template <>
struct Converter<enum QListView::LayoutMode>
{
public:
  typedef enum QListView::LayoutMode source_type;
  typedef QListView_LayoutMode_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Wrapper class for QFlags<enum QListView::Movement>
class QListView_Movement_Enums : public QFlags<enum QListView::Movement> {
public:
  QListView_Movement_Enums () : m_flags () { }
  QListView_Movement_Enums (enum QListView::Movement v) : m_flags (v) { }
  QListView_Movement_Enums (const QFlags<enum QListView::Movement> &v) : m_flags (v) { }
  QFlags<enum QListView::Movement> flags () const { return m_flags; }
private:
  QFlags<QListView::Movement> m_flags;
};

//  Wrapper class for enum QListView::Movement
class QListView_Movement_Enum : public QListView_Movement_Enums {
public:
  QListView_Movement_Enum () { }
  QListView_Movement_Enum (enum QListView::Movement v) : QListView_Movement_Enums (v) { }
  enum QListView::Movement value () const { return (enum QListView::Movement) flags ().operator int (); }
};

//  Converter for QFlags<enum QListView::Movement>
template <>
struct Converter<QFlags<enum QListView::Movement> >
{
public:
  typedef QFlags<enum QListView::Movement> source_type;
  typedef QListView_Movement_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QListView::Movement
template <>
struct Converter<enum QListView::Movement>
{
public:
  typedef enum QListView::Movement source_type;
  typedef QListView_Movement_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Wrapper class for QFlags<enum QListView::ResizeMode>
class QListView_ResizeMode_Enums : public QFlags<enum QListView::ResizeMode> {
public:
  QListView_ResizeMode_Enums () : m_flags () { }
  QListView_ResizeMode_Enums (enum QListView::ResizeMode v) : m_flags (v) { }
  QListView_ResizeMode_Enums (const QFlags<enum QListView::ResizeMode> &v) : m_flags (v) { }
  QFlags<enum QListView::ResizeMode> flags () const { return m_flags; }
private:
  QFlags<QListView::ResizeMode> m_flags;
};

//  Wrapper class for enum QListView::ResizeMode
class QListView_ResizeMode_Enum : public QListView_ResizeMode_Enums {
public:
  QListView_ResizeMode_Enum () { }
  QListView_ResizeMode_Enum (enum QListView::ResizeMode v) : QListView_ResizeMode_Enums (v) { }
  enum QListView::ResizeMode value () const { return (enum QListView::ResizeMode) flags ().operator int (); }
};

//  Converter for QFlags<enum QListView::ResizeMode>
template <>
struct Converter<QFlags<enum QListView::ResizeMode> >
{
public:
  typedef QFlags<enum QListView::ResizeMode> source_type;
  typedef QListView_ResizeMode_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QListView::ResizeMode
template <>
struct Converter<enum QListView::ResizeMode>
{
public:
  typedef enum QListView::ResizeMode source_type;
  typedef QListView_ResizeMode_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Wrapper class for QFlags<enum QListView::ViewMode>
class QListView_ViewMode_Enums : public QFlags<enum QListView::ViewMode> {
public:
  QListView_ViewMode_Enums () : m_flags () { }
  QListView_ViewMode_Enums (enum QListView::ViewMode v) : m_flags (v) { }
  QListView_ViewMode_Enums (const QFlags<enum QListView::ViewMode> &v) : m_flags (v) { }
  QFlags<enum QListView::ViewMode> flags () const { return m_flags; }
private:
  QFlags<QListView::ViewMode> m_flags;
};

//  Wrapper class for enum QListView::ViewMode
class QListView_ViewMode_Enum : public QListView_ViewMode_Enums {
public:
  QListView_ViewMode_Enum () { }
  QListView_ViewMode_Enum (enum QListView::ViewMode v) : QListView_ViewMode_Enums (v) { }
  enum QListView::ViewMode value () const { return (enum QListView::ViewMode) flags ().operator int (); }
};

//  Converter for QFlags<enum QListView::ViewMode>
template <>
struct Converter<QFlags<enum QListView::ViewMode> >
{
public:
  typedef QFlags<enum QListView::ViewMode> source_type;
  typedef QListView_ViewMode_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QListView::ViewMode
template <>
struct Converter<enum QListView::ViewMode>
{
public:
  typedef enum QListView::ViewMode source_type;
  typedef QListView_ViewMode_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};
