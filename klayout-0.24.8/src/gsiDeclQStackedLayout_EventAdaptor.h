...
/**
*  @file generated/gsiDeclQStackedLayout_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQStackedLayout_EventAdaptor
#define _HDR_gsiDeclQStackedLayout_EventAdaptor
...
public:
  QStackedLayout_EventAdaptor (QObject *host);
