...
/**
*  @file gsiDeclQProgressBar_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQProgressBar_Enums
#define _HDR_gsiDeclQProgressBar_Enums
...
//  Wrapper class for QFlags<enum QProgressBar::Direction>
class QProgressBar_Direction_Enums : public QFlags<enum QProgressBar::Direction> {
public:
  QProgressBar_Direction_Enums () : m_flags () { }
  QProgressBar_Direction_Enums (enum QProgressBar::Direction v) : m_flags (v) { }
  QProgressBar_Direction_Enums (const QFlags<enum QProgressBar::Direction> &v) : m_flags (v) { }
  QFlags<enum QProgressBar::Direction> flags () const { return m_flags; }
private:
  QFlags<QProgressBar::Direction> m_flags;
};

//  Wrapper class for enum QProgressBar::Direction
class QProgressBar_Direction_Enum : public QProgressBar_Direction_Enums {
public:
  QProgressBar_Direction_Enum () { }
  QProgressBar_Direction_Enum (enum QProgressBar::Direction v) : QProgressBar_Direction_Enums (v) { }
  enum QProgressBar::Direction value () const { return (enum QProgressBar::Direction) flags ().operator int (); }
};

//  Converter for QFlags<enum QProgressBar::Direction>
template <>
struct Converter<QFlags<enum QProgressBar::Direction> >
{
public:
  typedef QFlags<enum QProgressBar::Direction> source_type;
  typedef QProgressBar_Direction_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QProgressBar::Direction
template <>
struct Converter<enum QProgressBar::Direction>
{
public:
  typedef enum QProgressBar::Direction source_type;
  typedef QProgressBar_Direction_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};
