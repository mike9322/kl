...
/**
*  @file generated/gsiDeclQTemporaryFile_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQTemporaryFile_EventAdaptor
#define _HDR_gsiDeclQTemporaryFile_EventAdaptor
...
public:
  QTemporaryFile_EventAdaptor (QObject *host);
