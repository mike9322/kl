...
/**
*  @file generated/gsiDeclQDoubleSpinBox_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQDoubleSpinBox_EventAdaptor
#define _HDR_gsiDeclQDoubleSpinBox_EventAdaptor
...
public:
  QDoubleSpinBox_EventAdaptor (QObject *host);
