...
/**
*  @file gsiDeclQColorDialog_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQColorDialog_Enums
#define _HDR_gsiDeclQColorDialog_Enums
...
//  Wrapper class for QFlags<enum QColorDialog::ColorDialogOption>
class QColorDialog_ColorDialogOption_Enums : public QFlags<enum QColorDialog::ColorDialogOption> {
public:
  QColorDialog_ColorDialogOption_Enums () : m_flags () { }
  QColorDialog_ColorDialogOption_Enums (enum QColorDialog::ColorDialogOption v) : m_flags (v) { }
  QColorDialog_ColorDialogOption_Enums (const QFlags<enum QColorDialog::ColorDialogOption> &v) : m_flags (v) { }
  QFlags<enum QColorDialog::ColorDialogOption> flags () const { return m_flags; }
private:
  QFlags<QColorDialog::ColorDialogOption> m_flags;
};

//  Wrapper class for enum QColorDialog::ColorDialogOption
class QColorDialog_ColorDialogOption_Enum : public QColorDialog_ColorDialogOption_Enums {
public:
  QColorDialog_ColorDialogOption_Enum () { }
  QColorDialog_ColorDialogOption_Enum (enum QColorDialog::ColorDialogOption v) : QColorDialog_ColorDialogOption_Enums (v) { }
  enum QColorDialog::ColorDialogOption value () const { return (enum QColorDialog::ColorDialogOption) flags ().operator int (); }
};

//  Converter for QFlags<enum QColorDialog::ColorDialogOption>
template <>
struct Converter<QFlags<enum QColorDialog::ColorDialogOption> >
{
public:
  typedef QFlags<enum QColorDialog::ColorDialogOption> source_type;
  typedef QColorDialog_ColorDialogOption_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QColorDialog::ColorDialogOption
template <>
struct Converter<enum QColorDialog::ColorDialogOption>
{
public:
  typedef enum QColorDialog::ColorDialogOption source_type;
  typedef QColorDialog_ColorDialogOption_Enum target_type;
