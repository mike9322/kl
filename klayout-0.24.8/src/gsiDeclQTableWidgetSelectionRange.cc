...
#include "gsiDeclQTableWidgetSelectionRange_Enums.h"
#include <memory>
...
static qt_gsi::GenericStaticMethod *_create_ctor_QTableWidgetSelectionRange_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QTableWidgetSelectionRange::QTableWidgetSelectionRange()\nThis method creates an object of class QTableWidgetSelectionRange.", &_init_ctor_QTableWidgetSelectionRange_0, &_call_ctor_QTableWidgetSelectionRange_0);
}
...
static qt_gsi::GenericStaticMethod *_create_ctor_QTableWidgetSelectionRange_2744 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QTableWidgetSelectionRange::QTableWidgetSelectionRange(int top, int left, int bottom, int right)\nThis method creates an object of class QTableWidgetSelectionRange.", &_init_ctor_QTableWidgetSelectionRange_2744, &_call_ctor_QTableWidgetSelectionRange_2744);
}
...
static qt_gsi::GenericStaticMethod *_create_ctor_QTableWidgetSelectionRange_3921 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QTableWidgetSelectionRange::QTableWidgetSelectionRange(const QTableWidgetSelectionRange &other)\nThis method creates an object of class QTableWidgetSelectionRange.", &_init_ctor_QTableWidgetSelectionRange_3921, &_call_ctor_QTableWidgetSelectionRange_3921);
}
...
static qt_gsi::GenericMethod *_create_f_bottomRow_c0 ()
{
  return new qt_gsi::GenericMethod ("bottomRow", "@brief Method int QTableWidgetSelectionRange::bottomRow()\n", true, &_init_f_bottomRow_c0, &_call_f_bottomRow_c0);
}
...
{
  return new qt_gsi::GenericMethod ("columnCount", "@brief Method int QTableWidgetSelectionRange::columnCount()\n", true, &_init_f_columnCount_c0, &_call_f_columnCount_c0);
}
...
static qt_gsi::GenericMethod *_create_f_leftColumn_c0 ()
{
  return new qt_gsi::GenericMethod ("leftColumn", "@brief Method int QTableWidgetSelectionRange::leftColumn()\n", true, &_init_f_leftColumn_c0, &_call_f_leftColumn_c0);
}
...
static qt_gsi::GenericMethod *_create_f_rightColumn_c0 ()
{
  return new qt_gsi::GenericMethod ("rightColumn", "@brief Method int QTableWidgetSelectionRange::rightColumn()\n", true, &_init_f_rightColumn_c0, &_call_f_rightColumn_c0);
}
...
{
  return new qt_gsi::GenericMethod ("rowCount", "@brief Method int QTableWidgetSelectionRange::rowCount()\n", true, &_init_f_rowCount_c0, &_call_f_rowCount_c0);
}
...
static qt_gsi::GenericMethod *_create_f_topRow_c0 ()
{
  return new qt_gsi::GenericMethod ("topRow", "@brief Method int QTableWidgetSelectionRange::topRow()\n", true, &_init_f_topRow_c0, &_call_f_topRow_c0);
}


namespace gsi
{
gsi::Class<QTableWidgetSelectionRange> decl_QTableWidgetSelectionRange ("QTableWidgetSelectionRange",
  gsi::Methods(_create_ctor_QTableWidgetSelectionRange_0 ()) +
  gsi::Methods(_create_ctor_QTableWidgetSelectionRange_2744 ()) +
  gsi::Methods(_create_ctor_QTableWidgetSelectionRange_3921 ()) +
  gsi::Methods(_create_f_bottomRow_c0 ()) +
  gsi::Methods(_create_f_columnCount_c0 ()) +
  gsi::Methods(_create_f_leftColumn_c0 ()) +
  gsi::Methods(_create_f_rightColumn_c0 ()) +
  gsi::Methods(_create_f_rowCount_c0 ()) +
  gsi::Methods(_create_f_topRow_c0 ()),
