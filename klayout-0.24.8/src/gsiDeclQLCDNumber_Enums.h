...
/**
*  @file gsiDeclQLCDNumber_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQLCDNumber_Enums
#define _HDR_gsiDeclQLCDNumber_Enums
...
//  Wrapper class for QFlags<enum QLCDNumber::Mode>
class QLCDNumber_Mode_Enums : public QFlags<enum QLCDNumber::Mode> {
public:
  QLCDNumber_Mode_Enums () : m_flags () { }
  QLCDNumber_Mode_Enums (enum QLCDNumber::Mode v) : m_flags (v) { }
  QLCDNumber_Mode_Enums (const QFlags<enum QLCDNumber::Mode> &v) : m_flags (v) { }
  QFlags<enum QLCDNumber::Mode> flags () const { return m_flags; }
private:
  QFlags<QLCDNumber::Mode> m_flags;
};

//  Wrapper class for enum QLCDNumber::Mode
class QLCDNumber_Mode_Enum : public QLCDNumber_Mode_Enums {
public:
  QLCDNumber_Mode_Enum () { }
  QLCDNumber_Mode_Enum (enum QLCDNumber::Mode v) : QLCDNumber_Mode_Enums (v) { }
  enum QLCDNumber::Mode value () const { return (enum QLCDNumber::Mode) flags ().operator int (); }
};

//  Converter for QFlags<enum QLCDNumber::Mode>
template <>
struct Converter<QFlags<enum QLCDNumber::Mode> >
{
public:
  typedef QFlags<enum QLCDNumber::Mode> source_type;
  typedef QLCDNumber_Mode_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QLCDNumber::Mode
template <>
struct Converter<enum QLCDNumber::Mode>
{
public:
  typedef enum QLCDNumber::Mode source_type;
  typedef QLCDNumber_Mode_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Wrapper class for QFlags<enum QLCDNumber::SegmentStyle>
class QLCDNumber_SegmentStyle_Enums : public QFlags<enum QLCDNumber::SegmentStyle> {
public:
  QLCDNumber_SegmentStyle_Enums () : m_flags () { }
  QLCDNumber_SegmentStyle_Enums (enum QLCDNumber::SegmentStyle v) : m_flags (v) { }
  QLCDNumber_SegmentStyle_Enums (const QFlags<enum QLCDNumber::SegmentStyle> &v) : m_flags (v) { }
  QFlags<enum QLCDNumber::SegmentStyle> flags () const { return m_flags; }
private:
  QFlags<QLCDNumber::SegmentStyle> m_flags;
};

//  Wrapper class for enum QLCDNumber::SegmentStyle
class QLCDNumber_SegmentStyle_Enum : public QLCDNumber_SegmentStyle_Enums {
public:
  QLCDNumber_SegmentStyle_Enum () { }
  QLCDNumber_SegmentStyle_Enum (enum QLCDNumber::SegmentStyle v) : QLCDNumber_SegmentStyle_Enums (v) { }
  enum QLCDNumber::SegmentStyle value () const { return (enum QLCDNumber::SegmentStyle) flags ().operator int (); }
};

//  Converter for QFlags<enum QLCDNumber::SegmentStyle>
template <>
struct Converter<QFlags<enum QLCDNumber::SegmentStyle> >
{
public:
  typedef QFlags<enum QLCDNumber::SegmentStyle> source_type;
  typedef QLCDNumber_SegmentStyle_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QLCDNumber::SegmentStyle
template <>
struct Converter<enum QLCDNumber::SegmentStyle>
{
public:
  typedef enum QLCDNumber::SegmentStyle source_type;
  typedef QLCDNumber_SegmentStyle_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};
