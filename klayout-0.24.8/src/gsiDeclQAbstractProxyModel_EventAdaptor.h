...
/**
*  @file generated/gsiDeclQAbstractProxyModel_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQAbstractProxyModel_EventAdaptor
#define _HDR_gsiDeclQAbstractProxyModel_EventAdaptor
...
public:
  QAbstractProxyModel_EventAdaptor (QObject *host);
