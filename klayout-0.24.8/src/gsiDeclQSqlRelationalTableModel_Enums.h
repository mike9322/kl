...
/**
*  @file gsiDeclQSqlRelationalTableModel_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQSqlRelationalTableModel_Enums
#define _HDR_gsiDeclQSqlRelationalTableModel_Enums
...
//  Wrapper class for QFlags<enum QSqlTableModel::EditStrategy>
class QSqlTableModel_EditStrategy_Enums : public QFlags<enum QSqlTableModel::EditStrategy> {
public:
  QSqlTableModel_EditStrategy_Enums () : m_flags () { }
  QSqlTableModel_EditStrategy_Enums (enum QSqlTableModel::EditStrategy v) : m_flags (v) { }
  QSqlTableModel_EditStrategy_Enums (const QFlags<enum QSqlTableModel::EditStrategy> &v) : m_flags (v) { }
  QFlags<enum QSqlTableModel::EditStrategy> flags () const { return m_flags; }
private:
  QFlags<QSqlTableModel::EditStrategy> m_flags;
};

//  Wrapper class for enum QSqlTableModel::EditStrategy
class QSqlTableModel_EditStrategy_Enum : public QSqlTableModel_EditStrategy_Enums {
public:
  QSqlTableModel_EditStrategy_Enum () { }
  QSqlTableModel_EditStrategy_Enum (enum QSqlTableModel::EditStrategy v) : QSqlTableModel_EditStrategy_Enums (v) { }
  enum QSqlTableModel::EditStrategy value () const { return (enum QSqlTableModel::EditStrategy) flags ().operator int (); }
};

//  Converter for QFlags<enum QSqlTableModel::EditStrategy>
template <>
struct Converter<QFlags<enum QSqlTableModel::EditStrategy> >
{
public:
  typedef QFlags<enum QSqlTableModel::EditStrategy> source_type;
  typedef QSqlTableModel_EditStrategy_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QSqlTableModel::EditStrategy
template <>
struct Converter<enum QSqlTableModel::EditStrategy>
{
public:
  typedef enum QSqlTableModel::EditStrategy source_type;
  typedef QSqlTableModel_EditStrategy_Enum target_type;
