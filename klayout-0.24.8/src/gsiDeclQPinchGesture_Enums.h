...
/**
*  @file gsiDeclQPinchGesture_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQPinchGesture_Enums
#define _HDR_gsiDeclQPinchGesture_Enums
...
//  Wrapper class for QFlags<enum QPinchGesture::ChangeFlag>
class QPinchGesture_ChangeFlag_Enums : public QFlags<enum QPinchGesture::ChangeFlag> {
public:
  QPinchGesture_ChangeFlag_Enums () : m_flags () { }
  QPinchGesture_ChangeFlag_Enums (enum QPinchGesture::ChangeFlag v) : m_flags (v) { }
  QPinchGesture_ChangeFlag_Enums (const QFlags<enum QPinchGesture::ChangeFlag> &v) : m_flags (v) { }
  QFlags<enum QPinchGesture::ChangeFlag> flags () const { return m_flags; }
private:
  QFlags<QPinchGesture::ChangeFlag> m_flags;
};

//  Wrapper class for enum QPinchGesture::ChangeFlag
class QPinchGesture_ChangeFlag_Enum : public QPinchGesture_ChangeFlag_Enums {
public:
  QPinchGesture_ChangeFlag_Enum () { }
  QPinchGesture_ChangeFlag_Enum (enum QPinchGesture::ChangeFlag v) : QPinchGesture_ChangeFlag_Enums (v) { }
  enum QPinchGesture::ChangeFlag value () const { return (enum QPinchGesture::ChangeFlag) flags ().operator int (); }
};

//  Converter for QFlags<enum QPinchGesture::ChangeFlag>
template <>
struct Converter<QFlags<enum QPinchGesture::ChangeFlag> >
{
public:
  typedef QFlags<enum QPinchGesture::ChangeFlag> source_type;
  typedef QPinchGesture_ChangeFlag_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QPinchGesture::ChangeFlag
template <>
struct Converter<enum QPinchGesture::ChangeFlag>
{
public:
  typedef enum QPinchGesture::ChangeFlag source_type;
  typedef QPinchGesture_ChangeFlag_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};
