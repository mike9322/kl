...
#include "gsiDeclQDomNotation_Enums.h"
#include <memory>
...
static qt_gsi::GenericStaticMethod *_create_ctor_QDomNotation_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QDomNotation::QDomNotation()\nThis method creates an object of class QDomNotation.", &_init_ctor_QDomNotation_0, &_call_ctor_QDomNotation_0);
}
...
{
  const QDomNotation &arg1 = args.read<const QDomNotation & > ();
  ret.write<QDomNotation *> (new QDomNotation (arg1));
}

static qt_gsi::GenericStaticMethod *_create_ctor_QDomNotation_2526 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QDomNotation::QDomNotation(const QDomNotation &x)\nThis method creates an object of class QDomNotation.", &_init_ctor_QDomNotation_2526, &_call_ctor_QDomNotation_2526);
}
...
{
  return new qt_gsi::GenericMethod ("nodeType", "@brief Method QDomNode::NodeType QDomNotation::nodeType()\n", true, &_init_f_nodeType_c0, &_call_f_nodeType_c0);
}
...
static qt_gsi::GenericMethod *_create_f_operator_eq__2526 ()
{
  return new qt_gsi::GenericMethod ("assign", "@brief Method QDomNotation &QDomNotation::operator=(const QDomNotation &)\n", false, &_init_f_operator_eq__2526, &_call_f_operator_eq__2526);
}
...
{
  return new qt_gsi::GenericMethod ("publicId", "@brief Method QString QDomNotation::publicId()\n", true, &_init_f_publicId_c0, &_call_f_publicId_c0);
}
...
{
  return new qt_gsi::GenericMethod ("systemId", "@brief Method QString QDomNotation::systemId()\n", true, &_init_f_systemId_c0, &_call_f_systemId_c0);
}
...
gsi::Class<QDomNotation> decl_QDomNotation (decl_QDomNode, "QDomNotation",
  gsi::Methods(_create_ctor_QDomNotation_0 ()) +
  gsi::Methods(_create_ctor_QDomNotation_2526 ()) +
  gsi::Methods(_create_f_nodeType_c0 ()) +
  gsi::Methods(_create_f_operator_eq__2526 ()) +
