...
#include "gsiDeclQPainterPath_Element_Enums.h"
#include <memory>
...
static qt_gsi::GenericStaticMethod *_create_ctor_QPainterPath_Element_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QPainterPath::Element::Element()\nThis method creates an object of class QPainterPath::Element.", &_init_ctor_QPainterPath_Element_0, &_call_ctor_QPainterPath_Element_0);
}
...
static qt_gsi::GenericMethod *_create_f_isCurveTo_c0 ()
{
  return new qt_gsi::GenericMethod ("isCurveTo?", "@brief Method bool QPainterPath::Element::isCurveTo()\n", true, &_init_f_isCurveTo_c0, &_call_f_isCurveTo_c0);
}
...
static qt_gsi::GenericMethod *_create_f_isLineTo_c0 ()
{
  return new qt_gsi::GenericMethod ("isLineTo?", "@brief Method bool QPainterPath::Element::isLineTo()\n", true, &_init_f_isLineTo_c0, &_call_f_isLineTo_c0);
}
...
static qt_gsi::GenericMethod *_create_f_isMoveTo_c0 ()
{
  return new qt_gsi::GenericMethod ("isMoveTo?", "@brief Method bool QPainterPath::Element::isMoveTo()\n", true, &_init_f_isMoveTo_c0, &_call_f_isMoveTo_c0);
}
...
{
  const QPainterPath::Element &arg1 = args.read<const QPainterPath::Element & > ();
  ret.write<bool > ((bool)((QPainterPath::Element *)cls)->operator!= (arg1));
}

static qt_gsi::GenericMethod *_create_f_operator_excl__eq__c3344 ()
{
  return new qt_gsi::GenericMethod ("!=", "@brief Method bool QPainterPath::Element::operator!=(const QPainterPath::Element &e)\n", true, &_init_f_operator_excl__eq__c3344, &_call_f_operator_excl__eq__c3344);
}
...
static qt_gsi::GenericMethod *_create_f_operator_eq__eq__c3344 ()
{
...
gsi::Class<QPainterPath::Element> decl_QPainterPath_Element ("QPainterPath_Element",
  gsi::Methods(_create_ctor_QPainterPath_Element_0 ()) +
  gsi::Methods(_create_f_isCurveTo_c0 ()) +
  gsi::Methods(_create_f_isLineTo_c0 ()) +
  gsi::Methods(_create_f_isMoveTo_c0 ()) +
  gsi::Methods(_create_f_operator_excl__eq__c3344 ()) +
  gsi::Methods(_create_f_operator_eq__eq__c3344 ()),
