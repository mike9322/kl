...
#include "gsiDeclQSqlRecord_Enums.h"
#include <memory>
...
static qt_gsi::GenericStaticMethod *_create_ctor_QSqlRecord_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QSqlRecord::QSqlRecord()\nThis method creates an object of class QSqlRecord.", &_init_ctor_QSqlRecord_0, &_call_ctor_QSqlRecord_0);
}
...
{
  const QSqlRecord &arg1 = args.read<const QSqlRecord & > ();
  ret.write<QSqlRecord *> (new QSqlRecord (arg1));
}

static qt_gsi::GenericStaticMethod *_create_ctor_QSqlRecord_2305 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QSqlRecord::QSqlRecord(const QSqlRecord &other)\nThis method creates an object of class QSqlRecord.", &_init_ctor_QSqlRecord_2305, &_call_ctor_QSqlRecord_2305);
}
...
static qt_gsi::GenericMethod *_create_f_append_2182 ()
{
  return new qt_gsi::GenericMethod ("append", "@brief Method void QSqlRecord::append(const QSqlField &field)\n", false, &_init_f_append_2182, &_call_f_append_2182);
}
...
{
  return new qt_gsi::GenericMethod ("clear", "@brief Method void QSqlRecord::clear()\n", false, &_init_f_clear_0, &_call_f_clear_0);
}
...
static qt_gsi::GenericMethod *_create_f_clearValues_0 ()
{
  return new qt_gsi::GenericMethod ("clearValues", "@brief Method void QSqlRecord::clearValues()\n", false, &_init_f_clearValues_0, &_call_f_clearValues_0);
}
...
{
  return new qt_gsi::GenericMethod ("contains", "@brief Method bool QSqlRecord::contains(const QString &name)\n", true, &_init_f_contains_c2025, &_call_f_contains_c2025);
}
...
{
  return new qt_gsi::GenericMethod ("count", "@brief Method int QSqlRecord::count()\n", true, &_init_f_count_c0, &_call_f_count_c0);
}
...
static qt_gsi::GenericMethod *_create_f_field_c767 ()
{
  return new qt_gsi::GenericMethod ("field", "@brief Method QSqlField QSqlRecord::field(int i)\n", true, &_init_f_field_c767, &_call_f_field_c767);
}
...
{
  return new qt_gsi::GenericMethod ("field", "@brief Method QSqlField QSqlRecord::field(const QString &name)\n", true, &_init_f_field_c2025, &_call_f_field_c2025);
}
...
static qt_gsi::GenericMethod *_create_f_fieldName_c767 ()
{
  return new qt_gsi::GenericMethod ("fieldName", "@brief Method QString QSqlRecord::fieldName(int i)\n", true, &_init_f_fieldName_c767, &_call_f_fieldName_c767);
}
...
static qt_gsi::GenericMethod *_create_f_indexOf_c2025 ()
{
  return new qt_gsi::GenericMethod ("indexOf", "@brief Method int QSqlRecord::indexOf(const QString &name)\n", true, &_init_f_indexOf_c2025, &_call_f_indexOf_c2025);
}
...
{
  int arg1 = args.read<int > ();
  const QSqlField &arg2 = args.read<const QSqlField & > ();
  ((QSqlRecord *)cls)->insert (arg1, arg2);
}

static qt_gsi::GenericMethod *_create_f_insert_2841 ()
{
  return new qt_gsi::GenericMethod ("insert", "@brief Method void QSqlRecord::insert(int pos, const QSqlField &field)\n", false, &_init_f_insert_2841, &_call_f_insert_2841);
}
...
{
  return new qt_gsi::GenericMethod ("isEmpty?", "@brief Method bool QSqlRecord::isEmpty()\n", true, &_init_f_isEmpty_c0, &_call_f_isEmpty_c0);
}
...
static qt_gsi::GenericMethod *_create_f_isGenerated_c767 ()
{
  return new qt_gsi::GenericMethod ("isGenerated?", "@brief Method bool QSqlRecord::isGenerated(int i)\n", true, &_init_f_isGenerated_c767, &_call_f_isGenerated_c767);
}
...
static qt_gsi::GenericMethod *_create_f_isGenerated_c2025 ()
{
  return new qt_gsi::GenericMethod ("isGenerated?", "@brief Method bool QSqlRecord::isGenerated(const QString &name)\n", true, &_init_f_isGenerated_c2025, &_call_f_isGenerated_c2025);
}
...
{
  return new qt_gsi::GenericMethod ("isNull?", "@brief Method bool QSqlRecord::isNull(int i)\n", true, &_init_f_isNull_c767, &_call_f_isNull_c767);
}
...
static qt_gsi::GenericMethod *_create_f_isNull_c2025 ()
{
  return new qt_gsi::GenericMethod ("isNull?", "@brief Method bool QSqlRecord::isNull(const QString &name)\n", true, &_init_f_isNull_c2025, &_call_f_isNull_c2025);
}
...
static qt_gsi::GenericMethod *_create_f_operator_excl__eq__c2305 ()
{
  return new qt_gsi::GenericMethod ("!=", "@brief Method bool QSqlRecord::operator!=(const QSqlRecord &other)\n", true, &_init_f_operator_excl__eq__c2305, &_call_f_operator_excl__eq__c2305);
}
...
static qt_gsi::GenericMethod *_create_f_operator_eq__2305 ()
{
  return new qt_gsi::GenericMethod ("assign", "@brief Method QSqlRecord &QSqlRecord::operator=(const QSqlRecord &other)\n", false, &_init_f_operator_eq__2305, &_call_f_operator_eq__2305);
}
...
static qt_gsi::GenericMethod *_create_f_operator_eq__eq__c2305 ()
{
...
static qt_gsi::GenericMethod *_create_f_remove_767 ()
{
  return new qt_gsi::GenericMethod ("remove", "@brief Method void QSqlRecord::remove(int pos)\n", false, &_init_f_remove_767, &_call_f_remove_767);
}
...
static qt_gsi::GenericMethod *_create_f_replace_2841 ()
{
  return new qt_gsi::GenericMethod ("replace", "@brief Method void QSqlRecord::replace(int pos, const QSqlField &field)\n", false, &_init_f_replace_2841, &_call_f_replace_2841);
}
...
static qt_gsi::GenericMethod *_create_f_setGenerated_2781 ()
{
  return new qt_gsi::GenericMethod ("setGenerated", "@brief Method void QSqlRecord::setGenerated(const QString &name, bool generated)\n", false, &_init_f_setGenerated_2781, &_call_f_setGenerated_2781);
}
...
static qt_gsi::GenericMethod *_create_f_setGenerated_1523 ()
{
  return new qt_gsi::GenericMethod ("setGenerated", "@brief Method void QSqlRecord::setGenerated(int i, bool generated)\n", false, &_init_f_setGenerated_1523, &_call_f_setGenerated_1523);
}
...
static qt_gsi::GenericMethod *_create_f_setNull_767 ()
{
  return new qt_gsi::GenericMethod ("setNull", "@brief Method void QSqlRecord::setNull(int i)\n", false, &_init_f_setNull_767, &_call_f_setNull_767);
}
...
static qt_gsi::GenericMethod *_create_f_setNull_2025 ()
{
  return new qt_gsi::GenericMethod ("setNull", "@brief Method void QSqlRecord::setNull(const QString &name)\n", false, &_init_f_setNull_2025, &_call_f_setNull_2025);
}
...
static qt_gsi::GenericMethod *_create_f_setValue_2778 ()
{
  return new qt_gsi::GenericMethod ("setValue", "@brief Method void QSqlRecord::setValue(int i, const QVariant &val)\n", false, &_init_f_setValue_2778, &_call_f_setValue_2778);
}
...
{
  return new qt_gsi::GenericMethod ("setValue", "@brief Method void QSqlRecord::setValue(const QString &name, const QVariant &val)\n", false, &_init_f_setValue_4036, &_call_f_setValue_4036);
}
...
{
  return new qt_gsi::GenericMethod ("value", "@brief Method QVariant QSqlRecord::value(int i)\n", true, &_init_f_value_c767, &_call_f_value_c767);
}
...
{
  return new qt_gsi::GenericMethod ("value", "@brief Method QVariant QSqlRecord::value(const QString &name)\n", true, &_init_f_value_c2025, &_call_f_value_c2025);
}
...
gsi::Class<QSqlRecord> decl_QSqlRecord ("QSqlRecord",
  gsi::Methods(_create_ctor_QSqlRecord_0 ()) +
  gsi::Methods(_create_ctor_QSqlRecord_2305 ()) +
  gsi::Methods(_create_f_append_2182 ()) +
  gsi::Methods(_create_f_clear_0 ()) +
  gsi::Methods(_create_f_clearValues_0 ()) +
  gsi::Methods(_create_f_contains_c2025 ()) +
  gsi::Methods(_create_f_count_c0 ()) +
  gsi::Methods(_create_f_field_c767 ()) +
  gsi::Methods(_create_f_field_c2025 ()) +
  gsi::Methods(_create_f_fieldName_c767 ()) +
  gsi::Methods(_create_f_indexOf_c2025 ()) +
  gsi::Methods(_create_f_insert_2841 ()) +
  gsi::Methods(_create_f_isEmpty_c0 ()) +
  gsi::Methods(_create_f_isGenerated_c767 ()) +
  gsi::Methods(_create_f_isGenerated_c2025 ()) +
  gsi::Methods(_create_f_isNull_c767 ()) +
  gsi::Methods(_create_f_isNull_c2025 ()) +
  gsi::Methods(_create_f_operator_excl__eq__c2305 ()) +
  gsi::Methods(_create_f_operator_eq__2305 ()) +
  gsi::Methods(_create_f_operator_eq__eq__c2305 ()) +
  gsi::Methods(_create_f_remove_767 ()) +
  gsi::Methods(_create_f_replace_2841 ()) +
  gsi::Methods(_create_f_setGenerated_2781 ()) +
  gsi::Methods(_create_f_setGenerated_1523 ()) +
  gsi::Methods(_create_f_setNull_767 ()) +
  gsi::Methods(_create_f_setNull_2025 ()) +
  gsi::Methods(_create_f_setValue_2778 ()) +
