...
#include "gsiDeclQAbstractListModel_EventAdaptor.h"
#include "gsiDeclQAbstractListModel_Enums.h"
#include <memory>
...
{
  return new qt_gsi::GenericMethod ("dropMimeData", "@brief Method bool QAbstractListModel::dropMimeData(const QMimeData *data, Qt::DropAction action, int row, int column, const QModelIndex &parent)\nThis is a reimplementation of QAbstractItemModel::dropMimeData", false, &_init_f_dropMimeData_7425, &_call_f_dropMimeData_7425);
}
...
{
  return new qt_gsi::GenericMethod ("index", "@brief Method QModelIndex QAbstractListModel::index(int row, int column, const QModelIndex &parent)\nThis is a reimplementation of QAbstractItemModel::index", true, &_init_f_index_c3713, &_call_f_index_c3713);
}
...
{
  return new qt_gsi::GenericStaticMethod ("tr", "@brief Static method QString QAbstractListModel::tr(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_tr_3354, &_call_f_tr_3354);
}
...
{
  return new qt_gsi::GenericStaticMethod ("tr", "@brief Static method QString QAbstractListModel::tr(const char *s, const char *c, int n)\nThis method is static and can be called without an instance.", &_init_f_tr_4013, &_call_f_tr_4013);
}
...
{
  return new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QAbstractListModel::trUtf8(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_3354, &_call_f_trUtf8_3354);
}
...
{
  return new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QAbstractListModel::trUtf8(const char *s, const char *c, int n)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_4013, &_call_f_trUtf8_4013);
}

static qt_gsi::QObjectConnector<QAbstractListModel, QAbstractListModel_EventAdaptor> ea_QAbstractListModel;

namespace gsi
{
extern gsi::Class<QAbstractItemModel> decl_QAbstractItemModel;

gsi::Class<QAbstractListModel> decl_QAbstractListModel (ea_QAbstractListModel, decl_QAbstractItemModel, "QAbstractListModel_Native",
  gsi::Methods(_create_smo ()) +
  gsi::Methods(_create_f_dropMimeData_7425 ()) +
  gsi::Methods(_create_f_index_c3713 ()) +
  qt_gsi::qt_signal<QAbstractListModel, QAbstractListModel_EventAdaptor, const QModelIndex &, const QModelIndex &> ("dataChanged", &QAbstractListModel_EventAdaptor::dataChanged_e_4682, gsi::arg("topLeft"), gsi::arg("bottomRight"), "@brief Signal declaration for QAbstractListModel::dataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight)\nYou can bind a procedure to this signal.") +
  qt_gsi::qt_signal<QAbstractListModel, QAbstractListModel_EventAdaptor, QObject *> ("destroyed", &QAbstractListModel_EventAdaptor::destroyed_e_1302, gsi::arg("arg1"), "@brief Signal declaration for QAbstractListModel::destroyed(QObject *)\nYou can bind a procedure to this signal.") +
  qt_gsi::qt_signal<QAbstractListModel, QAbstractListModel_EventAdaptor, const qt_gsi::Converter<Qt::Orientation>::target_type &, int, int> ("headerDataChanged", &QAbstractListModel_EventAdaptor::headerDataChanged_e_3231, gsi::arg("orientation"), gsi::arg("first"), gsi::arg("last"), "@brief Signal declaration for QAbstractListModel::headerDataChanged(Qt::Orientation orientation, int first, int last)\nYou can bind a procedure to this signal.") +
  qt_gsi::qt_signal<QAbstractListModel, QAbstractListModel_EventAdaptor> ("layoutAboutToBeChanged", &QAbstractListModel_EventAdaptor::layoutAboutToBeChanged_e_0, "@brief Signal declaration for QAbstractListModel::layoutAboutToBeChanged()\nYou can bind a procedure to this signal.") +
  qt_gsi::qt_signal<QAbstractListModel, QAbstractListModel_EventAdaptor> ("layoutChanged", &QAbstractListModel_EventAdaptor::layoutChanged_e_0, "@brief Signal declaration for QAbstractListModel::layoutChanged()\nYou can bind a procedure to this signal.") +
...
public:
  ...
  //  void QAbstractListModel::beginInsertColumns(const QModelIndex &parent, int first, int last)
  ...
  //  void QAbstractListModel::beginInsertRows(const QModelIndex &parent, int first, int last)
  ...
  //  bool QAbstractListModel::beginMoveColumns(const QModelIndex &sourceParent, int sourceFirst, int sourceLast, const QModelIndex &destinationParent, int destinationColumn)
  ...
  //  bool QAbstractListModel::beginMoveRows(const QModelIndex &sourceParent, int sourceFirst, int sourceLast, const QModelIndex &destinationParent, int destinationRow)
  ...
  //  void QAbstractListModel::beginRemoveColumns(const QModelIndex &parent, int first, int last)
  ...
  //  void QAbstractListModel::beginRemoveRows(const QModelIndex &parent, int first, int last)
  ...
  //  void QAbstractListModel::beginResetModel()
  ...
  //  void QAbstractListModel::changePersistentIndexList(const QList<QModelIndex> &from, const QList<QModelIndex> &to)
  void fp_QAbstractListModel_changePersistentIndexList_5912 (const qt_gsi::Converter<QList<QModelIndex> >::target_type & from, const qt_gsi::Converter<QList<QModelIndex> >::target_type & to) {
    QAbstractListModel::changePersistentIndexList(qt_gsi::QtToCppAdaptor<QList<QModelIndex> >(from).cref(), qt_gsi::QtToCppAdaptor<QList<QModelIndex> >(to).cref());
  }

  //  QModelIndex QAbstractListModel::createIndex(int row, int column, void *data)
  ...
  //  QModelIndex QAbstractListModel::createIndex(int row, int column, int id)
  ...
  //  QModelIndex QAbstractListModel::createIndex(int row, int column, quint32 id)
  QModelIndex fp_QAbstractListModel_createIndex_c2416 (int row, int column, quint32 id) const {
    return QAbstractListModel::createIndex(row, column, id);
  }

  //  bool QAbstractListModel::decodeData(int row, int column, const QModelIndex &parent, QDataStream &stream)
  ...
  //  void QAbstractListModel::encodeData(const QList<QModelIndex> &indexes, QDataStream &stream)
  void fp_QAbstractListModel_encodeData_c4599 (const qt_gsi::Converter<QList<QModelIndex> >::target_type & indexes, QDataStream &stream) const {
    QAbstractListModel::encodeData(qt_gsi::QtToCppAdaptor<QList<QModelIndex> >(indexes).cref(), stream);
  }

  //  void QAbstractListModel::endInsertColumns()
  void fp_QAbstractListModel_endInsertColumns_0 () {
    QAbstractListModel::endInsertColumns();
  }

  //  void QAbstractListModel::endInsertRows()
  void fp_QAbstractListModel_endInsertRows_0 () {
    QAbstractListModel::endInsertRows();
  }

  //  void QAbstractListModel::endMoveColumns()
  void fp_QAbstractListModel_endMoveColumns_0 () {
    QAbstractListModel::endMoveColumns();
  }

  //  void QAbstractListModel::endMoveRows()
  ...
  //  void QAbstractListModel::endRemoveRows()
  void fp_QAbstractListModel_endRemoveRows_0 () {
    QAbstractListModel::endRemoveRows();
  }

  //  void QAbstractListModel::endResetModel()
  void fp_QAbstractListModel_endResetModel_0 () {
    QAbstractListModel::endResetModel();
  }

  //  QList<QModelIndex> QAbstractListModel::persistentIndexList()
  qt_gsi::Converter<QList<QModelIndex> >::target_type fp_QAbstractListModel_persistentIndexList_c0 () const {
    return qt_gsi::CppToQtAdaptor<QList<QModelIndex> >(QAbstractListModel::persistentIndexList());
  }

  //  int QAbstractListModel::receivers(const char *signal)
  int fp_QAbstractListModel_receivers_c1731 (const char *signal) const {
    return QAbstractListModel::receivers(signal);
  }

  //  void QAbstractListModel::reset()
  void fp_QAbstractListModel_reset_0 () {
    QAbstractListModel::reset();
  }

  //  QObject *QAbstractListModel::sender()
  ...
  {
    return qt_gsi::CppToQtAdaptor<QFlags<Qt::ItemFlag> >(QAbstractListModel::flags(index));
  }

  virtual QFlags<Qt::ItemFlag> flags(const QModelIndex &index) const
  {
    if (cb_flags_c2395_0.can_issue()) {
      return qt_gsi::QtToCppAdaptor<QFlags<Qt::ItemFlag> >(cb_flags_c2395_0.issue<QAbstractListModel_Adaptor, qt_gsi::Converter<QFlags<Qt::ItemFlag> >::target_type, const QModelIndex &>(&QAbstractListModel_Adaptor::cbs_flags_c2395_0, index)).cref();
    } else {
  ...
  {
    return qt_gsi::CppToQtAdaptor<QList<QModelIndex> >(QAbstractListModel::match(start, role, value, hits, qt_gsi::QtToCppAdaptor<QFlags<Qt::MatchFlag> >(flags).cref()));
  }
  ...
  {
    return QAbstractListModel::mimeData(qt_gsi::QtToCppAdaptor<QList<QModelIndex> >(indexes).cref());
  }

  virtual QMimeData * mimeData(const QList<QModelIndex> &indexes) const
  {
    if (cb_mimeData_c3010_0.can_issue()) {
      return cb_mimeData_c3010_0.issue<QAbstractListModel_Adaptor, QMimeData *, const qt_gsi::Converter<QList<QModelIndex> >::target_type &>(&QAbstractListModel_Adaptor::cbs_mimeData_c3010_0, qt_gsi::CppToQtAdaptor<QList<QModelIndex> >(indexes));
    } else {
  ...
  {
    return qt_gsi::CppToQtAdaptor<QStringList>(QAbstractListModel::mimeTypes());
  }

  virtual QStringList mimeTypes() const
  {
    if (cb_mimeTypes_c0_0.can_issue()) {
      return qt_gsi::QtToCppAdaptor<QStringList>(cb_mimeTypes_c0_0.issue<QAbstractListModel_Adaptor, qt_gsi::Converter<QStringList>::target_type>(&QAbstractListModel_Adaptor::cbs_mimeTypes_c0_0)).cref();
    } else {
  ...
  {
    return qt_gsi::CppToQtAdaptor<QFlags<Qt::DropAction> >(QAbstractListModel::supportedDropActions());
  }

  virtual QFlags<Qt::DropAction> supportedDropActions() const
  {
    if (cb_supportedDropActions_c0_0.can_issue()) {
      return qt_gsi::QtToCppAdaptor<QFlags<Qt::DropAction> >(cb_supportedDropActions_c0_0.issue<QAbstractListModel_Adaptor, qt_gsi::Converter<QFlags<Qt::DropAction> >::target_type>(&QAbstractListModel_Adaptor::cbs_supportedDropActions_c0_0)).cref();
    } else {
...
static qt_gsi::GenericStaticMethod *_create_ctor_QAbstractListModel_Adaptor_1302 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QAbstractListModel::QAbstractListModel(QObject *parent)\nThis method creates an object of class QAbstractListModel.", &_init_ctor_QAbstractListModel_Adaptor_1302, &_call_ctor_QAbstractListModel_Adaptor_1302);
}
...
{
  return new qt_gsi::GenericMethod("*beginInsertColumns", "@brief Method void QAbstractListModel::beginInsertColumns(const QModelIndex &parent, int first, int last)\nThis method is protected and can only be called from inside a derived class.", false, &_init_fp_beginInsertColumns_3713, &_call_fp_beginInsertColumns_3713);
}
...
{
  return new qt_gsi::GenericMethod("*beginInsertRows", "@brief Method void QAbstractListModel::beginInsertRows(const QModelIndex &parent, int first, int last)\nThis method is protected and can only be called from inside a derived class.", false, &_init_fp_beginInsertRows_3713, &_call_fp_beginInsertRows_3713);
}
...
{
  return new qt_gsi::GenericMethod("*beginMoveColumns", "@brief Method bool QAbstractListModel::beginMoveColumns(const QModelIndex &sourceParent, int sourceFirst, int sourceLast, const QModelIndex &destinationParent, int destinationColumn)\nThis method is protected and can only be called from inside a derived class.", false, &_init_fp_beginMoveColumns_6659, &_call_fp_beginMoveColumns_6659);
}
...
{
  return new qt_gsi::GenericMethod("*beginMoveRows", "@brief Method bool QAbstractListModel::beginMoveRows(const QModelIndex &sourceParent, int sourceFirst, int sourceLast, const QModelIndex &destinationParent, int destinationRow)\nThis method is protected and can only be called from inside a derived class.", false, &_init_fp_beginMoveRows_6659, &_call_fp_beginMoveRows_6659);
}
...
{
  return new qt_gsi::GenericMethod("*beginRemoveColumns", "@brief Method void QAbstractListModel::beginRemoveColumns(const QModelIndex &parent, int first, int last)\nThis method is protected and can only be called from inside a derived class.", false, &_init_fp_beginRemoveColumns_3713, &_call_fp_beginRemoveColumns_3713);
}
...
{
  return new qt_gsi::GenericMethod("*beginRemoveRows", "@brief Method void QAbstractListModel::beginRemoveRows(const QModelIndex &parent, int first, int last)\nThis method is protected and can only be called from inside a derived class.", false, &_init_fp_beginRemoveRows_3713, &_call_fp_beginRemoveRows_3713);
}
...
{
  return new qt_gsi::GenericMethod("*changePersistentIndex", "@brief Method void QAbstractListModel::changePersistentIndex(const QModelIndex &from, const QModelIndex &to)\nThis method is protected and can only be called from inside a derived class.", false, &_init_fp_changePersistentIndex_4682, &_call_fp_changePersistentIndex_4682);
}
...
{
  return new qt_gsi::GenericMethod("*changePersistentIndexList", "@brief Method void QAbstractListModel::changePersistentIndexList(const QList<QModelIndex> &from, const QList<QModelIndex> &to)\nThis method is protected and can only be called from inside a derived class.", false, &_init_fp_changePersistentIndexList_5912, &_call_fp_changePersistentIndexList_5912);
}
...
{
  return new qt_gsi::GenericMethod("*decodeData", "@brief Method bool QAbstractListModel::decodeData(int row, int column, const QModelIndex &parent, QDataStream &stream)\nThis method is protected and can only be called from inside a derived class.", false, &_init_fp_decodeData_5302, &_call_fp_decodeData_5302);
}
...
{
  return new qt_gsi::GenericMethod("*encodeData", "@brief Method void QAbstractListModel::encodeData(const QList<QModelIndex> &indexes, QDataStream &stream)\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_encodeData_c4599, &_call_fp_encodeData_c4599);
}
...
{
  ret.write<qt_gsi::Converter<QList<QModelIndex> >::target_type > ((qt_gsi::Converter<QList<QModelIndex> >::target_type)((QAbstractListModel_Adaptor *)cls)->fp_QAbstractListModel_persistentIndexList_c0 ());
}

static qt_gsi::GenericMethod*_create_fp_persistentIndexList_c0 ()
{
  return new qt_gsi::GenericMethod("*persistentIndexList", "@brief Method QList<QModelIndex> QAbstractListModel::persistentIndexList()\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_persistentIndexList_c0, &_call_fp_persistentIndexList_c0);
}
...
{
  return new qt_gsi::GenericMethod("*receivers", "@brief Method int QAbstractListModel::receivers(const char *signal)\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_receivers_c1731, &_call_fp_receivers_c1731);
}
...
{
  return new qt_gsi::GenericMethod("*sender", "@brief Method QObject *QAbstractListModel::sender()\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_sender_c0, &_call_fp_sender_c0);
}
...
{
  return new qt_gsi::GenericMethod ("dropMimeData", "@brief Virtual method bool QAbstractListModel::dropMimeData(const QMimeData *data, Qt::DropAction action, int row, int column, const QModelIndex &parent)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_dropMimeData_7425_0, &_call_cbs_dropMimeData_7425_0, &_set_callback_cbs_dropMimeData_7425_0);
}
...
{
  return new qt_gsi::GenericMethod ("event", "@brief Virtual method bool QAbstractListModel::event(QEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_event_1217_0, &_call_cbs_event_1217_0, &_set_callback_cbs_event_1217_0);
}
...
{
  return new qt_gsi::GenericMethod ("eventFilter", "@brief Virtual method bool QAbstractListModel::eventFilter(QObject *, QEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_eventFilter_2411_0, &_call_cbs_eventFilter_2411_0, &_set_callback_cbs_eventFilter_2411_0);
}
...
{
  const QModelIndex &arg1 = args.read<const QModelIndex & > ();
  ret.write<qt_gsi::Converter<QFlags<Qt::ItemFlag> >::target_type > ((qt_gsi::Converter<QFlags<Qt::ItemFlag> >::target_type)((QAbstractListModel_Adaptor *)cls)->cbs_flags_c2395_0 (arg1));
}
...
{
  return new qt_gsi::GenericMethod ("index", "@brief Virtual method QModelIndex QAbstractListModel::index(int row, int column, const QModelIndex &parent)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_index_c3713_2, &_call_cbs_index_c3713_2, &_set_callback_cbs_index_c3713_2);
}
...
static void _call_cbs_match_c7932_2 (const qt_gsi::GenericMethod *decl, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ret.write<qt_gsi::Converter<QList<QModelIndex> >::target_type > ((qt_gsi::Converter<QList<QModelIndex> >::target_type)((QAbstractListModel_Adaptor *)cls)->cbs_match_c7932_2 (arg1, arg2, arg3, arg4, arg5));
}
...
{
  return new qt_gsi::GenericMethod ("match", "@brief Virtual method QList<QModelIndex> QAbstractListModel::match(const QModelIndex &start, int role, const QVariant &value, int hits, QFlags<Qt::MatchFlag> flags)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_match_c7932_2, &_call_cbs_match_c7932_2, &_set_callback_cbs_match_c7932_2);
}
...
{
  ret.write<qt_gsi::Converter<QStringList>::target_type > ((qt_gsi::Converter<QStringList>::target_type)((QAbstractListModel_Adaptor *)cls)->cbs_mimeTypes_c0_0 ());
}
...
{
  return new qt_gsi::GenericMethod ("setData", "@brief Virtual method bool QAbstractListModel::setData(const QModelIndex &index, const QVariant &value, int role)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_setData_5065_1, &_call_cbs_setData_5065_1, &_set_callback_cbs_setData_5065_1);
}
...
{
  return new qt_gsi::GenericMethod ("setHeaderData", "@brief Virtual method bool QAbstractListModel::setHeaderData(int section, Qt::Orientation orientation, const QVariant &value, int role)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_setHeaderData_5242_1, &_call_cbs_setHeaderData_5242_1, &_set_callback_cbs_setHeaderData_5242_1);
}
...
{
  ret.write<qt_gsi::Converter<QFlags<Qt::DropAction> >::target_type > ((qt_gsi::Converter<QFlags<Qt::DropAction> >::target_type)((QAbstractListModel_Adaptor *)cls)->cbs_supportedDropActions_c0_0 ());
}
...
{
  return new qt_gsi::GenericMethod ("*childEvent", "@brief Virtual method void QAbstractListModel::childEvent(QChildEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_childEvent_1701_0, &_call_cbs_childEvent_1701_0, &_set_callback_cbs_childEvent_1701_0);
}
...
{
  return new qt_gsi::GenericMethod ("*customEvent", "@brief Virtual method void QAbstractListModel::customEvent(QEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_customEvent_1217_0, &_call_cbs_customEvent_1217_0, &_set_callback_cbs_customEvent_1217_0);
}
...
{
  return new qt_gsi::GenericMethod ("*disconnectNotify", "@brief Virtual method void QAbstractListModel::disconnectNotify(const char *signal)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_disconnectNotify_1731_0, &_call_cbs_disconnectNotify_1731_0, &_set_callback_cbs_disconnectNotify_1731_0);
}
...
{
  return new qt_gsi::GenericMethod ("*timerEvent", "@brief Virtual method void QAbstractListModel::timerEvent(QTimerEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_timerEvent_1730_0, &_call_cbs_timerEvent_1730_0, &_set_callback_cbs_timerEvent_1730_0);
}
...
gsi::Class<QAbstractListModel_Adaptor> decl_QAbstractListModel_Adaptor (decl_QAbstractListModel, "QAbstractListModel",
  ...
  gsi::Methods(_create_ctor_QAbstractListModel_Adaptor_1302 ()),
