...
#include "gsiDeclQStyleOptionSlider_Enums.h"
#include <memory>
...
static qt_gsi::GenericStaticMethod *_create_ctor_QStyleOptionSlider_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QStyleOptionSlider::QStyleOptionSlider()\nThis method creates an object of class QStyleOptionSlider.", &_init_ctor_QStyleOptionSlider_0, &_call_ctor_QStyleOptionSlider_0);
}
...
{
  const QStyleOptionSlider &arg1 = args.read<const QStyleOptionSlider & > ();
  ret.write<QStyleOptionSlider *> (new QStyleOptionSlider (arg1));
}

static qt_gsi::GenericStaticMethod *_create_ctor_QStyleOptionSlider_3167 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QStyleOptionSlider::QStyleOptionSlider(const QStyleOptionSlider &other)\nThis method creates an object of class QStyleOptionSlider.", &_init_ctor_QStyleOptionSlider_3167, &_call_ctor_QStyleOptionSlider_3167);
}
...
gsi::Class<QStyleOptionSlider> decl_QStyleOptionSlider (decl_QStyleOptionComplex, "QStyleOptionSlider",
  gsi::Methods(_create_ctor_QStyleOptionSlider_0 ()) +
  gsi::Methods(_create_ctor_QStyleOptionSlider_3167 ()),
