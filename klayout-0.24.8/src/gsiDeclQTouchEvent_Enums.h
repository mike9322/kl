...
/**
*  @file gsiDeclQTouchEvent_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQTouchEvent_Enums
#define _HDR_gsiDeclQTouchEvent_Enums
...
//  Wrapper class for QFlags<enum QTouchEvent::DeviceType>
class QTouchEvent_DeviceType_Enums : public QFlags<enum QTouchEvent::DeviceType> {
public:
  QTouchEvent_DeviceType_Enums () : m_flags () { }
  QTouchEvent_DeviceType_Enums (enum QTouchEvent::DeviceType v) : m_flags (v) { }
  QTouchEvent_DeviceType_Enums (const QFlags<enum QTouchEvent::DeviceType> &v) : m_flags (v) { }
  QFlags<enum QTouchEvent::DeviceType> flags () const { return m_flags; }
private:
  QFlags<QTouchEvent::DeviceType> m_flags;
};

//  Wrapper class for enum QTouchEvent::DeviceType
class QTouchEvent_DeviceType_Enum : public QTouchEvent_DeviceType_Enums {
public:
  QTouchEvent_DeviceType_Enum () { }
  QTouchEvent_DeviceType_Enum (enum QTouchEvent::DeviceType v) : QTouchEvent_DeviceType_Enums (v) { }
  enum QTouchEvent::DeviceType value () const { return (enum QTouchEvent::DeviceType) flags ().operator int (); }
};

//  Converter for QFlags<enum QTouchEvent::DeviceType>
template <>
struct Converter<QFlags<enum QTouchEvent::DeviceType> >
{
public:
  typedef QFlags<enum QTouchEvent::DeviceType> source_type;
  typedef QTouchEvent_DeviceType_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QTouchEvent::DeviceType
template <>
struct Converter<enum QTouchEvent::DeviceType>
{
public:
  typedef enum QTouchEvent::DeviceType source_type;
  typedef QTouchEvent_DeviceType_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};
