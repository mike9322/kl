...
/**
*  @file generated/gsiDeclQFrame_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQFrame_EventAdaptor
#define _HDR_gsiDeclQFrame_EventAdaptor
...
public:
  QFrame_EventAdaptor (QObject *host);
