...
#include "gsiDeclQStyleOptionTabWidgetFrame_Enums.h"
#include <memory>
...
static qt_gsi::GenericStaticMethod *_create_ctor_QStyleOptionTabWidgetFrame_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QStyleOptionTabWidgetFrame::QStyleOptionTabWidgetFrame()\nThis method creates an object of class QStyleOptionTabWidgetFrame.", &_init_ctor_QStyleOptionTabWidgetFrame_0, &_call_ctor_QStyleOptionTabWidgetFrame_0);
}
...
{
  const QStyleOptionTabWidgetFrame &arg1 = args.read<const QStyleOptionTabWidgetFrame & > ();
  ret.write<QStyleOptionTabWidgetFrame *> (new QStyleOptionTabWidgetFrame (arg1));
}

static qt_gsi::GenericStaticMethod *_create_ctor_QStyleOptionTabWidgetFrame_3938 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QStyleOptionTabWidgetFrame::QStyleOptionTabWidgetFrame(const QStyleOptionTabWidgetFrame &other)\nThis method creates an object of class QStyleOptionTabWidgetFrame.", &_init_ctor_QStyleOptionTabWidgetFrame_3938, &_call_ctor_QStyleOptionTabWidgetFrame_3938);
}
...
gsi::Class<QStyleOptionTabWidgetFrame> decl_QStyleOptionTabWidgetFrame (decl_QStyleOption, "QStyleOptionTabWidgetFrame",
  gsi::Methods(_create_ctor_QStyleOptionTabWidgetFrame_0 ()) +
  gsi::Methods(_create_ctor_QStyleOptionTabWidgetFrame_3938 ()),
