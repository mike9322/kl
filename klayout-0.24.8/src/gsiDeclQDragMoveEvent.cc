...
#include "gsiDeclQDragMoveEvent_Enums.h"
#include <memory>
...
{
  return new qt_gsi::GenericMethod ("accept", "@brief Method void QDragMoveEvent::accept()\n", false, &_init_f_accept_0, &_call_f_accept_0);
}
...
static qt_gsi::GenericMethod *_create_f_accept_1792 ()
{
  return new qt_gsi::GenericMethod ("accept", "@brief Method void QDragMoveEvent::accept(const QRect &r)\n", false, &_init_f_accept_1792, &_call_f_accept_1792);
}
...
static qt_gsi::GenericMethod *_create_f_answerRect_c0 ()
{
  return new qt_gsi::GenericMethod ("answerRect", "@brief Method QRect QDragMoveEvent::answerRect()\n", true, &_init_f_answerRect_c0, &_call_f_answerRect_c0);
}
...
{
  return new qt_gsi::GenericMethod ("ignore", "@brief Method void QDragMoveEvent::ignore()\n", false, &_init_f_ignore_0, &_call_f_ignore_0);
}
...
static qt_gsi::GenericMethod *_create_f_ignore_1792 ()
{
  return new qt_gsi::GenericMethod ("ignore", "@brief Method void QDragMoveEvent::ignore(const QRect &r)\n", false, &_init_f_ignore_1792, &_call_f_ignore_1792);
}
...
gsi::Class<QDragMoveEvent> decl_QDragMoveEvent (decl_QDropEvent, "QDragMoveEvent_Native",
  gsi::Methods(_create_f_accept_0 ()) +
  gsi::Methods(_create_f_accept_1792 ()) +
  gsi::Methods(_create_f_answerRect_c0 ()) +
  gsi::Methods(_create_f_ignore_0 ()) +
  gsi::Methods(_create_f_ignore_1792 ()),
...
static void _call_ctor_QDragMoveEvent_Adaptor_13244 (const qt_gsi::GenericStaticMethod *decl, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  tl::Heap heap;
  const qt_gsi::Converter<QEvent::Type>::target_type & arg6 = args ? args.read<const qt_gsi::Converter<QEvent::Type>::target_type & > () : (const qt_gsi::Converter<QEvent::Type>::target_type &)(qt_gsi::CppToQtReadAdaptor<QEvent::Type>(heap, QEvent::DragMove));
  ret.write<QDragMoveEvent_Adaptor *> (new QDragMoveEvent_Adaptor (arg1, qt_gsi::QtToCppAdaptor<QFlags<Qt::DropAction> >(arg2).cref(), arg3, qt_gsi::QtToCppAdaptor<QFlags<Qt::MouseButton> >(arg4).cref(), qt_gsi::QtToCppAdaptor<QFlags<Qt::KeyboardModifier> >(arg5).cref(), qt_gsi::QtToCppAdaptor<QEvent::Type>(arg6).cref()));
}

static qt_gsi::GenericStaticMethod *_create_ctor_QDragMoveEvent_Adaptor_13244 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QDragMoveEvent::QDragMoveEvent(const QPoint &pos, QFlags<Qt::DropAction> actions, const QMimeData *data, QFlags<Qt::MouseButton> buttons, QFlags<Qt::KeyboardModifier> modifiers, QEvent::Type type)\nThis method creates an object of class QDragMoveEvent.", &_init_ctor_QDragMoveEvent_Adaptor_13244, &_call_ctor_QDragMoveEvent_Adaptor_13244);
}
...
gsi::Class<QDragMoveEvent_Adaptor> decl_QDragMoveEvent_Adaptor (decl_QDragMoveEvent, "QDragMoveEvent",
  ...
  gsi::Methods(_create_ctor_QDragMoveEvent_Adaptor_13244 ()),
