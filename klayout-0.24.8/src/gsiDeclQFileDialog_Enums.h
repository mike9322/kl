...
/**
*  @file gsiDeclQFileDialog_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQFileDialog_Enums
#define _HDR_gsiDeclQFileDialog_Enums
...
//  Wrapper class for QFlags<enum QFileDialog::AcceptMode>
class QFileDialog_AcceptMode_Enums : public QFlags<enum QFileDialog::AcceptMode> {
public:
  QFileDialog_AcceptMode_Enums () : m_flags () { }
  QFileDialog_AcceptMode_Enums (enum QFileDialog::AcceptMode v) : m_flags (v) { }
  QFileDialog_AcceptMode_Enums (const QFlags<enum QFileDialog::AcceptMode> &v) : m_flags (v) { }
  QFlags<enum QFileDialog::AcceptMode> flags () const { return m_flags; }
private:
  QFlags<QFileDialog::AcceptMode> m_flags;
};

//  Wrapper class for enum QFileDialog::AcceptMode
class QFileDialog_AcceptMode_Enum : public QFileDialog_AcceptMode_Enums {
public:
  QFileDialog_AcceptMode_Enum () { }
  QFileDialog_AcceptMode_Enum (enum QFileDialog::AcceptMode v) : QFileDialog_AcceptMode_Enums (v) { }
  enum QFileDialog::AcceptMode value () const { return (enum QFileDialog::AcceptMode) flags ().operator int (); }
};

//  Converter for QFlags<enum QFileDialog::AcceptMode>
template <>
struct Converter<QFlags<enum QFileDialog::AcceptMode> >
{
public:
  typedef QFlags<enum QFileDialog::AcceptMode> source_type;
  typedef QFileDialog_AcceptMode_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QFileDialog::AcceptMode
template <>
struct Converter<enum QFileDialog::AcceptMode>
{
public:
  typedef enum QFileDialog::AcceptMode source_type;
  typedef QFileDialog_AcceptMode_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Wrapper class for QFlags<enum QFileDialog::DialogLabel>
class QFileDialog_DialogLabel_Enums : public QFlags<enum QFileDialog::DialogLabel> {
public:
  QFileDialog_DialogLabel_Enums () : m_flags () { }
  QFileDialog_DialogLabel_Enums (enum QFileDialog::DialogLabel v) : m_flags (v) { }
  QFileDialog_DialogLabel_Enums (const QFlags<enum QFileDialog::DialogLabel> &v) : m_flags (v) { }
  QFlags<enum QFileDialog::DialogLabel> flags () const { return m_flags; }
private:
  QFlags<QFileDialog::DialogLabel> m_flags;
};

//  Wrapper class for enum QFileDialog::DialogLabel
class QFileDialog_DialogLabel_Enum : public QFileDialog_DialogLabel_Enums {
public:
  QFileDialog_DialogLabel_Enum () { }
  QFileDialog_DialogLabel_Enum (enum QFileDialog::DialogLabel v) : QFileDialog_DialogLabel_Enums (v) { }
  enum QFileDialog::DialogLabel value () const { return (enum QFileDialog::DialogLabel) flags ().operator int (); }
};

//  Converter for QFlags<enum QFileDialog::DialogLabel>
template <>
struct Converter<QFlags<enum QFileDialog::DialogLabel> >
{
public:
  typedef QFlags<enum QFileDialog::DialogLabel> source_type;
  typedef QFileDialog_DialogLabel_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QFileDialog::DialogLabel
template <>
struct Converter<enum QFileDialog::DialogLabel>
{
public:
  typedef enum QFileDialog::DialogLabel source_type;
  typedef QFileDialog_DialogLabel_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Wrapper class for QFlags<enum QFileDialog::FileMode>
class QFileDialog_FileMode_Enums : public QFlags<enum QFileDialog::FileMode> {
public:
  QFileDialog_FileMode_Enums () : m_flags () { }
  QFileDialog_FileMode_Enums (enum QFileDialog::FileMode v) : m_flags (v) { }
  QFileDialog_FileMode_Enums (const QFlags<enum QFileDialog::FileMode> &v) : m_flags (v) { }
  QFlags<enum QFileDialog::FileMode> flags () const { return m_flags; }
private:
  QFlags<QFileDialog::FileMode> m_flags;
};

//  Wrapper class for enum QFileDialog::FileMode
class QFileDialog_FileMode_Enum : public QFileDialog_FileMode_Enums {
public:
  QFileDialog_FileMode_Enum () { }
  QFileDialog_FileMode_Enum (enum QFileDialog::FileMode v) : QFileDialog_FileMode_Enums (v) { }
  enum QFileDialog::FileMode value () const { return (enum QFileDialog::FileMode) flags ().operator int (); }
};

//  Converter for QFlags<enum QFileDialog::FileMode>
template <>
struct Converter<QFlags<enum QFileDialog::FileMode> >
{
public:
  typedef QFlags<enum QFileDialog::FileMode> source_type;
  typedef QFileDialog_FileMode_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QFileDialog::FileMode
template <>
struct Converter<enum QFileDialog::FileMode>
{
public:
  typedef enum QFileDialog::FileMode source_type;
  typedef QFileDialog_FileMode_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Wrapper class for QFlags<enum QFileDialog::Option>
class QFileDialog_Option_Enums : public QFlags<enum QFileDialog::Option> {
public:
  QFileDialog_Option_Enums () : m_flags () { }
  QFileDialog_Option_Enums (enum QFileDialog::Option v) : m_flags (v) { }
  QFileDialog_Option_Enums (const QFlags<enum QFileDialog::Option> &v) : m_flags (v) { }
  QFlags<enum QFileDialog::Option> flags () const { return m_flags; }
private:
  QFlags<QFileDialog::Option> m_flags;
};

//  Wrapper class for enum QFileDialog::Option
class QFileDialog_Option_Enum : public QFileDialog_Option_Enums {
public:
  QFileDialog_Option_Enum () { }
  QFileDialog_Option_Enum (enum QFileDialog::Option v) : QFileDialog_Option_Enums (v) { }
  enum QFileDialog::Option value () const { return (enum QFileDialog::Option) flags ().operator int (); }
};

//  Converter for QFlags<enum QFileDialog::Option>
template <>
struct Converter<QFlags<enum QFileDialog::Option> >
{
public:
  typedef QFlags<enum QFileDialog::Option> source_type;
  typedef QFileDialog_Option_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QFileDialog::Option
template <>
struct Converter<enum QFileDialog::Option>
{
public:
  typedef enum QFileDialog::Option source_type;
  typedef QFileDialog_Option_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Wrapper class for QFlags<enum QFileDialog::ViewMode>
class QFileDialog_ViewMode_Enums : public QFlags<enum QFileDialog::ViewMode> {
public:
  QFileDialog_ViewMode_Enums () : m_flags () { }
  QFileDialog_ViewMode_Enums (enum QFileDialog::ViewMode v) : m_flags (v) { }
  QFileDialog_ViewMode_Enums (const QFlags<enum QFileDialog::ViewMode> &v) : m_flags (v) { }
  QFlags<enum QFileDialog::ViewMode> flags () const { return m_flags; }
private:
  QFlags<QFileDialog::ViewMode> m_flags;
};

//  Wrapper class for enum QFileDialog::ViewMode
class QFileDialog_ViewMode_Enum : public QFileDialog_ViewMode_Enums {
public:
  QFileDialog_ViewMode_Enum () { }
  QFileDialog_ViewMode_Enum (enum QFileDialog::ViewMode v) : QFileDialog_ViewMode_Enums (v) { }
  enum QFileDialog::ViewMode value () const { return (enum QFileDialog::ViewMode) flags ().operator int (); }
};

//  Converter for QFlags<enum QFileDialog::ViewMode>
template <>
struct Converter<QFlags<enum QFileDialog::ViewMode> >
{
public:
  typedef QFlags<enum QFileDialog::ViewMode> source_type;
  typedef QFileDialog_ViewMode_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QFileDialog::ViewMode
template <>
struct Converter<enum QFileDialog::ViewMode>
{
public:
  typedef enum QFileDialog::ViewMode source_type;
  typedef QFileDialog_ViewMode_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};
