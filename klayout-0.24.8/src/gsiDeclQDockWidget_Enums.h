...
/**
*  @file gsiDeclQDockWidget_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQDockWidget_Enums
#define _HDR_gsiDeclQDockWidget_Enums
...
//  Wrapper class for QFlags<enum QDockWidget::DockWidgetFeature>
class QDockWidget_DockWidgetFeature_Enums : public QFlags<enum QDockWidget::DockWidgetFeature> {
public:
  QDockWidget_DockWidgetFeature_Enums () : m_flags () { }
  QDockWidget_DockWidgetFeature_Enums (enum QDockWidget::DockWidgetFeature v) : m_flags (v) { }
  QDockWidget_DockWidgetFeature_Enums (const QFlags<enum QDockWidget::DockWidgetFeature> &v) : m_flags (v) { }
  QFlags<enum QDockWidget::DockWidgetFeature> flags () const { return m_flags; }
private:
  QFlags<QDockWidget::DockWidgetFeature> m_flags;
};

//  Wrapper class for enum QDockWidget::DockWidgetFeature
class QDockWidget_DockWidgetFeature_Enum : public QDockWidget_DockWidgetFeature_Enums {
public:
  QDockWidget_DockWidgetFeature_Enum () { }
  QDockWidget_DockWidgetFeature_Enum (enum QDockWidget::DockWidgetFeature v) : QDockWidget_DockWidgetFeature_Enums (v) { }
  enum QDockWidget::DockWidgetFeature value () const { return (enum QDockWidget::DockWidgetFeature) flags ().operator int (); }
};

//  Converter for QFlags<enum QDockWidget::DockWidgetFeature>
template <>
struct Converter<QFlags<enum QDockWidget::DockWidgetFeature> >
{
public:
  typedef QFlags<enum QDockWidget::DockWidgetFeature> source_type;
  typedef QDockWidget_DockWidgetFeature_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QDockWidget::DockWidgetFeature
template <>
struct Converter<enum QDockWidget::DockWidgetFeature>
{
public:
  typedef enum QDockWidget::DockWidgetFeature source_type;
  typedef QDockWidget_DockWidgetFeature_Enum target_type;
