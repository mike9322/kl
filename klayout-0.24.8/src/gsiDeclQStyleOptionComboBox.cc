...
#include "gsiDeclQStyleOptionComboBox_Enums.h"
#include <memory>
...
static qt_gsi::GenericStaticMethod *_create_ctor_QStyleOptionComboBox_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QStyleOptionComboBox::QStyleOptionComboBox()\nThis method creates an object of class QStyleOptionComboBox.", &_init_ctor_QStyleOptionComboBox_0, &_call_ctor_QStyleOptionComboBox_0);
}
...
{
  const QStyleOptionComboBox &arg1 = args.read<const QStyleOptionComboBox & > ();
  ret.write<QStyleOptionComboBox *> (new QStyleOptionComboBox (arg1));
}

static qt_gsi::GenericStaticMethod *_create_ctor_QStyleOptionComboBox_3349 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QStyleOptionComboBox::QStyleOptionComboBox(const QStyleOptionComboBox &other)\nThis method creates an object of class QStyleOptionComboBox.", &_init_ctor_QStyleOptionComboBox_3349, &_call_ctor_QStyleOptionComboBox_3349);
}
...
gsi::Class<QStyleOptionComboBox> decl_QStyleOptionComboBox (decl_QStyleOptionComplex, "QStyleOptionComboBox",
  gsi::Methods(_create_ctor_QStyleOptionComboBox_0 ()) +
  gsi::Methods(_create_ctor_QStyleOptionComboBox_3349 ()),
