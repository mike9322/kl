 ...
 */
class KLAYOUT_DLL ImageIterator
{
public:
...
public: 
  ...
  /**
   *  @brief Add an observer for the image list changed event
   *
   *  The image list changed event is sent when an image has been added or removed.
   */
  void add_image_list_changed_observer (tl::Observer &observer)
  {
    m_image_list_changed.add_observer (observer);
  }
  
  /**
   *  @brief Remove an observer from the image list changed event
   */
  void remove_image_list_changed_observer (tl::Observer &observer)
  {
    m_image_list_changed.remove_observer (observer);
  }
  
  /**
   *  @brief Add an observer for the image changed event
   *
   *  The image list changed event is sent when an image has changed
   */
  void add_image_changed_observer (tl::Observer &observer)
  {
    m_image_changed.add_observer (observer);
  }
  
  /**
   *  @brief Remove an observer from the image changed event
   */
  void remove_image_changed_observer (tl::Observer &observer)
  {
    m_image_changed.remove_observer (observer);
  }
...
private:
  ...
  tl::Observed m_image_list_changed;
  tl::Observed m_image_changed;
