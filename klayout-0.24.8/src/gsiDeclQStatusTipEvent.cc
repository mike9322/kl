...
#include "gsiDeclQStatusTipEvent_Enums.h"
#include <memory>
...
static qt_gsi::GenericMethod *_create_f_tip_c0 ()
{
  return new qt_gsi::GenericMethod ("tip", "@brief Method QString QStatusTipEvent::tip()\n", true, &_init_f_tip_c0, &_call_f_tip_c0);
}
...
gsi::Class<QStatusTipEvent> decl_QStatusTipEvent (decl_QEvent, "QStatusTipEvent_Native",
  gsi::Methods(_create_f_tip_c0 ()),
...
static qt_gsi::GenericStaticMethod *_create_ctor_QStatusTipEvent_Adaptor_2025 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QStatusTipEvent::QStatusTipEvent(const QString &tip)\nThis method creates an object of class QStatusTipEvent.", &_init_ctor_QStatusTipEvent_Adaptor_2025, &_call_ctor_QStatusTipEvent_Adaptor_2025);
}

namespace gsi
{

extern gsi::Class<QStatusTipEvent> decl_QStatusTipEvent;

gsi::Class<QStatusTipEvent_Adaptor> decl_QStatusTipEvent_Adaptor (decl_QStatusTipEvent, "QStatusTipEvent",
  gsi::Methods(_create_ctor_QStatusTipEvent_Adaptor_2025 ()),
