...
/**
*  @file generated/gsiDeclQGraphicsScale_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQGraphicsScale_EventAdaptor
#define _HDR_gsiDeclQGraphicsScale_EventAdaptor
...
public:
  QGraphicsScale_EventAdaptor (QObject *host);
