...
#include "gsiDeclQGridLayout_EventAdaptor.h"
#include "gsiDeclQGridLayout_Enums.h"
#include <memory>
...
static void _call_f_addItem_7018 (const qt_gsi::GenericMethod *decl, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ((QGridLayout *)cls)->addItem (arg1, arg2, arg3, arg4, arg5, qt_gsi::QtToCppAdaptor<QFlags<Qt::AlignmentFlag> >(arg6).cref());
}

static qt_gsi::GenericMethod *_create_f_addItem_7018 ()
{
  return new qt_gsi::GenericMethod ("addItem", "@brief Method void QGridLayout::addItem(QLayoutItem *item, int row, int column, int rowSpan, int columnSpan, QFlags<Qt::AlignmentFlag>)\n", false, &_init_f_addItem_7018, &_call_f_addItem_7018);
}
...
static void _call_f_addLayout_5301 (const qt_gsi::GenericMethod *decl, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ((QGridLayout *)cls)->addLayout (arg1, arg2, arg3, qt_gsi::QtToCppAdaptor<QFlags<Qt::AlignmentFlag> >(arg4).cref());
}

static qt_gsi::GenericMethod *_create_f_addLayout_5301 ()
{
  return new qt_gsi::GenericMethod ("addLayout", "@brief Method void QGridLayout::addLayout(QLayout *, int row, int column, QFlags<Qt::AlignmentFlag>)\n", false, &_init_f_addLayout_5301, &_call_f_addLayout_5301);
}
...
static void _call_f_addLayout_6619 (const qt_gsi::GenericMethod *decl, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  tl::Heap heap;
  const qt_gsi::Converter<QFlags<Qt::AlignmentFlag> >::target_type & arg6 = args ? args.read<const qt_gsi::Converter<QFlags<Qt::AlignmentFlag> >::target_type & > () : (const qt_gsi::Converter<QFlags<Qt::AlignmentFlag> >::target_type &)(qt_gsi::CppToQtReadAdaptor<QFlags<Qt::AlignmentFlag> >(heap, 0));
  ((QGridLayout *)cls)->addLayout (arg1, arg2, arg3, arg4, arg5, qt_gsi::QtToCppAdaptor<QFlags<Qt::AlignmentFlag> >(arg6).cref());
}

static qt_gsi::GenericMethod *_create_f_addLayout_6619 ()
{
  return new qt_gsi::GenericMethod ("addLayout", "@brief Method void QGridLayout::addLayout(QLayout *, int row, int column, int rowSpan, int columnSpan, QFlags<Qt::AlignmentFlag>)\n", false, &_init_f_addLayout_6619, &_call_f_addLayout_6619);
}
...
{
  return new qt_gsi::GenericMethod ("addWidget", "@brief Method void QGridLayout::addWidget(QWidget *w)\n", false, &_init_f_addWidget_1315, &_call_f_addWidget_1315);
}
...
static void _call_f_addWidget_5275 (const qt_gsi::GenericMethod *decl, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  tl::Heap heap;
  const qt_gsi::Converter<QFlags<Qt::AlignmentFlag> >::target_type & arg4 = args ? args.read<const qt_gsi::Converter<QFlags<Qt::AlignmentFlag> >::target_type & > () : (const qt_gsi::Converter<QFlags<Qt::AlignmentFlag> >::target_type &)(qt_gsi::CppToQtReadAdaptor<QFlags<Qt::AlignmentFlag> >(heap, 0));
  ((QGridLayout *)cls)->addWidget (arg1, arg2, arg3, qt_gsi::QtToCppAdaptor<QFlags<Qt::AlignmentFlag> >(arg4).cref());
}

static qt_gsi::GenericMethod *_create_f_addWidget_5275 ()
{
  return new qt_gsi::GenericMethod ("addWidget", "@brief Method void QGridLayout::addWidget(QWidget *, int row, int column, QFlags<Qt::AlignmentFlag>)\n", false, &_init_f_addWidget_5275, &_call_f_addWidget_5275);
}
...
static void _call_f_addWidget_6593 (const qt_gsi::GenericMethod *decl, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  tl::Heap heap;
  const qt_gsi::Converter<QFlags<Qt::AlignmentFlag> >::target_type & arg6 = args ? args.read<const qt_gsi::Converter<QFlags<Qt::AlignmentFlag> >::target_type & > () : (const qt_gsi::Converter<QFlags<Qt::AlignmentFlag> >::target_type &)(qt_gsi::CppToQtReadAdaptor<QFlags<Qt::AlignmentFlag> >(heap, 0));
  ((QGridLayout *)cls)->addWidget (arg1, arg2, arg3, arg4, arg5, qt_gsi::QtToCppAdaptor<QFlags<Qt::AlignmentFlag> >(arg6).cref());
}

static qt_gsi::GenericMethod *_create_f_addWidget_6593 ()
{
  return new qt_gsi::GenericMethod ("addWidget", "@brief Method void QGridLayout::addWidget(QWidget *, int row, int column, int rowSpan, int columnSpan, QFlags<Qt::AlignmentFlag>)\n", false, &_init_f_addWidget_6593, &_call_f_addWidget_6593);
}
...
static qt_gsi::GenericMethod *_create_f_cellRect_c1426 ()
{
  return new qt_gsi::GenericMethod ("cellRect", "@brief Method QRect QGridLayout::cellRect(int row, int column)\n", true, &_init_f_cellRect_c1426, &_call_f_cellRect_c1426);
}
...
{
  return new qt_gsi::GenericMethod ("columnCount", "@brief Method int QGridLayout::columnCount()\n", true, &_init_f_columnCount_c0, &_call_f_columnCount_c0);
}
...
{
  return new qt_gsi::GenericMethod ("columnMinimumWidth", "@brief Method int QGridLayout::columnMinimumWidth(int column)\n", true, &_init_f_columnMinimumWidth_c767, &_call_f_columnMinimumWidth_c767);
}
...
static qt_gsi::GenericMethod *_create_f_columnStretch_c767 ()
{
  return new qt_gsi::GenericMethod ("columnStretch", "@brief Method int QGridLayout::columnStretch(int column)\n", true, &_init_f_columnStretch_c767, &_call_f_columnStretch_c767);
}
...
{
  ret.write<qt_gsi::Converter<QFlags<Qt::Orientation> >::target_type > ((qt_gsi::Converter<QFlags<Qt::Orientation> >::target_type)qt_gsi::CppToQtAdaptor<QFlags<Qt::Orientation> >(((QGridLayout *)cls)->expandingDirections ()));
}

static qt_gsi::GenericMethod *_create_f_expandingDirections_c0 ()
{
  return new qt_gsi::GenericMethod ("expandingDirections", "@brief Method QFlags<Qt::Orientation> QGridLayout::expandingDirections()\nThis is a reimplementation of QLayout::expandingDirections", true, &_init_f_expandingDirections_c0, &_call_f_expandingDirections_c0);
}

// void QGridLayout::getItemPosition(int idx, int *row, int *column, int *rowSpan, int *columnSpan)


static void _init_f_getItemPosition_4147 (qt_gsi::GenericMethod *decl)
{
...
static void _call_f_getItemPosition_4147 (const qt_gsi::GenericMethod *decl, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  int arg1 = args.read<int > ();
  int *arg2 = args.read<int * > ();
  int *arg3 = args.read<int * > ();
...
static qt_gsi::GenericMethod *_create_f_getItemPosition_4147 ()
{
  return new qt_gsi::GenericMethod ("getItemPosition", "@brief Method void QGridLayout::getItemPosition(int idx, int *row, int *column, int *rowSpan, int *columnSpan)\n", false, &_init_f_getItemPosition_4147, &_call_f_getItemPosition_4147);
}
...
{
  return new qt_gsi::GenericMethod (":horizontalSpacing", "@brief Method int QGridLayout::horizontalSpacing()\n", true, &_init_f_horizontalSpacing_c0, &_call_f_horizontalSpacing_c0);
}
...
{
  return new qt_gsi::GenericMethod ("itemAt", "@brief Method QLayoutItem *QGridLayout::itemAt(int index)\nThis is a reimplementation of QLayout::itemAt", true, &_init_f_itemAt_c767, &_call_f_itemAt_c767);
}
...
static qt_gsi::GenericMethod *_create_f_itemAtPosition_c1426 ()
{
  return new qt_gsi::GenericMethod ("itemAtPosition", "@brief Method QLayoutItem *QGridLayout::itemAtPosition(int row, int column)\n", true, &_init_f_itemAtPosition_c1426, &_call_f_itemAtPosition_c1426);
}
...
static qt_gsi::GenericMethod *_create_f_originCorner_c0 ()
{
  return new qt_gsi::GenericMethod (":originCorner", "@brief Method Qt::Corner QGridLayout::originCorner()\n", true, &_init_f_originCorner_c0, &_call_f_originCorner_c0);
}
...
{
  return new qt_gsi::GenericMethod ("rowCount", "@brief Method int QGridLayout::rowCount()\n", true, &_init_f_rowCount_c0, &_call_f_rowCount_c0);
}
...
{
  return new qt_gsi::GenericMethod ("rowMinimumHeight", "@brief Method int QGridLayout::rowMinimumHeight(int row)\n", true, &_init_f_rowMinimumHeight_c767, &_call_f_rowMinimumHeight_c767);
}
...
static qt_gsi::GenericMethod *_create_f_rowStretch_c767 ()
{
  return new qt_gsi::GenericMethod ("rowStretch", "@brief Method int QGridLayout::rowStretch(int row)\n", true, &_init_f_rowStretch_c767, &_call_f_rowStretch_c767);
}
...
static qt_gsi::GenericMethod *_create_f_setColumnMinimumWidth_1426 ()
{
  return new qt_gsi::GenericMethod ("setColumnMinimumWidth", "@brief Method void QGridLayout::setColumnMinimumWidth(int column, int minSize)\n", false, &_init_f_setColumnMinimumWidth_1426, &_call_f_setColumnMinimumWidth_1426);
}
...
static qt_gsi::GenericMethod *_create_f_setColumnStretch_1426 ()
{
  return new qt_gsi::GenericMethod ("setColumnStretch", "@brief Method void QGridLayout::setColumnStretch(int column, int stretch)\n", false, &_init_f_setColumnStretch_1426, &_call_f_setColumnStretch_1426);
}
...
static qt_gsi::GenericMethod *_create_f_setDefaultPositioning_2572 ()
{
  return new qt_gsi::GenericMethod ("setDefaultPositioning", "@brief Method void QGridLayout::setDefaultPositioning(int n, Qt::Orientation orient)\n", false, &_init_f_setDefaultPositioning_2572, &_call_f_setDefaultPositioning_2572);
}
...
{
  return new qt_gsi::GenericMethod ("setGeometry|geometry=", "@brief Method void QGridLayout::setGeometry(const QRect &)\nThis is a reimplementation of QLayout::setGeometry", false, &_init_f_setGeometry_1792, &_call_f_setGeometry_1792);
}
...
{
  return new qt_gsi::GenericMethod ("setHorizontalSpacing|horizontalSpacing=", "@brief Method void QGridLayout::setHorizontalSpacing(int spacing)\n", false, &_init_f_setHorizontalSpacing_767, &_call_f_setHorizontalSpacing_767);
}
...
static qt_gsi::GenericMethod *_create_f_setOriginCorner_1366 ()
{
  return new qt_gsi::GenericMethod ("setOriginCorner|originCorner=", "@brief Method void QGridLayout::setOriginCorner(Qt::Corner)\n", false, &_init_f_setOriginCorner_1366, &_call_f_setOriginCorner_1366);
}
...
static qt_gsi::GenericMethod *_create_f_setRowMinimumHeight_1426 ()
{
  return new qt_gsi::GenericMethod ("setRowMinimumHeight", "@brief Method void QGridLayout::setRowMinimumHeight(int row, int minSize)\n", false, &_init_f_setRowMinimumHeight_1426, &_call_f_setRowMinimumHeight_1426);
}
...
static qt_gsi::GenericMethod *_create_f_setRowStretch_1426 ()
{
  return new qt_gsi::GenericMethod ("setRowStretch", "@brief Method void QGridLayout::setRowStretch(int row, int stretch)\n", false, &_init_f_setRowStretch_1426, &_call_f_setRowStretch_1426);
}
...
{
  return new qt_gsi::GenericMethod ("setSpacing|spacing=", "@brief Method void QGridLayout::setSpacing(int spacing)\n", false, &_init_f_setSpacing_767, &_call_f_setSpacing_767);
}
...
{
  return new qt_gsi::GenericMethod ("setVerticalSpacing|verticalSpacing=", "@brief Method void QGridLayout::setVerticalSpacing(int spacing)\n", false, &_init_f_setVerticalSpacing_767, &_call_f_setVerticalSpacing_767);
}
...
{
  return new qt_gsi::GenericMethod (":spacing", "@brief Method int QGridLayout::spacing()\n", true, &_init_f_spacing_c0, &_call_f_spacing_c0);
}
...
{
  return new qt_gsi::GenericMethod ("takeAt", "@brief Method QLayoutItem *QGridLayout::takeAt(int index)\nThis is a reimplementation of QLayout::takeAt", false, &_init_f_takeAt_767, &_call_f_takeAt_767);
}
...
{
  return new qt_gsi::GenericMethod (":verticalSpacing", "@brief Method int QGridLayout::verticalSpacing()\n", true, &_init_f_verticalSpacing_c0, &_call_f_verticalSpacing_c0);
}

// static QString QGridLayout::tr(const char *s, const char *c)
...
static void _call_f_tr_3354 (const qt_gsi::GenericStaticMethod *decl, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ret.write<QString > ((QString)QGridLayout::tr (arg1, arg2));
}

static qt_gsi::GenericStaticMethod *_create_f_tr_3354 ()
{
  return new qt_gsi::GenericStaticMethod ("tr", "@brief Static method QString QGridLayout::tr(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_tr_3354, &_call_f_tr_3354);
}
...
{
  return new qt_gsi::GenericStaticMethod ("tr", "@brief Static method QString QGridLayout::tr(const char *s, const char *c, int n)\nThis method is static and can be called without an instance.", &_init_f_tr_4013, &_call_f_tr_4013);
}

// static QString QGridLayout::trUtf8(const char *s, const char *c)
...
static void _call_f_trUtf8_3354 (const qt_gsi::GenericStaticMethod *decl, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  const char *arg1 = args.read<const char * > ();
  const char *arg2 = args ? args.read<const char * > () : (const char *)(0);
  ret.write<QString > ((QString)QGridLayout::trUtf8 (arg1, arg2));
}

static qt_gsi::GenericStaticMethod *_create_f_trUtf8_3354 ()
{
  return new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QGridLayout::trUtf8(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_3354, &_call_f_trUtf8_3354);
}
...
{
  return new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QGridLayout::trUtf8(const char *s, const char *c, int n)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_4013, &_call_f_trUtf8_4013);
}

static qt_gsi::QObjectConnector<QGridLayout, QGridLayout_EventAdaptor> ea_QGridLayout;

namespace gsi
{
extern gsi::Class<QLayout> decl_QLayout;

gsi::Class<QGridLayout> decl_QGridLayout (ea_QGridLayout, decl_QLayout, "QGridLayout_Native",
  gsi::Methods(_create_smo ()) +
  gsi::Methods(_create_f_addItem_7018 ()) +
  gsi::Methods(_create_f_addLayout_5301 ()) +
  gsi::Methods(_create_f_addLayout_6619 ()) +
  gsi::Methods(_create_f_addWidget_1315 ()) +
  gsi::Methods(_create_f_addWidget_5275 ()) +
  gsi::Methods(_create_f_addWidget_6593 ()) +
  gsi::Methods(_create_f_cellRect_c1426 ()) +
  gsi::Methods(_create_f_columnCount_c0 ()) +
  gsi::Methods(_create_f_columnMinimumWidth_c767 ()) +
  gsi::Methods(_create_f_columnStretch_c767 ()) +
  gsi::Methods(_create_f_count_c0 ()) +
  gsi::Methods(_create_f_expandingDirections_c0 ()) +
  gsi::Methods(_create_f_getItemPosition_4147 ()) +
  ...
  gsi::Methods(_create_f_itemAtPosition_c1426 ()) +
  gsi::Methods(_create_f_maximumSize_c0 ()) +
  gsi::Methods(_create_f_minimumHeightForWidth_c767 ()) +
  gsi::Methods(_create_f_minimumSize_c0 ()) +
  gsi::Methods(_create_f_originCorner_c0 ()) +
  gsi::Methods(_create_f_rowCount_c0 ()) +
  gsi::Methods(_create_f_rowMinimumHeight_c767 ()) +
  gsi::Methods(_create_f_rowStretch_c767 ()) +
  gsi::Methods(_create_f_setColumnMinimumWidth_1426 ()) +
  gsi::Methods(_create_f_setColumnStretch_1426 ()) +
  gsi::Methods(_create_f_setDefaultPositioning_2572 ()) +
  gsi::Methods(_create_f_setGeometry_1792 ()) +
  gsi::Methods(_create_f_setHorizontalSpacing_767 ()) +
  gsi::Methods(_create_f_setOriginCorner_1366 ()) +
  gsi::Methods(_create_f_setRowMinimumHeight_1426 ()) +
  gsi::Methods(_create_f_setRowStretch_1426 ()) +
  ...
  qt_gsi::qt_signal<QGridLayout, QGridLayout_EventAdaptor, QObject *> ("destroyed", &QGridLayout_EventAdaptor::destroyed_e_1302, gsi::arg("arg1"), "@brief Signal declaration for QGridLayout::destroyed(QObject *)\nYou can bind a procedure to this signal.") +
...
public:
  ...
  {
    return qt_gsi::CppToQtAdaptor<QFlags<Qt::Orientation> >(QGridLayout::expandingDirections());
  }

  virtual QFlags<Qt::Orientation> expandingDirections() const
  {
    if (cb_expandingDirections_c0_0.can_issue()) {
      return qt_gsi::QtToCppAdaptor<QFlags<Qt::Orientation> >(cb_expandingDirections_c0_0.issue<QGridLayout_Adaptor, qt_gsi::Converter<QFlags<Qt::Orientation> >::target_type>(&QGridLayout_Adaptor::cbs_expandingDirections_c0_0)).cref();
    } else {
  ...
  //  [adaptor impl] void QGridLayout::disconnectNotify(const char *signal)
  ...
  virtual void disconnectNotify(const char *signal)
  {
    if (cb_disconnectNotify_1731_0.can_issue()) {
      cb_disconnectNotify_1731_0.issue<QGridLayout_Adaptor, const char *>(&QGridLayout_Adaptor::cbs_disconnectNotify_1731_0, signal);
    } else {
      QGridLayout::disconnectNotify(signal);
    }
  }
...
static qt_gsi::GenericStaticMethod *_create_ctor_QGridLayout_Adaptor_1315 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QGridLayout::QGridLayout(QWidget *parent)\nThis method creates an object of class QGridLayout.", &_init_ctor_QGridLayout_Adaptor_1315, &_call_ctor_QGridLayout_Adaptor_1315);
}
...
static qt_gsi::GenericStaticMethod *_create_ctor_QGridLayout_Adaptor_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QGridLayout::QGridLayout()\nThis method creates an object of class QGridLayout.", &_init_ctor_QGridLayout_Adaptor_0, &_call_ctor_QGridLayout_Adaptor_0);
}
...
{
  return new qt_gsi::GenericMethod("*receivers", "@brief Method int QGridLayout::receivers(const char *signal)\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_receivers_c1731, &_call_fp_receivers_c1731);
}
...
{
  return new qt_gsi::GenericMethod("*sender", "@brief Method QObject *QGridLayout::sender()\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_sender_c0, &_call_fp_sender_c0);
}
...
{
  return new qt_gsi::GenericMethod ("event", "@brief Virtual method bool QGridLayout::event(QEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_event_1217_0, &_call_cbs_event_1217_0, &_set_callback_cbs_event_1217_0);
}
...
{
  return new qt_gsi::GenericMethod ("eventFilter", "@brief Virtual method bool QGridLayout::eventFilter(QObject *, QEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_eventFilter_2411_0, &_call_cbs_eventFilter_2411_0, &_set_callback_cbs_eventFilter_2411_0);
}
...
{
  ret.write<qt_gsi::Converter<QFlags<Qt::Orientation> >::target_type > ((qt_gsi::Converter<QFlags<Qt::Orientation> >::target_type)((QGridLayout_Adaptor *)cls)->cbs_expandingDirections_c0_0 ());
}
...
{
  return new qt_gsi::GenericMethod ("heightForWidth", "@brief Virtual method int QGridLayout::heightForWidth(int)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_heightForWidth_c767_0, &_call_cbs_heightForWidth_c767_0, &_set_callback_cbs_heightForWidth_c767_0);
}
...
{
  return new qt_gsi::GenericMethod ("sizeHint", "@brief Virtual method QSize QGridLayout::sizeHint()\nThis method can be reimplemented in a derived class.", true, &_init_cbs_sizeHint_c0_0, &_call_cbs_sizeHint_c0_0, &_set_callback_cbs_sizeHint_c0_0);
}
...
{
  return new qt_gsi::GenericMethod ("*childEvent", "@brief Virtual method void QGridLayout::childEvent(QChildEvent *e)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_childEvent_1701_0, &_call_cbs_childEvent_1701_0, &_set_callback_cbs_childEvent_1701_0);
}
...
{
  return new qt_gsi::GenericMethod ("*customEvent", "@brief Virtual method void QGridLayout::customEvent(QEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_customEvent_1217_0, &_call_cbs_customEvent_1217_0, &_set_callback_cbs_customEvent_1217_0);
}


// void QGridLayout::disconnectNotify(const char *signal)
...
{
  const char *arg1 = args.read<const char * > ();
  ((QGridLayout_Adaptor *)cls)->cbs_disconnectNotify_1731_0 (arg1);
}

static void _set_callback_cbs_disconnectNotify_1731_0 (void *cls, const gsi::Callback &cb)
{
  ((QGridLayout_Adaptor *)cls)->cb_disconnectNotify_1731_0 = cb;
}
...
{
  return new qt_gsi::GenericMethod ("*disconnectNotify", "@brief Virtual method void QGridLayout::disconnectNotify(const char *signal)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_disconnectNotify_1731_0, &_call_cbs_disconnectNotify_1731_0, &_set_callback_cbs_disconnectNotify_1731_0);
}
...
{
  return new qt_gsi::GenericMethod ("*timerEvent", "@brief Virtual method void QGridLayout::timerEvent(QTimerEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_timerEvent_1730_0, &_call_cbs_timerEvent_1730_0, &_set_callback_cbs_timerEvent_1730_0);
}
...
extern gsi::Class<QGridLayout> decl_QGridLayout;

gsi::Class<QGridLayout_Adaptor> decl_QGridLayout_Adaptor (decl_QGridLayout, "QGridLayout",
  ...
  gsi::Methods(_create_ctor_QGridLayout_Adaptor_1315 ()) +
  gsi::Methods(_create_ctor_QGridLayout_Adaptor_0 ()),
