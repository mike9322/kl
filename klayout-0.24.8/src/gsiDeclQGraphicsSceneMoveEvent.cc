...
#include "gsiDeclQGraphicsSceneMoveEvent_Enums.h"
#include <memory>
...
static qt_gsi::GenericMethod *_create_f_newPos_c0 ()
{
  return new qt_gsi::GenericMethod (":newPos", "@brief Method QPointF QGraphicsSceneMoveEvent::newPos()\n", true, &_init_f_newPos_c0, &_call_f_newPos_c0);
}
...
{
  return new qt_gsi::GenericMethod (":oldPos", "@brief Method QPointF QGraphicsSceneMoveEvent::oldPos()\n", true, &_init_f_oldPos_c0, &_call_f_oldPos_c0);
}
...
static qt_gsi::GenericMethod *_create_f_setNewPos_1986 ()
{
  return new qt_gsi::GenericMethod ("setNewPos|newPos=", "@brief Method void QGraphicsSceneMoveEvent::setNewPos(const QPointF &pos)\n", false, &_init_f_setNewPos_1986, &_call_f_setNewPos_1986);
}
...
static qt_gsi::GenericMethod *_create_f_setOldPos_1986 ()
{
  return new qt_gsi::GenericMethod ("setOldPos|oldPos=", "@brief Method void QGraphicsSceneMoveEvent::setOldPos(const QPointF &pos)\n", false, &_init_f_setOldPos_1986, &_call_f_setOldPos_1986);
}
...
gsi::Class<QGraphicsSceneMoveEvent> decl_QGraphicsSceneMoveEvent (decl_QGraphicsSceneEvent, "QGraphicsSceneMoveEvent_Native",
  gsi::Methods(_create_f_newPos_c0 ()) +
  gsi::Methods(_create_f_oldPos_c0 ()) +
  gsi::Methods(_create_f_setNewPos_1986 ()) +
  gsi::Methods(_create_f_setOldPos_1986 ()),
...
static qt_gsi::GenericStaticMethod *_create_ctor_QGraphicsSceneMoveEvent_Adaptor_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QGraphicsSceneMoveEvent::QGraphicsSceneMoveEvent()\nThis method creates an object of class QGraphicsSceneMoveEvent.", &_init_ctor_QGraphicsSceneMoveEvent_Adaptor_0, &_call_ctor_QGraphicsSceneMoveEvent_Adaptor_0);
}

namespace gsi
{

extern gsi::Class<QGraphicsSceneMoveEvent> decl_QGraphicsSceneMoveEvent;

gsi::Class<QGraphicsSceneMoveEvent_Adaptor> decl_QGraphicsSceneMoveEvent_Adaptor (decl_QGraphicsSceneMoveEvent, "QGraphicsSceneMoveEvent",
  gsi::Methods(_create_ctor_QGraphicsSceneMoveEvent_Adaptor_0 ()),
