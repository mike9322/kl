...
/**
*  @file generated/gsiDeclQSortFilterProxyModel_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQSortFilterProxyModel_EventAdaptor
#define _HDR_gsiDeclQSortFilterProxyModel_EventAdaptor
...
public:
  QSortFilterProxyModel_EventAdaptor (QObject *host);
