...
#include "gsiDeclQInputMethodEvent_Attribute_Enums.h"
#include <memory>
...
{
  const qt_gsi::Converter<QInputMethodEvent::AttributeType>::target_type & arg1 = args.read<const qt_gsi::Converter<QInputMethodEvent::AttributeType>::target_type & > ();
  int arg2 = args.read<int > ();
  int arg3 = args.read<int > ();
  QVariant arg4 = args.read<QVariant > ();
...
static qt_gsi::GenericStaticMethod *_create_ctor_QInputMethodEvent_Attribute_6102 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QInputMethodEvent::Attribute::Attribute(QInputMethodEvent::AttributeType t, int s, int l, QVariant val)\nThis method creates an object of class QInputMethodEvent::Attribute.", &_init_ctor_QInputMethodEvent_Attribute_6102, &_call_ctor_QInputMethodEvent_Attribute_6102);
}


namespace gsi
{
gsi::Class<QInputMethodEvent::Attribute> decl_QInputMethodEvent_Attribute ("QInputMethodEvent_Attribute",
  gsi::Methods(_create_ctor_QInputMethodEvent_Attribute_6102 ()),
