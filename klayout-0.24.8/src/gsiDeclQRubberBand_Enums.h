...
/**
*  @file gsiDeclQRubberBand_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQRubberBand_Enums
#define _HDR_gsiDeclQRubberBand_Enums
...
//  Wrapper class for QFlags<enum QRubberBand::Shape>
class QRubberBand_Shape_Enums : public QFlags<enum QRubberBand::Shape> {
public:
  QRubberBand_Shape_Enums () : m_flags () { }
  QRubberBand_Shape_Enums (enum QRubberBand::Shape v) : m_flags (v) { }
  QRubberBand_Shape_Enums (const QFlags<enum QRubberBand::Shape> &v) : m_flags (v) { }
  QFlags<enum QRubberBand::Shape> flags () const { return m_flags; }
private:
  QFlags<QRubberBand::Shape> m_flags;
};

//  Wrapper class for enum QRubberBand::Shape
class QRubberBand_Shape_Enum : public QRubberBand_Shape_Enums {
public:
  QRubberBand_Shape_Enum () { }
  QRubberBand_Shape_Enum (enum QRubberBand::Shape v) : QRubberBand_Shape_Enums (v) { }
  enum QRubberBand::Shape value () const { return (enum QRubberBand::Shape) flags ().operator int (); }
};

//  Converter for QFlags<enum QRubberBand::Shape>
template <>
struct Converter<QFlags<enum QRubberBand::Shape> >
{
public:
  typedef QFlags<enum QRubberBand::Shape> source_type;
  typedef QRubberBand_Shape_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QRubberBand::Shape
template <>
struct Converter<enum QRubberBand::Shape>
{
public:
  typedef enum QRubberBand::Shape source_type;
  typedef QRubberBand_Shape_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};
