...
/**
*  @file generated/gsiDeclQRadioButton_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQRadioButton_EventAdaptor
#define _HDR_gsiDeclQRadioButton_EventAdaptor
...
public:
  QRadioButton_EventAdaptor (QObject *host);
