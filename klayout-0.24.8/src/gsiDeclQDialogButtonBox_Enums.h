...
/**
*  @file gsiDeclQDialogButtonBox_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQDialogButtonBox_Enums
#define _HDR_gsiDeclQDialogButtonBox_Enums
...
//  Wrapper class for QFlags<enum QDialogButtonBox::ButtonRole>
class QDialogButtonBox_ButtonRole_Enums : public QFlags<enum QDialogButtonBox::ButtonRole> {
public:
  QDialogButtonBox_ButtonRole_Enums () : m_flags () { }
  QDialogButtonBox_ButtonRole_Enums (enum QDialogButtonBox::ButtonRole v) : m_flags (v) { }
  QDialogButtonBox_ButtonRole_Enums (const QFlags<enum QDialogButtonBox::ButtonRole> &v) : m_flags (v) { }
  QFlags<enum QDialogButtonBox::ButtonRole> flags () const { return m_flags; }
private:
  QFlags<QDialogButtonBox::ButtonRole> m_flags;
};

//  Wrapper class for enum QDialogButtonBox::ButtonRole
class QDialogButtonBox_ButtonRole_Enum : public QDialogButtonBox_ButtonRole_Enums {
public:
  QDialogButtonBox_ButtonRole_Enum () { }
  QDialogButtonBox_ButtonRole_Enum (enum QDialogButtonBox::ButtonRole v) : QDialogButtonBox_ButtonRole_Enums (v) { }
  enum QDialogButtonBox::ButtonRole value () const { return (enum QDialogButtonBox::ButtonRole) flags ().operator int (); }
};

//  Converter for QFlags<enum QDialogButtonBox::ButtonRole>
template <>
struct Converter<QFlags<enum QDialogButtonBox::ButtonRole> >
{
public:
  typedef QFlags<enum QDialogButtonBox::ButtonRole> source_type;
  typedef QDialogButtonBox_ButtonRole_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QDialogButtonBox::ButtonRole
template <>
struct Converter<enum QDialogButtonBox::ButtonRole>
{
public:
  typedef enum QDialogButtonBox::ButtonRole source_type;
  typedef QDialogButtonBox_ButtonRole_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Wrapper class for QFlags<enum QDialogButtonBox::StandardButton>
class QDialogButtonBox_StandardButton_Enums : public QFlags<enum QDialogButtonBox::StandardButton> {
public:
  QDialogButtonBox_StandardButton_Enums () : m_flags () { }
  QDialogButtonBox_StandardButton_Enums (enum QDialogButtonBox::StandardButton v) : m_flags (v) { }
  QDialogButtonBox_StandardButton_Enums (const QFlags<enum QDialogButtonBox::StandardButton> &v) : m_flags (v) { }
  QFlags<enum QDialogButtonBox::StandardButton> flags () const { return m_flags; }
private:
  QFlags<QDialogButtonBox::StandardButton> m_flags;
};

//  Wrapper class for enum QDialogButtonBox::StandardButton
class QDialogButtonBox_StandardButton_Enum : public QDialogButtonBox_StandardButton_Enums {
public:
  QDialogButtonBox_StandardButton_Enum () { }
  QDialogButtonBox_StandardButton_Enum (enum QDialogButtonBox::StandardButton v) : QDialogButtonBox_StandardButton_Enums (v) { }
  enum QDialogButtonBox::StandardButton value () const { return (enum QDialogButtonBox::StandardButton) flags ().operator int (); }
};

//  Converter for QFlags<enum QDialogButtonBox::StandardButton>
template <>
struct Converter<QFlags<enum QDialogButtonBox::StandardButton> >
{
public:
  typedef QFlags<enum QDialogButtonBox::StandardButton> source_type;
  typedef QDialogButtonBox_StandardButton_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QDialogButtonBox::StandardButton
template <>
struct Converter<enum QDialogButtonBox::StandardButton>
{
public:
  typedef enum QDialogButtonBox::StandardButton source_type;
  typedef QDialogButtonBox_StandardButton_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};
