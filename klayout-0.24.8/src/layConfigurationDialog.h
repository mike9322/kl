...
public:
  ConfigurationDialog (QWidget *parent, lay::MainWindow *lv, lay::PluginDeclaration *decl, const char *name = "", Qt::WFlags fl = 0 );
  ConfigurationDialog (QWidget *parent, lay::MainWindow *lv, const std::string &plugin_name, const char *name = "", Qt::WFlags fl = 0 );
  ~ConfigurationDialog ();
