...
/**
*  @file generated/gsiDeclQAbstractItemView_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQAbstractItemView_EventAdaptor
#define _HDR_gsiDeclQAbstractItemView_EventAdaptor
...
public:
  QAbstractItemView_EventAdaptor (QObject *host);
