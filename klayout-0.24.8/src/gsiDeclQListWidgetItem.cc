...
#include "gsiDeclQListWidgetItem_Enums.h"
#include <memory>
...
{
  return new qt_gsi::GenericMethod (":background", "@brief Method QBrush QListWidgetItem::background()\n", true, &_init_f_background_c0, &_call_f_background_c0);
}
...
{
  return new qt_gsi::GenericMethod (":backgroundColor", "@brief Method QColor QListWidgetItem::backgroundColor()\n", true, &_init_f_backgroundColor_c0, &_call_f_backgroundColor_c0);
}
...
{
  return new qt_gsi::GenericMethod (":checkState", "@brief Method Qt::CheckState QListWidgetItem::checkState()\n", true, &_init_f_checkState_c0, &_call_f_checkState_c0);
}
...
{
  return new qt_gsi::GenericMethod ("clone", "@brief Method QListWidgetItem *QListWidgetItem::clone()\n", true, &_init_f_clone_c0, &_call_f_clone_c0);
}
...
{
  return new qt_gsi::GenericMethod ("data", "@brief Method QVariant QListWidgetItem::data(int role)\n", true, &_init_f_data_c767, &_call_f_data_c767);
}
...
{
  ret.write<qt_gsi::Converter<QFlags<Qt::ItemFlag> >::target_type > ((qt_gsi::Converter<QFlags<Qt::ItemFlag> >::target_type)qt_gsi::CppToQtAdaptor<QFlags<Qt::ItemFlag> >(((QListWidgetItem *)cls)->flags ()));
}

static qt_gsi::GenericMethod *_create_f_flags_c0 ()
{
  return new qt_gsi::GenericMethod (":flags", "@brief Method QFlags<Qt::ItemFlag> QListWidgetItem::flags()\n", true, &_init_f_flags_c0, &_call_f_flags_c0);
}
...
{
  return new qt_gsi::GenericMethod (":font", "@brief Method QFont QListWidgetItem::font()\n", true, &_init_f_font_c0, &_call_f_font_c0);
}
...
{
  return new qt_gsi::GenericMethod (":foreground", "@brief Method QBrush QListWidgetItem::foreground()\n", true, &_init_f_foreground_c0, &_call_f_foreground_c0);
}
...
{
  return new qt_gsi::GenericMethod (":icon", "@brief Method QIcon QListWidgetItem::icon()\n", true, &_init_f_icon_c0, &_call_f_icon_c0);
}
...
{
  return new qt_gsi::GenericMethod ("isHidden?|:hidden", "@brief Method bool QListWidgetItem::isHidden()\n", true, &_init_f_isHidden_c0, &_call_f_isHidden_c0);
}
...
{
  return new qt_gsi::GenericMethod ("isSelected?|:selected", "@brief Method bool QListWidgetItem::isSelected()\n", true, &_init_f_isSelected_c0, &_call_f_isSelected_c0);
}
...
static qt_gsi::GenericMethod *_create_f_listWidget_c0 ()
{
  return new qt_gsi::GenericMethod ("listWidget", "@brief Method QListWidget *QListWidgetItem::listWidget()\n", true, &_init_f_listWidget_c0, &_call_f_listWidget_c0);
}
...
{
  const QListWidgetItem &arg1 = args.read<const QListWidgetItem & > ();
  ret.write<bool > ((bool)((QListWidgetItem *)cls)->operator< (arg1));
}

static qt_gsi::GenericMethod *_create_f_operator_lt__c2817 ()
{
  return new qt_gsi::GenericMethod ("<", "@brief Method bool QListWidgetItem::operator<(const QListWidgetItem &other)\n", true, &_init_f_operator_lt__c2817, &_call_f_operator_lt__c2817);
}
...
static qt_gsi::GenericMethod *_create_f_operator_eq__2817 ()
{
  return new qt_gsi::GenericMethod ("assign", "@brief Method QListWidgetItem &QListWidgetItem::operator=(const QListWidgetItem &other)\n", false, &_init_f_operator_eq__2817, &_call_f_operator_eq__2817);
}
...
{
  return new qt_gsi::GenericMethod ("read", "@brief Method void QListWidgetItem::read(QDataStream &in)\n", false, &_init_f_read_1697, &_call_f_read_1697);
}
...
{
  return new qt_gsi::GenericMethod ("setBackground|background=", "@brief Method void QListWidgetItem::setBackground(const QBrush &brush)\n", false, &_init_f_setBackground_1910, &_call_f_setBackground_1910);
}
...
{
  return new qt_gsi::GenericMethod ("setBackgroundColor|backgroundColor=", "@brief Method void QListWidgetItem::setBackgroundColor(const QColor &color)\n", false, &_init_f_setBackgroundColor_1905, &_call_f_setBackgroundColor_1905);
}
...
{
  return new qt_gsi::GenericMethod ("setCheckState|checkState=", "@brief Method void QListWidgetItem::setCheckState(Qt::CheckState state)\n", false, &_init_f_setCheckState_1740, &_call_f_setCheckState_1740);
}
...
{
  return new qt_gsi::GenericMethod ("setData", "@brief Method void QListWidgetItem::setData(int role, const QVariant &value)\n", false, &_init_f_setData_2778, &_call_f_setData_2778);
}
...
static void _call_f_setFlags_2222 (const qt_gsi::GenericMethod *decl, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  ((QListWidgetItem *)cls)->setFlags (qt_gsi::QtToCppAdaptor<QFlags<Qt::ItemFlag> >(arg1).cref());
}

static qt_gsi::GenericMethod *_create_f_setFlags_2222 ()
{
  return new qt_gsi::GenericMethod ("setFlags|flags=", "@brief Method void QListWidgetItem::setFlags(QFlags<Qt::ItemFlag> flags)\n", false, &_init_f_setFlags_2222, &_call_f_setFlags_2222);
}
...
{
  return new qt_gsi::GenericMethod ("setFont|font=", "@brief Method void QListWidgetItem::setFont(const QFont &font)\n", false, &_init_f_setFont_1801, &_call_f_setFont_1801);
}
...
{
  return new qt_gsi::GenericMethod ("setForeground|foreground=", "@brief Method void QListWidgetItem::setForeground(const QBrush &brush)\n", false, &_init_f_setForeground_1910, &_call_f_setForeground_1910);
}
...
{
  return new qt_gsi::GenericMethod ("setHidden|hidden=", "@brief Method void QListWidgetItem::setHidden(bool hide)\n", false, &_init_f_setHidden_864, &_call_f_setHidden_864);
}
...
{
  return new qt_gsi::GenericMethod ("setIcon|icon=", "@brief Method void QListWidgetItem::setIcon(const QIcon &icon)\n", false, &_init_f_setIcon_1787, &_call_f_setIcon_1787);
}
...
{
  return new qt_gsi::GenericMethod ("setSelected|selected=", "@brief Method void QListWidgetItem::setSelected(bool select)\n", false, &_init_f_setSelected_864, &_call_f_setSelected_864);
}
...
{
  return new qt_gsi::GenericMethod ("setSizeHint|sizeHint=", "@brief Method void QListWidgetItem::setSizeHint(const QSize &size)\n", false, &_init_f_setSizeHint_1805, &_call_f_setSizeHint_1805);
}
...
{
  return new qt_gsi::GenericMethod ("setStatusTip|statusTip=", "@brief Method void QListWidgetItem::setStatusTip(const QString &statusTip)\n", false, &_init_f_setStatusTip_2025, &_call_f_setStatusTip_2025);
}
...
{
  return new qt_gsi::GenericMethod ("setText|text=", "@brief Method void QListWidgetItem::setText(const QString &text)\n", false, &_init_f_setText_2025, &_call_f_setText_2025);
}
...
{
  return new qt_gsi::GenericMethod ("setTextAlignment|textAlignment=", "@brief Method void QListWidgetItem::setTextAlignment(int alignment)\n", false, &_init_f_setTextAlignment_767, &_call_f_setTextAlignment_767);
}
...
{
  return new qt_gsi::GenericMethod ("setTextColor|textColor=", "@brief Method void QListWidgetItem::setTextColor(const QColor &color)\n", false, &_init_f_setTextColor_1905, &_call_f_setTextColor_1905);
}
...
{
  return new qt_gsi::GenericMethod ("setToolTip|toolTip=", "@brief Method void QListWidgetItem::setToolTip(const QString &toolTip)\n", false, &_init_f_setToolTip_2025, &_call_f_setToolTip_2025);
}
...
{
  return new qt_gsi::GenericMethod ("setWhatsThis|whatsThis=", "@brief Method void QListWidgetItem::setWhatsThis(const QString &whatsThis)\n", false, &_init_f_setWhatsThis_2025, &_call_f_setWhatsThis_2025);
}
...
{
  return new qt_gsi::GenericMethod (":sizeHint", "@brief Method QSize QListWidgetItem::sizeHint()\n", true, &_init_f_sizeHint_c0, &_call_f_sizeHint_c0);
}
...
{
  return new qt_gsi::GenericMethod (":statusTip", "@brief Method QString QListWidgetItem::statusTip()\n", true, &_init_f_statusTip_c0, &_call_f_statusTip_c0);
}
...
{
  return new qt_gsi::GenericMethod (":text", "@brief Method QString QListWidgetItem::text()\n", true, &_init_f_text_c0, &_call_f_text_c0);
}
...
{
  return new qt_gsi::GenericMethod (":textAlignment", "@brief Method int QListWidgetItem::textAlignment()\n", true, &_init_f_textAlignment_c0, &_call_f_textAlignment_c0);
}
...
{
  return new qt_gsi::GenericMethod (":textColor", "@brief Method QColor QListWidgetItem::textColor()\n", true, &_init_f_textColor_c0, &_call_f_textColor_c0);
}
...
{
  return new qt_gsi::GenericMethod (":toolTip", "@brief Method QString QListWidgetItem::toolTip()\n", true, &_init_f_toolTip_c0, &_call_f_toolTip_c0);
}
...
{
  return new qt_gsi::GenericMethod ("type", "@brief Method int QListWidgetItem::type()\n", true, &_init_f_type_c0, &_call_f_type_c0);
}
...
{
  return new qt_gsi::GenericMethod (":whatsThis", "@brief Method QString QListWidgetItem::whatsThis()\n", true, &_init_f_whatsThis_c0, &_call_f_whatsThis_c0);
}
...
{
  return new qt_gsi::GenericMethod ("write", "@brief Method void QListWidgetItem::write(QDataStream &out)\n", true, &_init_f_write_c1697, &_call_f_write_c1697);
}
...
gsi::Class<QListWidgetItem> decl_QListWidgetItem ("QListWidgetItem_Native",
  ...
  gsi::Methods(_create_f_listWidget_c0 ()) +
  gsi::Methods(_create_f_operator_lt__c2817 ()) +
  gsi::Methods(_create_f_operator_eq__2817 ()) +
...
{
  QListWidget *arg1 = args ? args.read<QListWidget * > () : (QListWidget *)(0);
  int arg2 = args ? args.read<int > () : (int)(QListWidgetItem::Type);
...
static qt_gsi::GenericStaticMethod *_create_ctor_QListWidgetItem_Adaptor_2386 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QListWidgetItem::QListWidgetItem(QListWidget *view, int type)\nThis method creates an object of class QListWidgetItem.", &_init_ctor_QListWidgetItem_Adaptor_2386, &_call_ctor_QListWidgetItem_Adaptor_2386);
}
...
{
  const QString &arg1 = args.read<const QString & > ();
  QListWidget *arg2 = args ? args.read<QListWidget * > () : (QListWidget *)(0);
  int arg3 = args ? args.read<int > () : (int)(QListWidgetItem::Type);
  ret.write<QListWidgetItem_Adaptor *> (new QListWidgetItem_Adaptor (arg1, arg2, arg3));
}

static qt_gsi::GenericStaticMethod *_create_ctor_QListWidgetItem_Adaptor_4303 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QListWidgetItem::QListWidgetItem(const QString &text, QListWidget *view, int type)\nThis method creates an object of class QListWidgetItem.", &_init_ctor_QListWidgetItem_Adaptor_4303, &_call_ctor_QListWidgetItem_Adaptor_4303);
}
...
static void _call_ctor_QListWidgetItem_Adaptor_5982 (const qt_gsi::GenericStaticMethod *decl, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  QListWidget *arg3 = args ? args.read<QListWidget * > () : (QListWidget *)(0);
  int arg4 = args ? args.read<int > () : (int)(QListWidgetItem::Type);
  ret.write<QListWidgetItem_Adaptor *> (new QListWidgetItem_Adaptor (arg1, arg2, arg3, arg4));
}

static qt_gsi::GenericStaticMethod *_create_ctor_QListWidgetItem_Adaptor_5982 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QListWidgetItem::QListWidgetItem(const QIcon &icon, const QString &text, QListWidget *view, int type)\nThis method creates an object of class QListWidgetItem.", &_init_ctor_QListWidgetItem_Adaptor_5982, &_call_ctor_QListWidgetItem_Adaptor_5982);
}
...
static qt_gsi::GenericStaticMethod *_create_ctor_QListWidgetItem_Adaptor_2817 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QListWidgetItem::QListWidgetItem(const QListWidgetItem &other)\nThis method creates an object of class QListWidgetItem.", &_init_ctor_QListWidgetItem_Adaptor_2817, &_call_ctor_QListWidgetItem_Adaptor_2817);
}
...
static qt_gsi::GenericMethod *_create_cbs_operator_lt__c2817_0 ()
{
  return new qt_gsi::GenericMethod ("<", "@hide", true, &_init_cbs_operator_lt__c2817_0, &_call_cbs_operator_lt__c2817_0);
}

static qt_gsi::GenericMethod *_create_callback_cbs_operator_lt__c2817_0 ()
{
  return new qt_gsi::GenericMethod ("<", "@brief Virtual method bool QListWidgetItem::operator<(const QListWidgetItem &other)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_operator_lt__c2817_0, &_call_cbs_operator_lt__c2817_0, &_set_callback_cbs_operator_lt__c2817_0);
}
...
static qt_gsi::GenericMethod *_create_cbs_setBackgroundColor_1905_0 ()
{
  return new qt_gsi::GenericMethod ("setBackgroundColor", "@hide", false, &_init_cbs_setBackgroundColor_1905_0, &_call_cbs_setBackgroundColor_1905_0);
}

static qt_gsi::GenericMethod *_create_callback_cbs_setBackgroundColor_1905_0 ()
{
  return new qt_gsi::GenericMethod ("setBackgroundColor", "@brief Virtual method void QListWidgetItem::setBackgroundColor(const QColor &color)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_setBackgroundColor_1905_0, &_call_cbs_setBackgroundColor_1905_0, &_set_callback_cbs_setBackgroundColor_1905_0);
}
...
extern gsi::Class<QListWidgetItem> decl_QListWidgetItem;

gsi::Class<QListWidgetItem_Adaptor> decl_QListWidgetItem_Adaptor (decl_QListWidgetItem, "QListWidgetItem",
  ...
  gsi::Methods(_create_cbs_operator_lt__c2817_0 ()) +
  gsi::Methods(_create_callback_cbs_operator_lt__c2817_0 ()) +
  gsi::Methods(_create_cbs_read_1697_0 ()) +
  gsi::Methods(_create_callback_cbs_read_1697_0 ()) +
  gsi::Methods(_create_cbs_setBackgroundColor_1905_0 ()) +
  gsi::Methods(_create_callback_cbs_setBackgroundColor_1905_0 ()) +
  ...
  gsi::Methods(_create_ctor_QListWidgetItem_Adaptor_2386 ()) +
  gsi::Methods(_create_ctor_QListWidgetItem_Adaptor_4303 ()) +
  gsi::Methods(_create_ctor_QListWidgetItem_Adaptor_5982 ()) +
  gsi::Methods(_create_ctor_QListWidgetItem_Adaptor_2817 ()),
