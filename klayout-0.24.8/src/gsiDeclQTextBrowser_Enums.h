...
/**
*  @file gsiDeclQTextBrowser_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQTextBrowser_Enums
#define _HDR_gsiDeclQTextBrowser_Enums
...
//  Wrapper class for QFlags<enum QTextDocument::FindFlag>
class QTextDocument_FindFlag_Enums : public QFlags<enum QTextDocument::FindFlag> {
public:
  QTextDocument_FindFlag_Enums () : m_flags () { }
  QTextDocument_FindFlag_Enums (enum QTextDocument::FindFlag v) : m_flags (v) { }
  QTextDocument_FindFlag_Enums (const QFlags<enum QTextDocument::FindFlag> &v) : m_flags (v) { }
  QFlags<enum QTextDocument::FindFlag> flags () const { return m_flags; }
private:
  QFlags<QTextDocument::FindFlag> m_flags;
};

//  Wrapper class for enum QTextDocument::FindFlag
class QTextDocument_FindFlag_Enum : public QTextDocument_FindFlag_Enums {
public:
  QTextDocument_FindFlag_Enum () { }
  QTextDocument_FindFlag_Enum (enum QTextDocument::FindFlag v) : QTextDocument_FindFlag_Enums (v) { }
  enum QTextDocument::FindFlag value () const { return (enum QTextDocument::FindFlag) flags ().operator int (); }
};

//  Converter for QFlags<enum QTextDocument::FindFlag>
template <>
struct Converter<QFlags<enum QTextDocument::FindFlag> >
{
public:
  typedef QFlags<enum QTextDocument::FindFlag> source_type;
  typedef QTextDocument_FindFlag_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QTextDocument::FindFlag
template <>
struct Converter<enum QTextDocument::FindFlag>
{
public:
  typedef enum QTextDocument::FindFlag source_type;
  typedef QTextDocument_FindFlag_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Wrapper class for QFlags<enum QTextEdit::AutoFormattingFlag>
class QTextEdit_AutoFormattingFlag_Enums : public QFlags<enum QTextEdit::AutoFormattingFlag> {
public:
  QTextEdit_AutoFormattingFlag_Enums () : m_flags () { }
  QTextEdit_AutoFormattingFlag_Enums (enum QTextEdit::AutoFormattingFlag v) : m_flags (v) { }
  QTextEdit_AutoFormattingFlag_Enums (const QFlags<enum QTextEdit::AutoFormattingFlag> &v) : m_flags (v) { }
  QFlags<enum QTextEdit::AutoFormattingFlag> flags () const { return m_flags; }
private:
  QFlags<QTextEdit::AutoFormattingFlag> m_flags;
};

//  Wrapper class for enum QTextEdit::AutoFormattingFlag
class QTextEdit_AutoFormattingFlag_Enum : public QTextEdit_AutoFormattingFlag_Enums {
public:
  QTextEdit_AutoFormattingFlag_Enum () { }
  QTextEdit_AutoFormattingFlag_Enum (enum QTextEdit::AutoFormattingFlag v) : QTextEdit_AutoFormattingFlag_Enums (v) { }
  enum QTextEdit::AutoFormattingFlag value () const { return (enum QTextEdit::AutoFormattingFlag) flags ().operator int (); }
};

//  Converter for QFlags<enum QTextEdit::AutoFormattingFlag>
template <>
struct Converter<QFlags<enum QTextEdit::AutoFormattingFlag> >
{
public:
  typedef QFlags<enum QTextEdit::AutoFormattingFlag> source_type;
  typedef QTextEdit_AutoFormattingFlag_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QTextEdit::AutoFormattingFlag
template <>
struct Converter<enum QTextEdit::AutoFormattingFlag>
{
public:
  typedef enum QTextEdit::AutoFormattingFlag source_type;
  typedef QTextEdit_AutoFormattingFlag_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Wrapper class for QFlags<enum QTextEdit::LineWrapMode>
class QTextEdit_LineWrapMode_Enums : public QFlags<enum QTextEdit::LineWrapMode> {
public:
  QTextEdit_LineWrapMode_Enums () : m_flags () { }
  QTextEdit_LineWrapMode_Enums (enum QTextEdit::LineWrapMode v) : m_flags (v) { }
  QTextEdit_LineWrapMode_Enums (const QFlags<enum QTextEdit::LineWrapMode> &v) : m_flags (v) { }
  QFlags<enum QTextEdit::LineWrapMode> flags () const { return m_flags; }
private:
  QFlags<QTextEdit::LineWrapMode> m_flags;
};

//  Wrapper class for enum QTextEdit::LineWrapMode
class QTextEdit_LineWrapMode_Enum : public QTextEdit_LineWrapMode_Enums {
public:
  QTextEdit_LineWrapMode_Enum () { }
  QTextEdit_LineWrapMode_Enum (enum QTextEdit::LineWrapMode v) : QTextEdit_LineWrapMode_Enums (v) { }
  enum QTextEdit::LineWrapMode value () const { return (enum QTextEdit::LineWrapMode) flags ().operator int (); }
};

//  Converter for QFlags<enum QTextEdit::LineWrapMode>
template <>
struct Converter<QFlags<enum QTextEdit::LineWrapMode> >
{
public:
  typedef QFlags<enum QTextEdit::LineWrapMode> source_type;
  typedef QTextEdit_LineWrapMode_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QTextEdit::LineWrapMode
template <>
struct Converter<enum QTextEdit::LineWrapMode>
{
public:
  typedef enum QTextEdit::LineWrapMode source_type;
  typedef QTextEdit_LineWrapMode_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};
