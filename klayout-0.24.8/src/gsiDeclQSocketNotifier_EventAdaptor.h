...
/**
*  @file generated/gsiDeclQSocketNotifier_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQSocketNotifier_EventAdaptor
#define _HDR_gsiDeclQSocketNotifier_EventAdaptor
...
public:
  QSocketNotifier_EventAdaptor (QObject *host);
