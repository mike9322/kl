...
/**
*  @file gsiDeclQPlainTextEdit_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQPlainTextEdit_Enums
#define _HDR_gsiDeclQPlainTextEdit_Enums
...
//  Wrapper class for QFlags<enum QPlainTextEdit::LineWrapMode>
class QPlainTextEdit_LineWrapMode_Enums : public QFlags<enum QPlainTextEdit::LineWrapMode> {
public:
  QPlainTextEdit_LineWrapMode_Enums () : m_flags () { }
  QPlainTextEdit_LineWrapMode_Enums (enum QPlainTextEdit::LineWrapMode v) : m_flags (v) { }
  QPlainTextEdit_LineWrapMode_Enums (const QFlags<enum QPlainTextEdit::LineWrapMode> &v) : m_flags (v) { }
  QFlags<enum QPlainTextEdit::LineWrapMode> flags () const { return m_flags; }
private:
  QFlags<QPlainTextEdit::LineWrapMode> m_flags;
};

//  Wrapper class for enum QPlainTextEdit::LineWrapMode
class QPlainTextEdit_LineWrapMode_Enum : public QPlainTextEdit_LineWrapMode_Enums {
public:
  QPlainTextEdit_LineWrapMode_Enum () { }
  QPlainTextEdit_LineWrapMode_Enum (enum QPlainTextEdit::LineWrapMode v) : QPlainTextEdit_LineWrapMode_Enums (v) { }
  enum QPlainTextEdit::LineWrapMode value () const { return (enum QPlainTextEdit::LineWrapMode) flags ().operator int (); }
};

//  Converter for QFlags<enum QPlainTextEdit::LineWrapMode>
template <>
struct Converter<QFlags<enum QPlainTextEdit::LineWrapMode> >
{
public:
  typedef QFlags<enum QPlainTextEdit::LineWrapMode> source_type;
  typedef QPlainTextEdit_LineWrapMode_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QPlainTextEdit::LineWrapMode
template <>
struct Converter<enum QPlainTextEdit::LineWrapMode>
{
public:
  typedef enum QPlainTextEdit::LineWrapMode source_type;
  typedef QPlainTextEdit_LineWrapMode_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};
