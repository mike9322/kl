...
/**
*  @file generated/gsiDeclQToolButton_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQToolButton_EventAdaptor
#define _HDR_gsiDeclQToolButton_EventAdaptor
...
public:
  QToolButton_EventAdaptor (QObject *host);
