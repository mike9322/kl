...
#include "gsiDeclQStyleOptionDockWidget_Enums.h"
#include <memory>
...
static qt_gsi::GenericStaticMethod *_create_ctor_QStyleOptionDockWidget_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QStyleOptionDockWidget::QStyleOptionDockWidget()\nThis method creates an object of class QStyleOptionDockWidget.", &_init_ctor_QStyleOptionDockWidget_0, &_call_ctor_QStyleOptionDockWidget_0);
}
...
{
  const QStyleOptionDockWidget &arg1 = args.read<const QStyleOptionDockWidget & > ();
  ret.write<QStyleOptionDockWidget *> (new QStyleOptionDockWidget (arg1));
}

static qt_gsi::GenericStaticMethod *_create_ctor_QStyleOptionDockWidget_3553 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QStyleOptionDockWidget::QStyleOptionDockWidget(const QStyleOptionDockWidget &other)\nThis method creates an object of class QStyleOptionDockWidget.", &_init_ctor_QStyleOptionDockWidget_3553, &_call_ctor_QStyleOptionDockWidget_3553);
}
...
gsi::Class<QStyleOptionDockWidget> decl_QStyleOptionDockWidget (decl_QStyleOption, "QStyleOptionDockWidget",
  gsi::Methods(_create_ctor_QStyleOptionDockWidget_0 ()) +
  gsi::Methods(_create_ctor_QStyleOptionDockWidget_3553 ()),
