...
#include "gsiDeclQWhatsThis_Enums.h"
#include <memory>
...
static qt_gsi::GenericStaticMethod *_create_f_createAction_1302 ()
{
  return new qt_gsi::GenericStaticMethod ("createAction", "@brief Static method QAction *QWhatsThis::createAction(QObject *parent)\nThis method is static and can be called without an instance.", &_init_f_createAction_1302, &_call_f_createAction_1302);
}
...
static qt_gsi::GenericStaticMethod *_create_f_enterWhatsThisMode_0 ()
{
  return new qt_gsi::GenericStaticMethod ("enterWhatsThisMode", "@brief Static method void QWhatsThis::enterWhatsThisMode()\nThis method is static and can be called without an instance.", &_init_f_enterWhatsThisMode_0, &_call_f_enterWhatsThisMode_0);
}
...
static qt_gsi::GenericStaticMethod *_create_f_inWhatsThisMode_0 ()
{
  return new qt_gsi::GenericStaticMethod ("inWhatsThisMode", "@brief Static method bool QWhatsThis::inWhatsThisMode()\nThis method is static and can be called without an instance.", &_init_f_inWhatsThisMode_0, &_call_f_inWhatsThisMode_0);
}
...
static qt_gsi::GenericStaticMethod *_create_f_leaveWhatsThisMode_0 ()
{
  return new qt_gsi::GenericStaticMethod ("leaveWhatsThisMode", "@brief Static method void QWhatsThis::leaveWhatsThisMode()\nThis method is static and can be called without an instance.", &_init_f_leaveWhatsThisMode_0, &_call_f_leaveWhatsThisMode_0);
}
...
{
  return new qt_gsi::GenericStaticMethod ("showText", "@brief Static method void QWhatsThis::showText(const QPoint &pos, const QString &text, QWidget *w)\nThis method is static and can be called without an instance.", &_init_f_showText_5040, &_call_f_showText_5040);
}


namespace gsi
{
gsi::Class<QWhatsThis> decl_QWhatsThis ("QWhatsThis",
  gsi::Methods(_create_f_createAction_1302 ()) +
  gsi::Methods(_create_f_enterWhatsThisMode_0 ()) +
  gsi::Methods(_create_f_hideText_0 ()) +
  gsi::Methods(_create_f_inWhatsThisMode_0 ()) +
  gsi::Methods(_create_f_leaveWhatsThisMode_0 ()) +
