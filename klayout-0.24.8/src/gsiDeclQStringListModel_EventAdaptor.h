...
/**
*  @file generated/gsiDeclQStringListModel_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQStringListModel_EventAdaptor
#define _HDR_gsiDeclQStringListModel_EventAdaptor
...
public:
  QStringListModel_EventAdaptor (QObject *host);
