...
#include "gsiDeclQStyleOptionGroupBox_Enums.h"
#include <memory>
...
static qt_gsi::GenericStaticMethod *_create_ctor_QStyleOptionGroupBox_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QStyleOptionGroupBox::QStyleOptionGroupBox()\nThis method creates an object of class QStyleOptionGroupBox.", &_init_ctor_QStyleOptionGroupBox_0, &_call_ctor_QStyleOptionGroupBox_0);
}
...
{
  const QStyleOptionGroupBox &arg1 = args.read<const QStyleOptionGroupBox & > ();
  ret.write<QStyleOptionGroupBox *> (new QStyleOptionGroupBox (arg1));
}

static qt_gsi::GenericStaticMethod *_create_ctor_QStyleOptionGroupBox_3378 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QStyleOptionGroupBox::QStyleOptionGroupBox(const QStyleOptionGroupBox &other)\nThis method creates an object of class QStyleOptionGroupBox.", &_init_ctor_QStyleOptionGroupBox_3378, &_call_ctor_QStyleOptionGroupBox_3378);
}
...
gsi::Class<QStyleOptionGroupBox> decl_QStyleOptionGroupBox (decl_QStyleOptionComplex, "QStyleOptionGroupBox",
  gsi::Methods(_create_ctor_QStyleOptionGroupBox_0 ()) +
  gsi::Methods(_create_ctor_QStyleOptionGroupBox_3378 ()),
