...
/**
*  @file gsiDeclQToolButton_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQToolButton_Enums
#define _HDR_gsiDeclQToolButton_Enums
...
//  Wrapper class for QFlags<enum QToolButton::ToolButtonPopupMode>
class QToolButton_ToolButtonPopupMode_Enums : public QFlags<enum QToolButton::ToolButtonPopupMode> {
public:
  QToolButton_ToolButtonPopupMode_Enums () : m_flags () { }
  QToolButton_ToolButtonPopupMode_Enums (enum QToolButton::ToolButtonPopupMode v) : m_flags (v) { }
  QToolButton_ToolButtonPopupMode_Enums (const QFlags<enum QToolButton::ToolButtonPopupMode> &v) : m_flags (v) { }
  QFlags<enum QToolButton::ToolButtonPopupMode> flags () const { return m_flags; }
private:
  QFlags<QToolButton::ToolButtonPopupMode> m_flags;
};

//  Wrapper class for enum QToolButton::ToolButtonPopupMode
class QToolButton_ToolButtonPopupMode_Enum : public QToolButton_ToolButtonPopupMode_Enums {
public:
  QToolButton_ToolButtonPopupMode_Enum () { }
  QToolButton_ToolButtonPopupMode_Enum (enum QToolButton::ToolButtonPopupMode v) : QToolButton_ToolButtonPopupMode_Enums (v) { }
  enum QToolButton::ToolButtonPopupMode value () const { return (enum QToolButton::ToolButtonPopupMode) flags ().operator int (); }
};

//  Converter for QFlags<enum QToolButton::ToolButtonPopupMode>
template <>
struct Converter<QFlags<enum QToolButton::ToolButtonPopupMode> >
{
public:
  typedef QFlags<enum QToolButton::ToolButtonPopupMode> source_type;
  typedef QToolButton_ToolButtonPopupMode_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QToolButton::ToolButtonPopupMode
template <>
struct Converter<enum QToolButton::ToolButtonPopupMode>
{
public:
  typedef enum QToolButton::ToolButtonPopupMode source_type;
  typedef QToolButton_ToolButtonPopupMode_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};
