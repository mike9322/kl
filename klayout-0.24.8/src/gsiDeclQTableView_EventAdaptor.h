...
/**
*  @file generated/gsiDeclQTableView_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQTableView_EventAdaptor
#define _HDR_gsiDeclQTableView_EventAdaptor
...
public:
  QTableView_EventAdaptor (QObject *host);
