...
/**
*  @file generated/gsiDeclQListView_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQListView_EventAdaptor
#define _HDR_gsiDeclQListView_EventAdaptor
...
public:
  QListView_EventAdaptor (QObject *host);
