...
#include "gsiDeclQAccessibleInterface_Enums.h"
#include <memory>
...
{
  return new qt_gsi::GenericMethod ("actionText", "@brief Method QString QAccessibleInterface::actionText(int action, QAccessible::Text t, int child)\n", true, &_init_f_actionText_c3378, &_call_f_actionText_c3378);
}
...
static qt_gsi::GenericMethod *_create_f_backgroundColor_0 ()
{
  return new qt_gsi::GenericMethod ("backgroundColor", "@brief Method QColor QAccessibleInterface::backgroundColor()\n", false, &_init_f_backgroundColor_0, &_call_f_backgroundColor_0);
}
...
{
  return new qt_gsi::GenericMethod ("childAt", "@brief Method int QAccessibleInterface::childAt(int x, int y)\n", true, &_init_f_childAt_c1426, &_call_f_childAt_c1426);
}
...
{
  return new qt_gsi::GenericMethod ("childCount", "@brief Method int QAccessibleInterface::childCount()\n", true, &_init_f_childCount_c0, &_call_f_childCount_c0);
}
...
static void _call_f_doAction_4052 (const qt_gsi::GenericMethod *decl, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  int arg2 = args.read<int > ();
  tl::Heap heap;
  const qt_gsi::Converter<QList<QVariant> >::target_type & arg3 = args ? args.read<const qt_gsi::Converter<QList<QVariant> >::target_type & > () : (const qt_gsi::Converter<QList<QVariant> >::target_type &)(qt_gsi::CppToQtReadAdaptor<QList<QVariant> >(heap, QVariantList()));
  ret.write<bool > ((bool)((QAccessibleInterface *)cls)->doAction (arg1, arg2, qt_gsi::QtToCppAdaptor<QList<QVariant> >(arg3).cref()));
}

static qt_gsi::GenericMethod *_create_f_doAction_4052 ()
{
  return new qt_gsi::GenericMethod ("doAction", "@brief Method bool QAccessibleInterface::doAction(int action, int child, const QList<QVariant> &params)\n", false, &_init_f_doAction_4052, &_call_f_doAction_4052);
}
...
static qt_gsi::GenericMethod *_create_f_foregroundColor_0 ()
{
  return new qt_gsi::GenericMethod ("foregroundColor", "@brief Method QColor QAccessibleInterface::foregroundColor()\n", false, &_init_f_foregroundColor_0, &_call_f_foregroundColor_0);
}
...
{
  return new qt_gsi::GenericMethod ("indexOfChild", "@brief Method int QAccessibleInterface::indexOfChild(const QAccessibleInterface *)\n", true, &_init_f_indexOfChild_c3317, &_call_f_indexOfChild_c3317);
}
...
{
  const qt_gsi::Converter<QAccessible::Method>::target_type & arg1 = args.read<const qt_gsi::Converter<QAccessible::Method>::target_type & > ();
  int arg2 = args ? args.read<int > () : (int)(0);
  tl::Heap heap;
  const qt_gsi::Converter<QList<QVariant> >::target_type & arg3 = args ? args.read<const qt_gsi::Converter<QList<QVariant> >::target_type & > () : (const qt_gsi::Converter<QList<QVariant> >::target_type &)(qt_gsi::CppToQtReadAdaptor<QList<QVariant> >(heap, QVariantList()));
  ret.write<QVariant > ((QVariant)((QAccessibleInterface *)cls)->invokeMethod (qt_gsi::QtToCppAdaptor<QAccessible::Method>(arg1).cref(), arg2, qt_gsi::QtToCppAdaptor<QList<QVariant> >(arg3).cref()));
}

static qt_gsi::GenericMethod *_create_f_invokeMethod_5533 ()
{
  return new qt_gsi::GenericMethod ("invokeMethod", "@brief Method QVariant QAccessibleInterface::invokeMethod(QAccessible::Method method, int child, const QList<QVariant> &params)\n", false, &_init_f_invokeMethod_5533, &_call_f_invokeMethod_5533);
}
...
{
  return new qt_gsi::GenericMethod ("isValid?", "@brief Method bool QAccessibleInterface::isValid()\n", true, &_init_f_isValid_c0, &_call_f_isValid_c0);
}
...
{
  return new qt_gsi::GenericMethod ("object", "@brief Method QObject *QAccessibleInterface::object()\n", true, &_init_f_object_c0, &_call_f_object_c0);
}
...
{
  return new qt_gsi::GenericMethod ("rect", "@brief Method QRect QAccessibleInterface::rect(int child)\n", true, &_init_f_rect_c767, &_call_f_rect_c767);
}
...
static void _call_f_relationTo_c4635 (const qt_gsi::GenericMethod *decl, void *cls, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  int arg3 = args.read<int > ();
  ret.write<qt_gsi::Converter<QFlags<QAccessible::RelationFlag> >::target_type > ((qt_gsi::Converter<QFlags<QAccessible::RelationFlag> >::target_type)qt_gsi::CppToQtAdaptor<QFlags<QAccessible::RelationFlag> >(((QAccessibleInterface *)cls)->relationTo (arg1, arg2, arg3)));
}

static qt_gsi::GenericMethod *_create_f_relationTo_c4635 ()
{
  return new qt_gsi::GenericMethod ("relationTo", "@brief Method QFlags<QAccessible::RelationFlag> QAccessibleInterface::relationTo(int child, const QAccessibleInterface *other, int otherChild)\n", true, &_init_f_relationTo_c4635, &_call_f_relationTo_c4635);
}
...
{
  return new qt_gsi::GenericMethod ("role", "@brief Method QAccessible::Role QAccessibleInterface::role(int child)\n", true, &_init_f_role_c767, &_call_f_role_c767);
}
...
{
  return new qt_gsi::GenericMethod ("setText", "@brief Method void QAccessibleInterface::setText(QAccessible::Text t, int child, const QString &text)\n", false, &_init_f_setText_4636, &_call_f_setText_4636);
}
...
{
  int arg1 = args.read<int > ();
  ret.write<qt_gsi::Converter<QFlags<QAccessible::StateFlag> >::target_type > ((qt_gsi::Converter<QFlags<QAccessible::StateFlag> >::target_type)qt_gsi::CppToQtAdaptor<QFlags<QAccessible::StateFlag> >(((QAccessibleInterface *)cls)->state (arg1)));
}

static qt_gsi::GenericMethod *_create_f_state_c767 ()
{
  return new qt_gsi::GenericMethod ("state", "@brief Method QFlags<QAccessible::StateFlag> QAccessibleInterface::state(int child)\n", true, &_init_f_state_c767, &_call_f_state_c767);
}
...
{
  return new qt_gsi::GenericMethod ("text", "@brief Method QString QAccessibleInterface::text(QAccessible::Text t, int child)\n", true, &_init_f_text_c2719, &_call_f_text_c2719);
}
...
{
  return new qt_gsi::GenericMethod ("userActionCount", "@brief Method int QAccessibleInterface::userActionCount(int child)\n", true, &_init_f_userActionCount_c767, &_call_f_userActionCount_c767);
}


namespace gsi
{
extern gsi::Class<QAccessible> decl_QAccessible;

gsi::Class<QAccessibleInterface> decl_QAccessibleInterface (decl_QAccessible, "QAccessibleInterface",
  gsi::Methods(_create_f_actionText_c3378 ()) +
  gsi::Methods(_create_f_backgroundColor_0 ()) +
  gsi::Methods(_create_f_childAt_c1426 ()) +
  gsi::Methods(_create_f_childCount_c0 ()) +
  gsi::Methods(_create_f_doAction_4052 ()) +
  gsi::Methods(_create_f_foregroundColor_0 ()) +
  gsi::Methods(_create_f_indexOfChild_c3317 ()) +
  gsi::Methods(_create_f_invokeMethod_5533 ()) +
