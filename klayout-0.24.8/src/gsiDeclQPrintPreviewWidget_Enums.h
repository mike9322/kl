...
/**
*  @file gsiDeclQPrintPreviewWidget_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQPrintPreviewWidget_Enums
#define _HDR_gsiDeclQPrintPreviewWidget_Enums
...
//  Wrapper class for QFlags<enum QPrintPreviewWidget::ViewMode>
class QPrintPreviewWidget_ViewMode_Enums : public QFlags<enum QPrintPreviewWidget::ViewMode> {
public:
  QPrintPreviewWidget_ViewMode_Enums () : m_flags () { }
  QPrintPreviewWidget_ViewMode_Enums (enum QPrintPreviewWidget::ViewMode v) : m_flags (v) { }
  QPrintPreviewWidget_ViewMode_Enums (const QFlags<enum QPrintPreviewWidget::ViewMode> &v) : m_flags (v) { }
  QFlags<enum QPrintPreviewWidget::ViewMode> flags () const { return m_flags; }
private:
  QFlags<QPrintPreviewWidget::ViewMode> m_flags;
};

//  Wrapper class for enum QPrintPreviewWidget::ViewMode
class QPrintPreviewWidget_ViewMode_Enum : public QPrintPreviewWidget_ViewMode_Enums {
public:
  QPrintPreviewWidget_ViewMode_Enum () { }
  QPrintPreviewWidget_ViewMode_Enum (enum QPrintPreviewWidget::ViewMode v) : QPrintPreviewWidget_ViewMode_Enums (v) { }
  enum QPrintPreviewWidget::ViewMode value () const { return (enum QPrintPreviewWidget::ViewMode) flags ().operator int (); }
};

//  Converter for QFlags<enum QPrintPreviewWidget::ViewMode>
template <>
struct Converter<QFlags<enum QPrintPreviewWidget::ViewMode> >
{
public:
  typedef QFlags<enum QPrintPreviewWidget::ViewMode> source_type;
  typedef QPrintPreviewWidget_ViewMode_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QPrintPreviewWidget::ViewMode
template <>
struct Converter<enum QPrintPreviewWidget::ViewMode>
{
public:
  typedef enum QPrintPreviewWidget::ViewMode source_type;
  typedef QPrintPreviewWidget_ViewMode_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Wrapper class for QFlags<enum QPrintPreviewWidget::ZoomMode>
class QPrintPreviewWidget_ZoomMode_Enums : public QFlags<enum QPrintPreviewWidget::ZoomMode> {
public:
  QPrintPreviewWidget_ZoomMode_Enums () : m_flags () { }
  QPrintPreviewWidget_ZoomMode_Enums (enum QPrintPreviewWidget::ZoomMode v) : m_flags (v) { }
  QPrintPreviewWidget_ZoomMode_Enums (const QFlags<enum QPrintPreviewWidget::ZoomMode> &v) : m_flags (v) { }
  QFlags<enum QPrintPreviewWidget::ZoomMode> flags () const { return m_flags; }
private:
  QFlags<QPrintPreviewWidget::ZoomMode> m_flags;
};

//  Wrapper class for enum QPrintPreviewWidget::ZoomMode
class QPrintPreviewWidget_ZoomMode_Enum : public QPrintPreviewWidget_ZoomMode_Enums {
public:
  QPrintPreviewWidget_ZoomMode_Enum () { }
  QPrintPreviewWidget_ZoomMode_Enum (enum QPrintPreviewWidget::ZoomMode v) : QPrintPreviewWidget_ZoomMode_Enums (v) { }
  enum QPrintPreviewWidget::ZoomMode value () const { return (enum QPrintPreviewWidget::ZoomMode) flags ().operator int (); }
};

//  Converter for QFlags<enum QPrintPreviewWidget::ZoomMode>
template <>
struct Converter<QFlags<enum QPrintPreviewWidget::ZoomMode> >
{
public:
  typedef QFlags<enum QPrintPreviewWidget::ZoomMode> source_type;
  typedef QPrintPreviewWidget_ZoomMode_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QPrintPreviewWidget::ZoomMode
template <>
struct Converter<enum QPrintPreviewWidget::ZoomMode>
{
public:
  typedef enum QPrintPreviewWidget::ZoomMode source_type;
  typedef QPrintPreviewWidget_ZoomMode_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};
