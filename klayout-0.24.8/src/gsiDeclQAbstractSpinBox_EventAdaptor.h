...
/**
*  @file generated/gsiDeclQAbstractSpinBox_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQAbstractSpinBox_EventAdaptor
#define _HDR_gsiDeclQAbstractSpinBox_EventAdaptor
...
public:
  QAbstractSpinBox_EventAdaptor (QObject *host);
