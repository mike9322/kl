...
/**
*  @file generated/gsiDeclQMainWindow_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQMainWindow_EventAdaptor
#define _HDR_gsiDeclQMainWindow_EventAdaptor
...
public:
  QMainWindow_EventAdaptor (QObject *host);
