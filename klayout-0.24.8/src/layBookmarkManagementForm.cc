...
BookmarkManagementForm::BookmarkManagementForm (QWidget *parent, const char *name, const lay::BookmarkList &bookmarks, Qt::WFlags fl)
  : QDialog (parent, fl), Ui::BookmarkManagementForm (),
