...
#include "gsiDeclQAbstractItemDelegate_EventAdaptor.h"
...
{
  return new qt_gsi::GenericMethod ("createEditor", "@brief Method QWidget *QAbstractItemDelegate::createEditor(QWidget *parent, const QStyleOptionViewItem &option, const QModelIndex &index)\n", true, &_init_f_createEditor_c6860, &_call_f_createEditor_c6860);
}
...
static qt_gsi::GenericMethod *_create_f_editorEvent_9073 ()
{
  return new qt_gsi::GenericMethod ("editorEvent", "@brief Method bool QAbstractItemDelegate::editorEvent(QEvent *event, QAbstractItemModel *model, const QStyleOptionViewItem &option, const QModelIndex &index)\n", false, &_init_f_editorEvent_9073, &_call_f_editorEvent_9073);
}
...
{
  QHelpEvent *arg1 = args.read<QHelpEvent * > ();
  QAbstractItemView *arg2 = args.read<QAbstractItemView * > ();
  const QStyleOptionViewItem &arg3 = args.read<const QStyleOptionViewItem & > ();
  const QModelIndex &arg4 = args.read<const QModelIndex & > ();
  ret.write<bool > ((bool)((QAbstractItemDelegate *)cls)->helpEvent (arg1, arg2, arg3, arg4));
}

static qt_gsi::GenericMethod *_create_f_helpEvent_9380 ()
{
  return new qt_gsi::GenericMethod ("helpEvent", "@brief Method bool QAbstractItemDelegate::helpEvent(QHelpEvent *event, QAbstractItemView *view, const QStyleOptionViewItem &option, const QModelIndex &index)\n", false, &_init_f_helpEvent_9380, &_call_f_helpEvent_9380);
}
...
{
  return new qt_gsi::GenericMethod ("paint", "@brief Method void QAbstractItemDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index)\n", true, &_init_f_paint_c6971, &_call_f_paint_c6971);
}
...
{
  return new qt_gsi::GenericMethod ("setEditorData", "@brief Method void QAbstractItemDelegate::setEditorData(QWidget *editor, const QModelIndex &index)\n", true, &_init_f_setEditorData_c3602, &_call_f_setEditorData_c3602);
}
...
{
  return new qt_gsi::GenericMethod ("setModelData", "@brief Method void QAbstractItemDelegate::setModelData(QWidget *editor, QAbstractItemModel *model, const QModelIndex &index)\n", true, &_init_f_setModelData_c5913, &_call_f_setModelData_c5913);
}
...
{
  return new qt_gsi::GenericMethod ("sizeHint", "@brief Method QSize QAbstractItemDelegate::sizeHint(const QStyleOptionViewItem &option, const QModelIndex &index)\n", true, &_init_f_sizeHint_c5653, &_call_f_sizeHint_c5653);
}
...
{
  return new qt_gsi::GenericMethod ("updateEditorGeometry", "@brief Method void QAbstractItemDelegate::updateEditorGeometry(QWidget *editor, const QStyleOptionViewItem &option, const QModelIndex &index)\n", true, &_init_f_updateEditorGeometry_c6860, &_call_f_updateEditorGeometry_c6860);
}
...
static void _call_f_elidedText_7038 (const qt_gsi::GenericStaticMethod *decl, gsi::SerialArgs &args, gsi::SerialArgs &ret) 
{
  ...
  const qt_gsi::Converter<Qt::TextElideMode>::target_type & arg3 = args.read<const qt_gsi::Converter<Qt::TextElideMode>::target_type & > ();
...
static qt_gsi::GenericStaticMethod *_create_f_elidedText_7038 ()
{
  return new qt_gsi::GenericStaticMethod ("elidedText", "@brief Static method QString QAbstractItemDelegate::elidedText(const QFontMetrics &fontMetrics, int width, Qt::TextElideMode mode, const QString &text)\nThis method is static and can be called without an instance.", &_init_f_elidedText_7038, &_call_f_elidedText_7038);
}
...
{
  return new qt_gsi::GenericStaticMethod ("tr", "@brief Static method QString QAbstractItemDelegate::tr(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_tr_3354, &_call_f_tr_3354);
}
...
{
  return new qt_gsi::GenericStaticMethod ("tr", "@brief Static method QString QAbstractItemDelegate::tr(const char *s, const char *c, int n)\nThis method is static and can be called without an instance.", &_init_f_tr_4013, &_call_f_tr_4013);
}
...
{
  return new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QAbstractItemDelegate::trUtf8(const char *s, const char *c)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_3354, &_call_f_trUtf8_3354);
}
...
{
  return new qt_gsi::GenericStaticMethod ("trUtf8", "@brief Static method QString QAbstractItemDelegate::trUtf8(const char *s, const char *c, int n)\nThis method is static and can be called without an instance.", &_init_f_trUtf8_4013, &_call_f_trUtf8_4013);
}

static qt_gsi::QObjectConnector<QAbstractItemDelegate, QAbstractItemDelegate_EventAdaptor> ea_QAbstractItemDelegate;

namespace gsi
{
extern gsi::Class<QObject> decl_QObject;

gsi::Class<QAbstractItemDelegate> decl_QAbstractItemDelegate (ea_QAbstractItemDelegate, decl_QObject, "QAbstractItemDelegate_Native",
  gsi::Methods(_create_smo ()) +
  gsi::Methods(_create_f_createEditor_c6860 ()) +
  gsi::Methods(_create_f_editorEvent_9073 ()) +
  gsi::Methods(_create_f_helpEvent_9380 ()) +
  ...
  qt_gsi::qt_signal<QAbstractItemDelegate, QAbstractItemDelegate_EventAdaptor, QWidget *, const qt_gsi::Converter<QAbstractItemDelegate::EndEditHint>::target_type &> ("closeEditor", &QAbstractItemDelegate_EventAdaptor::closeEditor_e_4926, gsi::arg("editor"), gsi::arg("hint"), "@brief Signal declaration for QAbstractItemDelegate::closeEditor(QWidget *editor, QAbstractItemDelegate::EndEditHint hint)\nYou can bind a procedure to this signal.") +
  qt_gsi::qt_signal<QAbstractItemDelegate, QAbstractItemDelegate_EventAdaptor, QWidget *> ("commitData", &QAbstractItemDelegate_EventAdaptor::commitData_e_1315, gsi::arg("editor"), "@brief Signal declaration for QAbstractItemDelegate::commitData(QWidget *editor)\nYou can bind a procedure to this signal.") +
  qt_gsi::qt_signal<QAbstractItemDelegate, QAbstractItemDelegate_EventAdaptor, QObject *> ("destroyed", &QAbstractItemDelegate_EventAdaptor::destroyed_e_1302, gsi::arg("arg1"), "@brief Signal declaration for QAbstractItemDelegate::destroyed(QObject *)\nYou can bind a procedure to this signal.") +
  qt_gsi::qt_signal<QAbstractItemDelegate, QAbstractItemDelegate_EventAdaptor, const QModelIndex &> ("sizeHintChanged", &QAbstractItemDelegate_EventAdaptor::sizeHintChanged_e_2395, gsi::arg("arg1"), "@brief Signal declaration for QAbstractItemDelegate::sizeHintChanged(const QModelIndex &)\nYou can bind a procedure to this signal.") +
  gsi::Methods(_create_f_elidedText_7038 ()) +
...
public:
  ...
  //  QObject *QAbstractItemDelegate::sender()
...
static qt_gsi::GenericStaticMethod *_create_ctor_QAbstractItemDelegate_Adaptor_1302 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QAbstractItemDelegate::QAbstractItemDelegate(QObject *parent)\nThis method creates an object of class QAbstractItemDelegate.", &_init_ctor_QAbstractItemDelegate_Adaptor_1302, &_call_ctor_QAbstractItemDelegate_Adaptor_1302);
}
...
{
  return new qt_gsi::GenericMethod("*receivers", "@brief Method int QAbstractItemDelegate::receivers(const char *signal)\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_receivers_c1731, &_call_fp_receivers_c1731);
}
...
{
  return new qt_gsi::GenericMethod("*sender", "@brief Method QObject *QAbstractItemDelegate::sender()\nThis method is protected and can only be called from inside a derived class.", true, &_init_fp_sender_c0, &_call_fp_sender_c0);
}
...
{
  return new qt_gsi::GenericMethod ("createEditor", "@brief Virtual method QWidget *QAbstractItemDelegate::createEditor(QWidget *parent, const QStyleOptionViewItem &option, const QModelIndex &index)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_createEditor_c6860_0, &_call_cbs_createEditor_c6860_0, &_set_callback_cbs_createEditor_c6860_0);
}
...
{
  return new qt_gsi::GenericMethod ("editorEvent", "@brief Virtual method bool QAbstractItemDelegate::editorEvent(QEvent *event, QAbstractItemModel *model, const QStyleOptionViewItem &option, const QModelIndex &index)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_editorEvent_9073_0, &_call_cbs_editorEvent_9073_0, &_set_callback_cbs_editorEvent_9073_0);
}
...
{
  return new qt_gsi::GenericMethod ("event", "@brief Virtual method bool QAbstractItemDelegate::event(QEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_event_1217_0, &_call_cbs_event_1217_0, &_set_callback_cbs_event_1217_0);
}
...
{
  return new qt_gsi::GenericMethod ("eventFilter", "@brief Virtual method bool QAbstractItemDelegate::eventFilter(QObject *, QEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_eventFilter_2411_0, &_call_cbs_eventFilter_2411_0, &_set_callback_cbs_eventFilter_2411_0);
}
...
{
  return new qt_gsi::GenericMethod ("paint", "@brief Virtual method void QAbstractItemDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_paint_c6971_0, &_call_cbs_paint_c6971_0, &_set_callback_cbs_paint_c6971_0);
}
...
{
  return new qt_gsi::GenericMethod ("setModelData", "@brief Virtual method void QAbstractItemDelegate::setModelData(QWidget *editor, QAbstractItemModel *model, const QModelIndex &index)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_setModelData_c5913_0, &_call_cbs_setModelData_c5913_0, &_set_callback_cbs_setModelData_c5913_0);
}
...
{
  return new qt_gsi::GenericMethod ("sizeHint", "@brief Virtual method QSize QAbstractItemDelegate::sizeHint(const QStyleOptionViewItem &option, const QModelIndex &index)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_sizeHint_c5653_0, &_call_cbs_sizeHint_c5653_0, &_set_callback_cbs_sizeHint_c5653_0);
}
...
{
  return new qt_gsi::GenericMethod ("updateEditorGeometry", "@brief Virtual method void QAbstractItemDelegate::updateEditorGeometry(QWidget *editor, const QStyleOptionViewItem &option, const QModelIndex &index)\nThis method can be reimplemented in a derived class.", true, &_init_cbs_updateEditorGeometry_c6860_0, &_call_cbs_updateEditorGeometry_c6860_0, &_set_callback_cbs_updateEditorGeometry_c6860_0);
}
...
{
  return new qt_gsi::GenericMethod ("*childEvent", "@brief Virtual method void QAbstractItemDelegate::childEvent(QChildEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_childEvent_1701_0, &_call_cbs_childEvent_1701_0, &_set_callback_cbs_childEvent_1701_0);
}
...
{
  return new qt_gsi::GenericMethod ("*customEvent", "@brief Virtual method void QAbstractItemDelegate::customEvent(QEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_customEvent_1217_0, &_call_cbs_customEvent_1217_0, &_set_callback_cbs_customEvent_1217_0);
}
...
{
  return new qt_gsi::GenericMethod ("*disconnectNotify", "@brief Virtual method void QAbstractItemDelegate::disconnectNotify(const char *signal)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_disconnectNotify_1731_0, &_call_cbs_disconnectNotify_1731_0, &_set_callback_cbs_disconnectNotify_1731_0);
}
...
{
  return new qt_gsi::GenericMethod ("*timerEvent", "@brief Virtual method void QAbstractItemDelegate::timerEvent(QTimerEvent *)\nThis method can be reimplemented in a derived class.", false, &_init_cbs_timerEvent_1730_0, &_call_cbs_timerEvent_1730_0, &_set_callback_cbs_timerEvent_1730_0);
}
...
gsi::Class<QAbstractItemDelegate_Adaptor> decl_QAbstractItemDelegate_Adaptor (decl_QAbstractItemDelegate, "QAbstractItemDelegate",
  ...
  gsi::Methods(_create_ctor_QAbstractItemDelegate_Adaptor_1302 ()),
...
static QAbstractItemDelegate_EndEditHint_Enum *c_1_QAbstractItemDelegate_EndEditHint_Enum () { return new QAbstractItemDelegate_EndEditHint_Enum (QAbstractItemDelegate::NoHint); }
static QAbstractItemDelegate_EndEditHint_Enum *c_2_QAbstractItemDelegate_EndEditHint_Enum () { return new QAbstractItemDelegate_EndEditHint_Enum (QAbstractItemDelegate::EditNextItem); }
static QAbstractItemDelegate_EndEditHint_Enum *c_3_QAbstractItemDelegate_EndEditHint_Enum () { return new QAbstractItemDelegate_EndEditHint_Enum (QAbstractItemDelegate::EditPreviousItem); }
static QAbstractItemDelegate_EndEditHint_Enum *c_4_QAbstractItemDelegate_EndEditHint_Enum () { return new QAbstractItemDelegate_EndEditHint_Enum (QAbstractItemDelegate::SubmitModelCache); }
static QAbstractItemDelegate_EndEditHint_Enum *c_5_QAbstractItemDelegate_EndEditHint_Enum () { return new QAbstractItemDelegate_EndEditHint_Enum (QAbstractItemDelegate::RevertModelCache); }

static gsi::Methods mkdefs_QAbstractItemDelegate_EndEditHint () {
  return
    gsi::constant ("NoHint", &qt_gsi::c_1_QAbstractItemDelegate_EndEditHint_Enum, "@brief Enum constant QAbstractItemDelegate::NoHint") +
    gsi::constant ("EditNextItem", &qt_gsi::c_2_QAbstractItemDelegate_EndEditHint_Enum, "@brief Enum constant QAbstractItemDelegate::EditNextItem") +
    gsi::constant ("EditPreviousItem", &qt_gsi::c_3_QAbstractItemDelegate_EndEditHint_Enum, "@brief Enum constant QAbstractItemDelegate::EditPreviousItem") +
    gsi::constant ("SubmitModelCache", &qt_gsi::c_4_QAbstractItemDelegate_EndEditHint_Enum, "@brief Enum constant QAbstractItemDelegate::SubmitModelCache") +
    gsi::constant ("RevertModelCache", &qt_gsi::c_5_QAbstractItemDelegate_EndEditHint_Enum, "@brief Enum constant QAbstractItemDelegate::RevertModelCache");
}

static std::string to_s_QAbstractItemDelegate_EndEditHint_Enum (const QAbstractItemDelegate_EndEditHint_Enum *e)
{
  if (e->value () == QAbstractItemDelegate::NoHint) { return tl::sprintf ("NoHint (%u)", (unsigned int) e->value ()); }
  if (e->value () == QAbstractItemDelegate::EditNextItem) { return tl::sprintf ("EditNextItem (%u)", (unsigned int) e->value ()); }
  if (e->value () == QAbstractItemDelegate::EditPreviousItem) { return tl::sprintf ("EditPreviousItem (%u)", (unsigned int) e->value ()); }
  if (e->value () == QAbstractItemDelegate::SubmitModelCache) { return tl::sprintf ("SubmitModelCache (%u)", (unsigned int) e->value ()); }
  if (e->value () == QAbstractItemDelegate::RevertModelCache) { return tl::sprintf ("RevertModelCache (%u)", (unsigned int) e->value ()); }
  return std::string ("(not a valid enum evalue)");
}

static unsigned int to_i_QAbstractItemDelegate_EndEditHint_Enum (const QAbstractItemDelegate_EndEditHint_Enum *e)
{
  return (unsigned int) e->value ();
}

static QAbstractItemDelegate_EndEditHint_Enum *from_i_QAbstractItemDelegate_EndEditHint_Enum (unsigned int i)
{
  return new QAbstractItemDelegate_EndEditHint_Enum ((QAbstractItemDelegate::EndEditHint) i);
}

static bool equalQAbstractItemDelegate_EndEditHint_Enum (const QAbstractItemDelegate_EndEditHint_Enum *e, QAbstractItemDelegate_EndEditHint_Enum d)
{
  return e->value () == d.value ();
}

static bool equal2QAbstractItemDelegate_EndEditHint_Enum (const QAbstractItemDelegate_EndEditHint_Enum *e, unsigned int i)
{
  return (unsigned int) e->value () == i;
}

static QAbstractItemDelegate_EndEditHint_Enums oropQAbstractItemDelegate_EndEditHint_Enums (const QAbstractItemDelegate_EndEditHint_Enums *e, const QAbstractItemDelegate_EndEditHint_Enums &d)
{
  return e->flags () | d.flags ();
}

static QAbstractItemDelegate_EndEditHint_Enums andopQAbstractItemDelegate_EndEditHint_Enums (const QAbstractItemDelegate_EndEditHint_Enums *e, const QAbstractItemDelegate_EndEditHint_Enums &d)
{
  return e->flags () & d.flags ();
}

static QAbstractItemDelegate_EndEditHint_Enums xoropQAbstractItemDelegate_EndEditHint_Enums (const QAbstractItemDelegate_EndEditHint_Enums *e, const QAbstractItemDelegate_EndEditHint_Enums &d)
{
  return e->flags () ^ d.flags ();
}

static std::string to_s_QAbstractItemDelegate_EndEditHint_Enums (const QAbstractItemDelegate_EndEditHint_Enums *e)
{
  std::string l;
  if (e->testFlag (QAbstractItemDelegate::NoHint)) { if (!l.empty ()) l += "|"; l += "NoHint"; }
  if (e->testFlag (QAbstractItemDelegate::EditNextItem)) { if (!l.empty ()) l += "|"; l += "EditNextItem"; }
  if (e->testFlag (QAbstractItemDelegate::EditPreviousItem)) { if (!l.empty ()) l += "|"; l += "EditPreviousItem"; }
  if (e->testFlag (QAbstractItemDelegate::SubmitModelCache)) { if (!l.empty ()) l += "|"; l += "SubmitModelCache"; }
  if (e->testFlag (QAbstractItemDelegate::RevertModelCache)) { if (!l.empty ()) l += "|"; l += "RevertModelCache"; }
  return tl::sprintf ("%u (%s)", (unsigned int) (e->flags ()), l);
}

static int to_i_QAbstractItemDelegate_EndEditHint_Enums (const QAbstractItemDelegate_EndEditHint_Enums *e)
{
  return int (e->flags ());
}

static bool testFlag_QAbstractItemDelegate_EndEditHint_Enums (const QAbstractItemDelegate_EndEditHint_Enums *e, const QAbstractItemDelegate_EndEditHint_Enum &d)
{
...
gsi::Class<qt_gsi::QAbstractItemDelegate_EndEditHint_Enums> decl_QAbstractItemDelegate_EndEditHint_Enums ("QAbstractItemDelegate_QFlags_EndEditHint",
  gsi::method_ext ("|", &qt_gsi::oropQAbstractItemDelegate_EndEditHint_Enums, gsi::arg ("other"), "@brief 'or' operator between two flag sets") +
  gsi::method_ext ("&", &qt_gsi::andopQAbstractItemDelegate_EndEditHint_Enums, gsi::arg ("other"), "@brief 'and' operator between two flag sets") +
  gsi::method_ext ("^", &qt_gsi::xoropQAbstractItemDelegate_EndEditHint_Enums, gsi::arg ("other"), "@brief 'xor' operator between two flag sets") +
  gsi::method_ext ("to_s|inspect", &qt_gsi::to_s_QAbstractItemDelegate_EndEditHint_Enums, "@brief Converts the flag set to a string") +
  gsi::method_ext ("to_i", &qt_gsi::to_i_QAbstractItemDelegate_EndEditHint_Enums, "@brief Returns the integer value encoding the flag set") +
  gsi::method_ext ("testFlag", &qt_gsi::testFlag_QAbstractItemDelegate_EndEditHint_Enums, gsi::arg ("flag"), "@brief Tests whether the flag is contained in the flag set"),
  "@qt\n@brief This class represents the QFlags<QAbstractItemDelegate::EndEditHint> flag set");

//  Declarations for enum wrapper class
gsi::Class<qt_gsi::QAbstractItemDelegate_EndEditHint_Enum> decl_QAbstractItemDelegate_EndEditHint_Enum (decl_QAbstractItemDelegate_EndEditHint_Enums, "QAbstractItemDelegate_EndEditHint",
  qt_gsi::mkdefs_QAbstractItemDelegate_EndEditHint () +
  gsi::method_ext ("to_s|inspect", &qt_gsi::to_s_QAbstractItemDelegate_EndEditHint_Enum, "@brief Converts the enum class to a string") +
  gsi::method_ext ("to_i", &qt_gsi::to_i_QAbstractItemDelegate_EndEditHint_Enum, "@brief Converts the enum class to an integer") +
  gsi::method_ext ("==", &qt_gsi::equalQAbstractItemDelegate_EndEditHint_Enum, gsi::arg ("other"), "@brief Compares the enum class against an enum of it's own type") +
  gsi::method_ext ("==", &qt_gsi::equal2QAbstractItemDelegate_EndEditHint_Enum, gsi::arg ("other"), "@brief Compares the enum class against an integer") +
  gsi::constructor ("new", &qt_gsi::from_i_QAbstractItemDelegate_EndEditHint_Enum, gsi::arg ("value"), "@brief Creates the enum object from an integer"),
  "@qt\n@brief This class represents the QAbstractItemDelegate::EndEditHint enum");

//  Inject the declarations into the parent
static gsi::ClassExt<QAbstractItemDelegate> inject_QAbstractItemDelegate_EndEditHint_Enum_in_parent (qt_gsi::mkdefs_QAbstractItemDelegate_EndEditHint ());
