...
/**
*  @file gsiDeclQGraphicsSceneDragDropEvent_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQGraphicsSceneDragDropEvent_Enums
#define _HDR_gsiDeclQGraphicsSceneDragDropEvent_Enums
