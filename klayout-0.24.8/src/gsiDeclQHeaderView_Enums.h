...
/**
*  @file gsiDeclQHeaderView_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQHeaderView_Enums
#define _HDR_gsiDeclQHeaderView_Enums
...
//  Wrapper class for QFlags<enum QHeaderView::ResizeMode>
class QHeaderView_ResizeMode_Enums : public QFlags<enum QHeaderView::ResizeMode> {
public:
  QHeaderView_ResizeMode_Enums () : m_flags () { }
  QHeaderView_ResizeMode_Enums (enum QHeaderView::ResizeMode v) : m_flags (v) { }
  QHeaderView_ResizeMode_Enums (const QFlags<enum QHeaderView::ResizeMode> &v) : m_flags (v) { }
  QFlags<enum QHeaderView::ResizeMode> flags () const { return m_flags; }
private:
  QFlags<QHeaderView::ResizeMode> m_flags;
};

//  Wrapper class for enum QHeaderView::ResizeMode
class QHeaderView_ResizeMode_Enum : public QHeaderView_ResizeMode_Enums {
public:
  QHeaderView_ResizeMode_Enum () { }
  QHeaderView_ResizeMode_Enum (enum QHeaderView::ResizeMode v) : QHeaderView_ResizeMode_Enums (v) { }
  enum QHeaderView::ResizeMode value () const { return (enum QHeaderView::ResizeMode) flags ().operator int (); }
};

//  Converter for QFlags<enum QHeaderView::ResizeMode>
template <>
struct Converter<QFlags<enum QHeaderView::ResizeMode> >
{
public:
  typedef QFlags<enum QHeaderView::ResizeMode> source_type;
  typedef QHeaderView_ResizeMode_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QHeaderView::ResizeMode
template <>
struct Converter<enum QHeaderView::ResizeMode>
{
public:
  typedef enum QHeaderView::ResizeMode source_type;
  typedef QHeaderView_ResizeMode_Enum target_type;
  static source_type toq (const target_type &c) { return c.value (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};
