...
/**
*  @file gsiDeclQHBoxLayout_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQHBoxLayout_Enums
#define _HDR_gsiDeclQHBoxLayout_Enums
...
//  Wrapper class for QFlags<enum QBoxLayout::Direction>
class QBoxLayout_Direction_Enums : public QFlags<enum QBoxLayout::Direction> {
public:
  QBoxLayout_Direction_Enums () : m_flags () { }
  QBoxLayout_Direction_Enums (enum QBoxLayout::Direction v) : m_flags (v) { }
  QBoxLayout_Direction_Enums (const QFlags<enum QBoxLayout::Direction> &v) : m_flags (v) { }
  QFlags<enum QBoxLayout::Direction> flags () const { return m_flags; }
private:
  QFlags<QBoxLayout::Direction> m_flags;
};

//  Wrapper class for enum QBoxLayout::Direction
class QBoxLayout_Direction_Enum : public QBoxLayout_Direction_Enums {
public:
  QBoxLayout_Direction_Enum () { }
  QBoxLayout_Direction_Enum (enum QBoxLayout::Direction v) : QBoxLayout_Direction_Enums (v) { }
  enum QBoxLayout::Direction value () const { return (enum QBoxLayout::Direction) flags ().operator int (); }
};

//  Converter for QFlags<enum QBoxLayout::Direction>
template <>
struct Converter<QFlags<enum QBoxLayout::Direction> >
{
public:
  typedef QFlags<enum QBoxLayout::Direction> source_type;
  typedef QBoxLayout_Direction_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QBoxLayout::Direction
template <>
struct Converter<enum QBoxLayout::Direction>
{
public:
  typedef enum QBoxLayout::Direction source_type;
  typedef QBoxLayout_Direction_Enum target_type;
