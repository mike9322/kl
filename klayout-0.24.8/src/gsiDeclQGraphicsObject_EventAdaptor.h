...
/**
*  @file generated/gsiDeclQGraphicsObject_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQGraphicsObject_EventAdaptor
#define _HDR_gsiDeclQGraphicsObject_EventAdaptor
...
public:
  QGraphicsObject_EventAdaptor (QObject *host);
