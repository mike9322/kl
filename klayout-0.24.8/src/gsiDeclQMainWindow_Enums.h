...
/**
*  @file gsiDeclQMainWindow_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQMainWindow_Enums
#define _HDR_gsiDeclQMainWindow_Enums
...
//  Wrapper class for QFlags<enum QMainWindow::DockOption>
class QMainWindow_DockOption_Enums : public QFlags<enum QMainWindow::DockOption> {
public:
  QMainWindow_DockOption_Enums () : m_flags () { }
  QMainWindow_DockOption_Enums (enum QMainWindow::DockOption v) : m_flags (v) { }
  QMainWindow_DockOption_Enums (const QFlags<enum QMainWindow::DockOption> &v) : m_flags (v) { }
  QFlags<enum QMainWindow::DockOption> flags () const { return m_flags; }
private:
  QFlags<QMainWindow::DockOption> m_flags;
};

//  Wrapper class for enum QMainWindow::DockOption
class QMainWindow_DockOption_Enum : public QMainWindow_DockOption_Enums {
public:
  QMainWindow_DockOption_Enum () { }
  QMainWindow_DockOption_Enum (enum QMainWindow::DockOption v) : QMainWindow_DockOption_Enums (v) { }
  enum QMainWindow::DockOption value () const { return (enum QMainWindow::DockOption) flags ().operator int (); }
};

//  Converter for QFlags<enum QMainWindow::DockOption>
template <>
struct Converter<QFlags<enum QMainWindow::DockOption> >
{
public:
  typedef QFlags<enum QMainWindow::DockOption> source_type;
  typedef QMainWindow_DockOption_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QMainWindow::DockOption
template <>
struct Converter<enum QMainWindow::DockOption>
{
public:
  typedef enum QMainWindow::DockOption source_type;
  typedef QMainWindow_DockOption_Enum target_type;
