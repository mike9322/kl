...
void 
MarkerBrowserConfigPage::setup (lay::Plugin *root)
{
  //  context mode
...
void 
MarkerBrowserConfigPage::commit (lay::Plugin *root)
{
  double dim = 1.0;
...
void 
MarkerBrowserConfigPage2::setup (lay::Plugin *root)
{
  //  marker color
  QColor color;
...
void 
MarkerBrowserConfigPage2::commit (lay::Plugin *root)
{
...
public:
  ...
  {
    return new rdb::MarkerBrowserDialog (main_window, view);
  }
};
