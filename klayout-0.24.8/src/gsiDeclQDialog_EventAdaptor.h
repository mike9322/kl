...
/**
*  @file generated/gsiDeclQDialog_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQDialog_EventAdaptor
#define _HDR_gsiDeclQDialog_EventAdaptor
...
public:
  QDialog_EventAdaptor (QObject *host);
