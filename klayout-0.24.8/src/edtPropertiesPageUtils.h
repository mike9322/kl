...
{
public:
  TextPositionChangeApplicator (const db::Point &disp, const db::Point &org_disp);

  bool supports_relative_mode () const { return true; }
  db::Shape do_apply (db::Shapes &shapes, const db::Shape &shape, double dbu, bool relative) const;

private:
  db::Point m_disp, m_org_disp;
};
...
{
public:
  ChangeInstanceTransApplicator (double a, double org_a, bool mirror, bool org_mirror, double m, double org_m, const db::DPoint &disp, const db::DPoint &org_disp);
...
{
public:
  ChangeInstanceArrayApplicator (const db::DPoint &a, bool set_a, const db::DPoint &b, bool set_b, unsigned long na, bool set_na, unsigned long nb, bool set_nb);
 ...
 */
db::DPoint dpoint_from_dpoint (const db::DPoint &dp, double dbu, bool du, const db::CplxTrans &t);
 ...
 */
db::Point point_from_dpoint (const db::DPoint &dp, double dbu, bool du, const db::CplxTrans &t);
 ...
 */
db::Coord coord_from_string (const char *txt, double dbu, bool du, const db::CplxTrans &t);
