...
/**
*  @file generated/gsiDeclQDirModel_EventAdaptor.h
...
#ifndef _HDR_gsiDeclQDirModel_EventAdaptor
#define _HDR_gsiDeclQDirModel_EventAdaptor
...
public:
  QDirModel_EventAdaptor (QObject *host);
