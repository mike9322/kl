...
/**
*  @file gsiDeclQMdiSubWindow_Enums.h 
*
*  DO NOT EDIT THIS FILE. 
*  This file has been created automatically
*/

#ifndef _HDR_gsiDeclQMdiSubWindow_Enums
#define _HDR_gsiDeclQMdiSubWindow_Enums
...
//  Wrapper class for QFlags<enum QMdiSubWindow::SubWindowOption>
class QMdiSubWindow_SubWindowOption_Enums : public QFlags<enum QMdiSubWindow::SubWindowOption> {
public:
  QMdiSubWindow_SubWindowOption_Enums () : m_flags () { }
  QMdiSubWindow_SubWindowOption_Enums (enum QMdiSubWindow::SubWindowOption v) : m_flags (v) { }
  QMdiSubWindow_SubWindowOption_Enums (const QFlags<enum QMdiSubWindow::SubWindowOption> &v) : m_flags (v) { }
  QFlags<enum QMdiSubWindow::SubWindowOption> flags () const { return m_flags; }
private:
  QFlags<QMdiSubWindow::SubWindowOption> m_flags;
};

//  Wrapper class for enum QMdiSubWindow::SubWindowOption
class QMdiSubWindow_SubWindowOption_Enum : public QMdiSubWindow_SubWindowOption_Enums {
public:
  QMdiSubWindow_SubWindowOption_Enum () { }
  QMdiSubWindow_SubWindowOption_Enum (enum QMdiSubWindow::SubWindowOption v) : QMdiSubWindow_SubWindowOption_Enums (v) { }
  enum QMdiSubWindow::SubWindowOption value () const { return (enum QMdiSubWindow::SubWindowOption) flags ().operator int (); }
};

//  Converter for QFlags<enum QMdiSubWindow::SubWindowOption>
template <>
struct Converter<QFlags<enum QMdiSubWindow::SubWindowOption> >
{
public:
  typedef QFlags<enum QMdiSubWindow::SubWindowOption> source_type;
  typedef QMdiSubWindow_SubWindowOption_Enums target_type;
  static source_type toq (const target_type &c) { return c.flags (); }
  static target_type toc (const source_type &qc) { return target_type (qc); }
};

//  Converter for enum QMdiSubWindow::SubWindowOption
template <>
struct Converter<enum QMdiSubWindow::SubWindowOption>
{
public:
  typedef enum QMdiSubWindow::SubWindowOption source_type;
  typedef QMdiSubWindow_SubWindowOption_Enum target_type;
