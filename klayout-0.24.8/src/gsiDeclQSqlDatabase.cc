...
#include "gsiDeclQSqlDatabase_Enums.h"
#include <memory>
...
static qt_gsi::GenericStaticMethod *_create_ctor_QSqlDatabase_0 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QSqlDatabase::QSqlDatabase()\nThis method creates an object of class QSqlDatabase.", &_init_ctor_QSqlDatabase_0, &_call_ctor_QSqlDatabase_0);
}
...
{
  const QSqlDatabase &arg1 = args.read<const QSqlDatabase & > ();
  ret.write<QSqlDatabase *> (new QSqlDatabase (arg1));
}

static qt_gsi::GenericStaticMethod *_create_ctor_QSqlDatabase_2487 ()
{
  return new qt_gsi::GenericStaticMethod ("new", "@brief Constructor QSqlDatabase::QSqlDatabase(const QSqlDatabase &other)\nThis method creates an object of class QSqlDatabase.", &_init_ctor_QSqlDatabase_2487, &_call_ctor_QSqlDatabase_2487);
}
...
{
  return new qt_gsi::GenericMethod ("close", "@brief Method void QSqlDatabase::close()\n", false, &_init_f_close_0, &_call_f_close_0);
}
...
static qt_gsi::GenericMethod *_create_f_commit_0 ()
{
  return new qt_gsi::GenericMethod ("commit", "@brief Method bool QSqlDatabase::commit()\n", false, &_init_f_commit_0, &_call_f_commit_0);
}
...
static qt_gsi::GenericMethod *_create_f_connectOptions_c0 ()
{
  return new qt_gsi::GenericMethod (":connectOptions", "@brief Method QString QSqlDatabase::connectOptions()\n", true, &_init_f_connectOptions_c0, &_call_f_connectOptions_c0);
}
...
static qt_gsi::GenericMethod *_create_f_connectionName_c0 ()
{
  return new qt_gsi::GenericMethod ("connectionName", "@brief Method QString QSqlDatabase::connectionName()\n", true, &_init_f_connectionName_c0, &_call_f_connectionName_c0);
}
...
static qt_gsi::GenericMethod *_create_f_databaseName_c0 ()
{
  return new qt_gsi::GenericMethod (":databaseName", "@brief Method QString QSqlDatabase::databaseName()\n", true, &_init_f_databaseName_c0, &_call_f_databaseName_c0);
}
...
{
  return new qt_gsi::GenericMethod ("driver", "@brief Method QSqlDriver *QSqlDatabase::driver()\n", true, &_init_f_driver_c0, &_call_f_driver_c0);
}
...
static qt_gsi::GenericMethod *_create_f_driverName_c0 ()
{
  return new qt_gsi::GenericMethod ("driverName", "@brief Method QString QSqlDatabase::driverName()\n", true, &_init_f_driverName_c0, &_call_f_driverName_c0);
}
...
static qt_gsi::GenericMethod *_create_f_exec_c2025 ()
{
  return new qt_gsi::GenericMethod ("exec", "@brief Method QSqlQuery QSqlDatabase::exec(const QString &query)\n", true, &_init_f_exec_c2025, &_call_f_exec_c2025);
}
...
{
  return new qt_gsi::GenericMethod (":hostName", "@brief Method QString QSqlDatabase::hostName()\n", true, &_init_f_hostName_c0, &_call_f_hostName_c0);
}
...
{
  return new qt_gsi::GenericMethod ("isOpen?", "@brief Method bool QSqlDatabase::isOpen()\n", true, &_init_f_isOpen_c0, &_call_f_isOpen_c0);
}
...
{
  return new qt_gsi::GenericMethod ("isOpenError?", "@brief Method bool QSqlDatabase::isOpenError()\n", true, &_init_f_isOpenError_c0, &_call_f_isOpenError_c0);
}
...
{
  return new qt_gsi::GenericMethod ("isValid?", "@brief Method bool QSqlDatabase::isValid()\n", true, &_init_f_isValid_c0, &_call_f_isValid_c0);
}
...
{
  return new qt_gsi::GenericMethod ("lastError", "@brief Method QSqlError QSqlDatabase::lastError()\n", true, &_init_f_lastError_c0, &_call_f_lastError_c0);
}
...
{
  return new qt_gsi::GenericMethod (":numericalPrecisionPolicy", "@brief Method QSql::NumericalPrecisionPolicy QSqlDatabase::numericalPrecisionPolicy()\n", true, &_init_f_numericalPrecisionPolicy_c0, &_call_f_numericalPrecisionPolicy_c0);
}
...
{
  return new qt_gsi::GenericMethod ("open", "@brief Method bool QSqlDatabase::open()\n", false, &_init_f_open_0, &_call_f_open_0);
}
...
static qt_gsi::GenericMethod *_create_f_open_3942 ()
{
  return new qt_gsi::GenericMethod ("open", "@brief Method bool QSqlDatabase::open(const QString &user, const QString &password)\n", false, &_init_f_open_3942, &_call_f_open_3942);
}
...
static qt_gsi::GenericMethod *_create_f_operator_eq__2487 ()
{
  return new qt_gsi::GenericMethod ("assign", "@brief Method QSqlDatabase &QSqlDatabase::operator=(const QSqlDatabase &other)\n", false, &_init_f_operator_eq__2487, &_call_f_operator_eq__2487);
}
...
{
  return new qt_gsi::GenericMethod (":password", "@brief Method QString QSqlDatabase::password()\n", true, &_init_f_password_c0, &_call_f_password_c0);
}
...
{
  return new qt_gsi::GenericMethod (":port", "@brief Method int QSqlDatabase::port()\n", true, &_init_f_port_c0, &_call_f_port_c0);
}
...
{
  return new qt_gsi::GenericMethod ("primaryIndex", "@brief Method QSqlIndex QSqlDatabase::primaryIndex(const QString &tablename)\n", true, &_init_f_primaryIndex_c2025, &_call_f_primaryIndex_c2025);
}
...
{
  return new qt_gsi::GenericMethod ("record", "@brief Method QSqlRecord QSqlDatabase::record(const QString &tablename)\n", true, &_init_f_record_c2025, &_call_f_record_c2025);
}
...
static qt_gsi::GenericMethod *_create_f_rollback_0 ()
{
  return new qt_gsi::GenericMethod ("rollback", "@brief Method bool QSqlDatabase::rollback()\n", false, &_init_f_rollback_0, &_call_f_rollback_0);
}
...
static qt_gsi::GenericMethod *_create_f_setConnectOptions_2025 ()
{
  return new qt_gsi::GenericMethod ("setConnectOptions|connectOptions=", "@brief Method void QSqlDatabase::setConnectOptions(const QString &options)\n", false, &_init_f_setConnectOptions_2025, &_call_f_setConnectOptions_2025);
}
...
static qt_gsi::GenericMethod *_create_f_setDatabaseName_2025 ()
{
  return new qt_gsi::GenericMethod ("setDatabaseName|databaseName=", "@brief Method void QSqlDatabase::setDatabaseName(const QString &name)\n", false, &_init_f_setDatabaseName_2025, &_call_f_setDatabaseName_2025);
}
...
{
  return new qt_gsi::GenericMethod ("setHostName|hostName=", "@brief Method void QSqlDatabase::setHostName(const QString &host)\n", false, &_init_f_setHostName_2025, &_call_f_setHostName_2025);
}
...
{
  return new qt_gsi::GenericMethod ("setNumericalPrecisionPolicy|numericalPrecisionPolicy=", "@brief Method void QSqlDatabase::setNumericalPrecisionPolicy(QSql::NumericalPrecisionPolicy precisionPolicy)\n", false, &_init_f_setNumericalPrecisionPolicy_3429, &_call_f_setNumericalPrecisionPolicy_3429);
}
...
{
  return new qt_gsi::GenericMethod ("setPassword|password=", "@brief Method void QSqlDatabase::setPassword(const QString &password)\n", false, &_init_f_setPassword_2025, &_call_f_setPassword_2025);
}
...
{
  return new qt_gsi::GenericMethod ("setPort|port=", "@brief Method void QSqlDatabase::setPort(int p)\n", false, &_init_f_setPort_767, &_call_f_setPort_767);
}
...
{
  return new qt_gsi::GenericMethod ("setUserName|userName=", "@brief Method void QSqlDatabase::setUserName(const QString &name)\n", false, &_init_f_setUserName_2025, &_call_f_setUserName_2025);
}
...
{
  tl::Heap heap;
  const qt_gsi::Converter<QSql::TableType>::target_type & arg1 = args ? args.read<const qt_gsi::Converter<QSql::TableType>::target_type & > () : (const qt_gsi::Converter<QSql::TableType>::target_type &)(qt_gsi::CppToQtReadAdaptor<QSql::TableType>(heap, QSql::Tables));
  ret.write<qt_gsi::Converter<QStringList>::target_type > ((qt_gsi::Converter<QStringList>::target_type)qt_gsi::CppToQtAdaptor<QStringList>(((QSqlDatabase *)cls)->tables (qt_gsi::QtToCppAdaptor<QSql::TableType>(arg1).cref())));
}

static qt_gsi::GenericMethod *_create_f_tables_c1843 ()
{
  return new qt_gsi::GenericMethod ("tables", "@brief Method QStringList QSqlDatabase::tables(QSql::TableType type)\n", true, &_init_f_tables_c1843, &_call_f_tables_c1843);
}
...
static qt_gsi::GenericMethod *_create_f_transaction_0 ()
{
  return new qt_gsi::GenericMethod ("transaction", "@brief Method bool QSqlDatabase::transaction()\n", false, &_init_f_transaction_0, &_call_f_transaction_0);
}
...
{
  return new qt_gsi::GenericMethod (":userName", "@brief Method QString QSqlDatabase::userName()\n", true, &_init_f_userName_c0, &_call_f_userName_c0);
}
...
{
  const QString &arg1 = args.read<const QString & > ();
  const QString &arg2 = args ? args.read<const QString & > () : (const QString &)(QLatin1String(QSqlDatabase::defaultConnection));
  ret.write<QSqlDatabase > ((QSqlDatabase)QSqlDatabase::addDatabase (arg1, arg2));
}

static qt_gsi::GenericStaticMethod *_create_f_addDatabase_3942 ()
{
  return new qt_gsi::GenericStaticMethod ("addDatabase", "@brief Static method QSqlDatabase QSqlDatabase::addDatabase(const QString &type, const QString &connectionName)\nThis method is static and can be called without an instance.", &_init_f_addDatabase_3942, &_call_f_addDatabase_3942);
}
...
{
  QSqlDriver *arg1 = args.read<QSqlDriver * > ();
  const QString &arg2 = args ? args.read<const QString & > () : (const QString &)(QLatin1String(QSqlDatabase::defaultConnection));
  ret.write<QSqlDatabase > ((QSqlDatabase)QSqlDatabase::addDatabase (arg1, arg2));
}

static qt_gsi::GenericStaticMethod *_create_f_addDatabase_3544 ()
{
  return new qt_gsi::GenericStaticMethod ("addDatabase", "@brief Static method QSqlDatabase QSqlDatabase::addDatabase(QSqlDriver *driver, const QString &connectionName)\nThis method is static and can be called without an instance.", &_init_f_addDatabase_3544, &_call_f_addDatabase_3544);
}
...
static qt_gsi::GenericStaticMethod *_create_f_cloneDatabase_4404 ()
{
  return new qt_gsi::GenericStaticMethod ("cloneDatabase", "@brief Static method QSqlDatabase QSqlDatabase::cloneDatabase(const QSqlDatabase &other, const QString &connectionName)\nThis method is static and can be called without an instance.", &_init_f_cloneDatabase_4404, &_call_f_cloneDatabase_4404);
}
...
{
  ret.write<qt_gsi::Converter<QStringList>::target_type > ((qt_gsi::Converter<QStringList>::target_type)qt_gsi::CppToQtAdaptor<QStringList>(QSqlDatabase::connectionNames ()));
}

static qt_gsi::GenericStaticMethod *_create_f_connectionNames_0 ()
{
  return new qt_gsi::GenericStaticMethod ("connectionNames", "@brief Static method QStringList QSqlDatabase::connectionNames()\nThis method is static and can be called without an instance.", &_init_f_connectionNames_0, &_call_f_connectionNames_0);
}
...
{
  const QString &arg1 = args ? args.read<const QString & > () : (const QString &)(QLatin1String(QSqlDatabase::defaultConnection));
  ret.write<bool > ((bool)QSqlDatabase::contains (arg1));
}

static qt_gsi::GenericStaticMethod *_create_f_contains_2025 ()
{
  return new qt_gsi::GenericStaticMethod ("contains", "@brief Static method bool QSqlDatabase::contains(const QString &connectionName)\nThis method is static and can be called without an instance.", &_init_f_contains_2025, &_call_f_contains_2025);
}
...
static qt_gsi::GenericStaticMethod *_create_f_database_2781 ()
{
  return new qt_gsi::GenericStaticMethod ("database", "@brief Static method QSqlDatabase QSqlDatabase::database(const QString &connectionName, bool open)\nThis method is static and can be called without an instance.", &_init_f_database_2781, &_call_f_database_2781);
}
...
{
  ret.write<qt_gsi::Converter<QStringList>::target_type > ((qt_gsi::Converter<QStringList>::target_type)qt_gsi::CppToQtAdaptor<QStringList>(QSqlDatabase::drivers ()));
}

static qt_gsi::GenericStaticMethod *_create_f_drivers_0 ()
{
  return new qt_gsi::GenericStaticMethod ("drivers", "@brief Static method QStringList QSqlDatabase::drivers()\nThis method is static and can be called without an instance.", &_init_f_drivers_0, &_call_f_drivers_0);
}
...
static qt_gsi::GenericStaticMethod *_create_f_isDriverAvailable_2025 ()
{
  return new qt_gsi::GenericStaticMethod ("isDriverAvailable?", "@brief Static method bool QSqlDatabase::isDriverAvailable(const QString &name)\nThis method is static and can be called without an instance.", &_init_f_isDriverAvailable_2025, &_call_f_isDriverAvailable_2025);
}
...
{
  const QString &arg1 = args.read<const QString & > ();
  QSqlDriverCreatorBase *arg2 = args.read<QSqlDriverCreatorBase * > ();
  QSqlDatabase::registerSqlDriver (arg1, arg2);
}

static qt_gsi::GenericStaticMethod *_create_f_registerSqlDriver_4643 ()
{
  return new qt_gsi::GenericStaticMethod ("registerSqlDriver", "@brief Static method void QSqlDatabase::registerSqlDriver(const QString &name, QSqlDriverCreatorBase *creator)\nThis method is static and can be called without an instance.", &_init_f_registerSqlDriver_4643, &_call_f_registerSqlDriver_4643);
}
...
static qt_gsi::GenericStaticMethod *_create_f_removeDatabase_2025 ()
{
  return new qt_gsi::GenericStaticMethod ("removeDatabase", "@brief Static method void QSqlDatabase::removeDatabase(const QString &connectionName)\nThis method is static and can be called without an instance.", &_init_f_removeDatabase_2025, &_call_f_removeDatabase_2025);
}


namespace gsi
{
gsi::Class<QSqlDatabase> decl_QSqlDatabase ("QSqlDatabase",
  gsi::Methods(_create_ctor_QSqlDatabase_0 ()) +
  gsi::Methods(_create_ctor_QSqlDatabase_2487 ()) +
  gsi::Methods(_create_f_close_0 ()) +
  gsi::Methods(_create_f_commit_0 ()) +
  gsi::Methods(_create_f_connectOptions_c0 ()) +
  gsi::Methods(_create_f_connectionName_c0 ()) +
  gsi::Methods(_create_f_databaseName_c0 ()) +
  gsi::Methods(_create_f_driver_c0 ()) +
  gsi::Methods(_create_f_driverName_c0 ()) +
  gsi::Methods(_create_f_exec_c2025 ()) +
  ...
  gsi::Methods(_create_f_open_3942 ()) +
  gsi::Methods(_create_f_operator_eq__2487 ()) +
  ...
  gsi::Methods(_create_f_rollback_0 ()) +
  gsi::Methods(_create_f_setConnectOptions_2025 ()) +
  gsi::Methods(_create_f_setDatabaseName_2025 ()) +
  ...
  gsi::Methods(_create_f_transaction_0 ()) +
  gsi::Methods(_create_f_userName_c0 ()) +
  gsi::Methods(_create_f_addDatabase_3942 ()) +
  gsi::Methods(_create_f_addDatabase_3544 ()) +
  gsi::Methods(_create_f_cloneDatabase_4404 ()) +
  gsi::Methods(_create_f_connectionNames_0 ()) +
  gsi::Methods(_create_f_contains_2025 ()) +
  gsi::Methods(_create_f_database_2781 ()) +
  gsi::Methods(_create_f_drivers_0 ()) +
  gsi::Methods(_create_f_isDriverAvailable_2025 ()) +
  gsi::Methods(_create_f_registerSqlDriver_4643 ()) +
  gsi::Methods(_create_f_removeDatabase_2025 ()),
