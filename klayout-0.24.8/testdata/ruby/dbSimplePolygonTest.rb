...
class DBSimplePolygon_TestClass < TestBase
  ...
  def test_1_DSimplePolygon
    ...
    assert_equal( RBA::DSimplePolygon::from_s(a.to_s).to_s, a.to_s )
    assert_equal( RBA::SimplePolygon::from_dpoly(a).to_s, "(0,1;1,5;5,5)" )
  ...
  def test_1_SimplePolygon
    ...
    assert_equal( a.to_s, "(0,1;1,5;5,5)" )
    assert_equal( RBA::SimplePolygon::from_s(a.to_s).to_s, a.to_s )
    assert_equal( RBA::DSimplePolygon::from_ipoly(a).to_s, "(0,1;1,5;5,5)" )
    assert_equal( a.points, 3 )
    c = a.dup 
    ...
    b = a.dup
    b.transform(RBA::ICplxTrans::from_trans(m))
    ...
    ph.resolve_holes
    assert_equal(ph.to_s, "(10,-90;10,-65;-90,-65;-90,235;10,410;510,410;535,385;610,385;610,210;110,210;110,110;410,110;410,210;610,210;610,-40;510,-90)")
    ...
    assert_equal(ph2.to_s, "(10,-90;10,-65;-90,-65;-90,235;10,410;510,410;535,385;610,385;610,-40;510,-90/110,110;410,110;410,210;110,210)")
    assert_equal(ph3.to_s, "(10,-90;10,-65;-90,-65;-90,235;10,410;510,410;535,385;610,385;610,210;110,210;110,110;410,110;410,210;610,210;610,-40;510,-90)")
  ...
  def test_2_SimplePolygon
    ...
    assert_equal(RBA::DSimplePolygon::from_ipoly(p).to_s, "(0,0;10,0)")
  ...
  def test_2_DSimplePolygon
    ...
    assert_equal(RBA::SimplePolygon::from_dpoly(p).to_s, "(0,0;10,0)")
